    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(source, "class", "svelte-1ite3zy");
    			...
    			attr_dev(img0, "class", "header-image svelte-1ite3zy");
    			add_location(img0, file$1, 17, 8, 547);
    			attr_dev(picture, "class", "svelte-1ite3zy");
    			add_location(picture, file$1, 15, 6, 453);
    			attr_dev(br, "class", "svelte-1ite3zy");
    			add_location(br, file$1, 23, 23, 744);
    			attr_dev(h1, "class", "title svelte-1ite3zy");
    			add_location(h1, file$1, 22, 10, 702);
    			attr_dev(p0, "class", "description svelte-1ite3zy");
    			add_location(p0, file$1, 26, 10, 802);
    			attr_dev(p1, "class", "description svelte-1ite3zy");
    			add_location(p1, file$1, 31, 10, 1114);
    			attr_dev(button0, "class", "promo-button svelte-1ite3zy");
    			add_location(button0, file$1, 34, 10, 1278);
    			attr_dev(div0, "class", "left-side svelte-1ite3zy");
    			add_location(div0, file$1, 21, 8, 668);
    			...
    			attr_dev(img1, "class", "tree-image svelte-1ite3zy");
    			add_location(img1, file$1, 39, 10, 1444);
    			attr_dev(div1, "class", "right-side svelte-1ite3zy");
    			add_location(div1, file$1, 38, 8, 1409);
    			attr_dev(div2, "class", "content svelte-1ite3zy");
    			add_location(div2, file$1, 20, 6, 638);
    			attr_dev(section0, "class", "first-screen svelte-1ite3zy");
    			add_location(section0, file$1, 14, 4, 416);
    			attr_dev(div3, "class", "screen-container svelte-1ite3zy");
    			add_location(div3, file$1, 13, 2, 381);
    			attr_dev(span0, "class", "prize-label svelte-1ite3zy");
    			add_location(span0, file$1, 50, 10, 1748);
    			attr_dev(div4, "class", "prize-header svelte-1ite3zy");
    			add_location(div4, file$1, 49, 8, 1711);
    			attr_dev(h20, "class", "prize-title svelte-1ite3zy");
    			add_location(h20, file$1, 53, 8, 1826);
    			attr_dev(span1, "class", "spec-label svelte-1ite3zy");
    			add_location(span1, file$1, 58, 14, 2003);
    			attr_dev(span2, "class", "spec-value svelte-1ite3zy");
    			add_location(span2, file$1, 59, 14, 2062);
    			attr_dev(div5, "class", "spec-item svelte-1ite3zy");
    			add_location(div5, file$1, 57, 12, 1965);
    			attr_dev(span3, "class", "spec-label svelte-1ite3zy");
    			add_location(span3, file$1, 62, 14, 2170);
    			attr_dev(span4, "class", "spec-value svelte-1ite3zy");
    			add_location(span4, file$1, 63, 14, 2226);
    			attr_dev(div6, "class", "spec-item svelte-1ite3zy");
    			add_location(div6, file$1, 61, 12, 2132);
    			attr_dev(div7, "class", "specs-column svelte-1ite3zy");
    			add_location(div7, file$1, 56, 10, 1926);
    			attr_dev(span5, "class", "spec-label svelte-1ite3zy");
    			add_location(span5, file$1, 68, 14, 2392);
    			attr_dev(span6, "class", "spec-value svelte-1ite3zy");
    			add_location(span6, file$1, 69, 14, 2443);
    			attr_dev(div8, "class", "spec-item svelte-1ite3zy");
    			add_location(div8, file$1, 67, 12, 2354);
    			attr_dev(span7, "class", "spec-label svelte-1ite3zy");
    			add_location(span7, file$1, 72, 14, 2563);
    			attr_dev(span8, "class", "spec-value svelte-1ite3zy");
    			add_location(span8, file$1, 73, 14, 2616);
    			attr_dev(div9, "class", "spec-item svelte-1ite3zy");
    			add_location(div9, file$1, 71, 12, 2525);
    			attr_dev(div10, "class", "specs-column svelte-1ite3zy");
    			add_location(div10, file$1, 66, 10, 2315);
    			attr_dev(div11, "class", "specs-container svelte-1ite3zy");
    			add_location(div11, file$1, 55, 8, 1886);
    			...
    			attr_dev(img2, "class", "prize-image svelte-1ite3zy");
    			add_location(img2, file$1, 78, 8, 2722);
    			attr_dev(div12, "class", "main-prize svelte-1ite3zy");
    			add_location(div12, file$1, 48, 6, 1678);
    			attr_dev(h30, "class", "prize-card-category svelte-1ite3zy");
    			add_location(h30, file$1, 83, 10, 2893);
    			attr_dev(h40, "class", "prize-card-model svelte-1ite3zy");
    			add_location(h40, file$1, 84, 10, 2949);
    			...
    			attr_dev(img3, "class", "prize-card-image svelte-1ite3zy");
    			add_location(img3, file$1, 85, 10, 3009);
    			attr_dev(div13, "class", "prize-card svelte-1ite3zy");
    			add_location(div13, file$1, 82, 8, 2858);
    			attr_dev(h31, "class", "prize-card-category svelte-1ite3zy");
    			add_location(h31, file$1, 89, 10, 3149);
    			attr_dev(h41, "class", "prize-card-model svelte-1ite3zy");
    			add_location(h41, file$1, 90, 10, 3208);
    			...
    			attr_dev(img4, "class", "prize-card-image svelte-1ite3zy");
    			add_location(img4, file$1, 91, 10, 3268);
    			attr_dev(div14, "class", "prize-card svelte-1ite3zy");
    			add_location(div14, file$1, 88, 8, 3114);
    			attr_dev(h32, "class", "prize-card-category svelte-1ite3zy");
    			add_location(h32, file$1, 95, 10, 3410);
    			attr_dev(h42, "class", "prize-card-model svelte-1ite3zy");
    			add_location(h42, file$1, 96, 10, 3471);
    			...
    			attr_dev(img5, "class", "prize-card-image svelte-1ite3zy");
    			add_location(img5, file$1, 97, 10, 3532);
    			attr_dev(div15, "class", "prize-card svelte-1ite3zy");
    			add_location(div15, file$1, 94, 8, 3375);
    			attr_dev(div16, "class", "additional-prizes svelte-1ite3zy");
    			add_location(div16, file$1, 81, 6, 2818);
    			attr_dev(div17, "class", "header-place svelte-1ite3zy");
    			add_location(div17, file$1, 104, 12, 3771);
    			attr_dev(div18, "class", "header-prize svelte-1ite3zy");
    			add_location(div18, file$1, 105, 12, 3821);
    			attr_dev(div19, "class", "header-freebet svelte-1ite3zy");
    			add_location(div19, file$1, 106, 12, 3870);
    			attr_dev(div20, "class", "leaderboard-headers svelte-1ite3zy");
    			add_location(div20, file$1, 103, 10, 3725);
    			attr_dev(div21, "class", "place svelte-1ite3zy");
    			add_location(div21, file$1, 111, 14, 4026);
    			attr_dev(div22, "class", "prize svelte-1ite3zy");
    			add_location(div22, file$1, 112, 14, 4067);
    			attr_dev(div23, "class", "freebet svelte-1ite3zy");
    			add_location(div23, file$1, 113, 14, 4120);
    			attr_dev(div24, "class", "leaderboard-row svelte-1ite3zy");
    			add_location(div24, file$1, 110, 12, 3982);
    			attr_dev(div25, "class", "place svelte-1ite3zy");
    			add_location(div25, file$1, 117, 14, 4232);
    			attr_dev(div26, "class", "prize svelte-1ite3zy");
    			add_location(div26, file$1, 118, 14, 4273);
    			attr_dev(div27, "class", "freebet svelte-1ite3zy");
    			add_location(div27, file$1, 119, 14, 4326);
    			attr_dev(div28, "class", "leaderboard-row svelte-1ite3zy");
    			add_location(div28, file$1, 116, 12, 4188);
    			attr_dev(div29, "class", "place svelte-1ite3zy");
    			add_location(div29, file$1, 123, 14, 4438);
    			attr_dev(div30, "class", "prize svelte-1ite3zy");
    			add_location(div30, file$1, 124, 14, 4479);
    			attr_dev(div31, "class", "freebet svelte-1ite3zy");
    			add_location(div31, file$1, 125, 14, 4532);
    			attr_dev(div32, "class", "leaderboard-row svelte-1ite3zy");
    			add_location(div32, file$1, 122, 12, 4394);
    			attr_dev(div33, "class", "place svelte-1ite3zy");
    			add_location(div33, file$1, 129, 14, 4644);
    			attr_dev(div34, "class", "prize svelte-1ite3zy");
    			add_location(div34, file$1, 130, 14, 4685);
    			attr_dev(div35, "class", "freebet svelte-1ite3zy");
    			add_location(div35, file$1, 131, 14, 4744);
    			attr_dev(div36, "class", "leaderboard-row svelte-1ite3zy");
    			add_location(div36, file$1, 128, 12, 4600);
    			attr_dev(div37, "class", "place svelte-1ite3zy");
    			add_location(div37, file$1, 135, 14, 4856);
    			attr_dev(div38, "class", "prize svelte-1ite3zy");
    			add_location(div38, file$1, 136, 14, 4897);
    			attr_dev(div39, "class", "freebet svelte-1ite3zy");
    			add_location(div39, file$1, 137, 14, 4956);
    			attr_dev(div40, "class", "leaderboard-row svelte-1ite3zy");
    			add_location(div40, file$1, 134, 12, 4812);
    			attr_dev(div41, "class", "place svelte-1ite3zy");
    			add_location(div41, file$1, 141, 14, 5068);
    			attr_dev(div42, "class", "prize svelte-1ite3zy");
    			add_location(div42, file$1, 142, 14, 5112);
    			attr_dev(div43, "class", "freebet svelte-1ite3zy");
    			add_location(div43, file$1, 143, 14, 5172);
    			attr_dev(div44, "class", "leaderboard-row svelte-1ite3zy");
    			add_location(div44, file$1, 140, 12, 5024);
    			attr_dev(div45, "class", "leaderboard-rows svelte-1ite3zy");
    			add_location(div45, file$1, 109, 10, 3939);
    			attr_dev(div46, "class", "leaderboard-content svelte-1ite3zy");
    			add_location(div46, file$1, 102, 8, 3681);
    			attr_dev(div47, "class", "merch-images svelte-1ite3zy");
    			add_location(div47, file$1, 150, 12, 5344);
    			attr_dev(span9, "class", "svelte-1ite3zy");
    			add_location(span9, file$1, 154, 14, 5496);
    			attr_dev(div48, "class", "merch-status svelte-1ite3zy");
    			add_location(div48, file$1, 153, 12, 5455);
    			attr_dev(div49, "class", "merch-content svelte-1ite3zy");
    			add_location(div49, file$1, 149, 10, 5304);
    			attr_dev(div50, "class", "merch-column svelte-1ite3zy");
    			add_location(div50, file$1, 148, 8, 5267);
    			attr_dev(div51, "class", "leaderboard svelte-1ite3zy");
    			add_location(div51, file$1, 101, 6, 3647);
    			attr_dev(section1, "class", "second-screen svelte-1ite3zy");
    			add_location(section1, file$1, 47, 4, 1640);
    			attr_dev(div52, "class", "screen-container svelte-1ite3zy");
    			add_location(div52, file$1, 46, 2, 1605);
    			attr_dev(h21, "class", "leaderboard-title svelte-1ite3zy");
    			add_location(h21, file$1, 166, 8, 5758);
    			attr_dev(p2, "class", "leaderboard-description svelte-1ite3zy");
    			add_location(p2, file$1, 167, 8, 5818);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-1ite3zy");
    			add_location(a, file$1, 170, 8, 5964);
    			attr_dev(div53, "class", "table-frame svelte-1ite3zy");
    			add_location(div53, file$1, 174, 10, 6140);
    			attr_dev(div54, "class", "leaderboard-table svelte-1ite3zy");
    			add_location(div54, file$1, 172, 8, 6059);
    			attr_dev(div55, "class", "leaderboard-left svelte-1ite3zy");
    			add_location(div55, file$1, 165, 6, 5719);
    			attr_dev(button1, "class", "action-button svelte-1ite3zy");
    			add_location(button1, file$1, 182, 10, 6351);
    			attr_dev(button2, "class", "action-button svelte-1ite3zy");
    			add_location(button2, file$1, 183, 10, 6417);
    			attr_dev(p3, "class", "promo-description svelte-1ite3zy");
    			add_location(p3, file$1, 185, 10, 6490);
    			attr_dev(p4, "class", "svelte-1ite3zy");
    			add_location(p4, file$1, 191, 12, 6754);
    			attr_dev(p5, "class", "svelte-1ite3zy");
    			add_location(p5, file$1, 192, 12, 6866);
    			attr_dev(p6, "class", "svelte-1ite3zy");
    			add_location(p6, file$1, 193, 12, 6920);
    			attr_dev(div56, "class", "additional-info svelte-1ite3zy");
    			add_location(div56, file$1, 190, 10, 6712);
    			attr_dev(div57, "class", "actions-container svelte-1ite3zy");
    			add_location(div57, file$1, 181, 8, 6309);
    			attr_dev(div58, "class", "leaderboard-right svelte-1ite3zy");
    			add_location(div58, file$1, 180, 6, 6269);
    			attr_dev(div59, "class", "leaderboard-container svelte-1ite3zy");
    			add_location(div59, file$1, 164, 4, 5677);
    			attr_dev(section2, "class", "third-screen svelte-1ite3zy");
    			add_location(section2, file$1, 163, 2, 5642);
    			attr_dev(div60, "class", "page-wrapper svelte-1ite3zy");
    			add_location(div60, file$1, 11, 0, 322);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div60, t92);
    			append_dev(div60, section2);
    			append_dev(section2, div59);
    			append_dev(div59, div55);
    			append_dev(div55, h21);
    			...
    			append_dev(div57, button2);
    			append_dev(div57, t103);
    			append_dev(div57, p3);
    			append_dev(div57, t105);
    			append_dev(div57, div56);
    			append_dev(div56, p4);
    			append_dev(div56, t107);
    			append_dev(div56, p5);
    			append_dev(div56, t109);
    			append_dev(div56, p6);
    			append_dev(div60, t111);
    			mount_component(screen4, div60, null);
    			append_dev(div60, t112);
    			mount_component(screen5, div60, null);
    			current = true;

    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "header-image svelte-1xdojpd");
    			add_location(img0, file$1, 11, 8, 324);
    			add_location(picture, file$1, 7, 6, 161);
    			attr_dev(br, "class", "svelte-1xdojpd");
    			add_location(br, file$1, 17, 23, 521);
    			attr_dev(h1, "class", "title svelte-1xdojpd");
    			add_location(h1, file$1, 16, 10, 479);
    			attr_dev(p0, "class", "description svelte-1xdojpd");
    			add_location(p0, file$1, 20, 10, 579);
    			attr_dev(p1, "class", "description svelte-1xdojpd");
    			add_location(p1, file$1, 25, 10, 892);
    			attr_dev(button0, "class", "promo-button svelte-1xdojpd");
    			add_location(button0, file$1, 28, 10, 1056);
    			attr_dev(div0, "class", "left-side svelte-1xdojpd");
    			...
    			attr_dev(img1, "class", "tree-image svelte-1xdojpd");
    			add_location(img1, file$1, 33, 10, 1194);
    			attr_dev(div1, "class", "right-side svelte-1xdojpd");
    			add_location(div1, file$1, 32, 8, 1159);
    			attr_dev(div2, "class", "content svelte-1xdojpd");
    			add_location(div2, file$1, 14, 6, 415);
    			attr_dev(section0, "class", "first-screen svelte-1xdojpd");
    			add_location(section0, file$1, 6, 4, 124);
    			attr_dev(div3, "class", "screen-container");
    			add_location(div3, file$1, 5, 2, 89);
    			attr_dev(span0, "class", "prize-label svelte-1xdojpd");
    			add_location(span0, file$1, 43, 10, 1474);
    			attr_dev(div4, "class", "prize-header svelte-1xdojpd");
    			add_location(div4, file$1, 42, 8, 1437);
    			attr_dev(h20, "class", "prize-title svelte-1xdojpd");
    			add_location(h20, file$1, 46, 8, 1552);
    			attr_dev(span1, "class", "spec-label svelte-1xdojpd");
    			add_location(span1, file$1, 51, 14, 1729);
    			attr_dev(span2, "class", "spec-value svelte-1xdojpd");
    			add_location(span2, file$1, 52, 14, 1788);
    			attr_dev(div5, "class", "spec-item svelte-1xdojpd");
    			add_location(div5, file$1, 50, 12, 1691);
    			attr_dev(span3, "class", "spec-label svelte-1xdojpd");
    			add_location(span3, file$1, 55, 14, 1896);
    			attr_dev(span4, "class", "spec-value svelte-1xdojpd");
    			add_location(span4, file$1, 56, 14, 1952);
    			attr_dev(div6, "class", "spec-item svelte-1xdojpd");
    			add_location(div6, file$1, 54, 12, 1858);
    			attr_dev(div7, "class", "specs-column svelte-1xdojpd");
    			add_location(div7, file$1, 49, 10, 1652);
    			attr_dev(span5, "class", "spec-label svelte-1xdojpd");
    			add_location(span5, file$1, 61, 14, 2118);
    			attr_dev(span6, "class", "spec-value svelte-1xdojpd");
    			add_location(span6, file$1, 62, 14, 2169);
    			attr_dev(div8, "class", "spec-item svelte-1xdojpd");
    			add_location(div8, file$1, 60, 12, 2080);
    			attr_dev(span7, "class", "spec-label svelte-1xdojpd");
    			add_location(span7, file$1, 65, 14, 2289);
    			attr_dev(span8, "class", "spec-value svelte-1xdojpd");
    			add_location(span8, file$1, 66, 14, 2342);
    			attr_dev(div9, "class", "spec-item svelte-1xdojpd");
    			add_location(div9, file$1, 64, 12, 2251);
    			attr_dev(div10, "class", "specs-column svelte-1xdojpd");
    			add_location(div10, file$1, 59, 10, 2041);
    			attr_dev(div11, "class", "specs-container svelte-1xdojpd");
    			...
    			attr_dev(img2, "class", "prize-image svelte-1xdojpd");
    			add_location(img2, file$1, 71, 8, 2448);
    			attr_dev(div12, "class", "main-prize svelte-1xdojpd");
    			add_location(div12, file$1, 41, 6, 1404);
    			attr_dev(h30, "class", "prize-card-category svelte-1xdojpd");
    			add_location(h30, file$1, 76, 10, 2619);
    			attr_dev(h40, "class", "prize-card-model svelte-1xdojpd");
    			...
    			attr_dev(img3, "class", "prize-card-image svelte-1xdojpd");
    			add_location(img3, file$1, 78, 10, 2735);
    			attr_dev(div13, "class", "prize-card svelte-1xdojpd");
    			add_location(div13, file$1, 75, 8, 2584);
    			attr_dev(h31, "class", "prize-card-category svelte-1xdojpd");
    			add_location(h31, file$1, 82, 6, 2867);
    			attr_dev(h41, "class", "prize-card-model svelte-1xdojpd");
    			...
    			attr_dev(img4, "class", "prize-card-image svelte-1xdojpd");
    			add_location(img4, file$1, 84, 6, 2978);
    			attr_dev(div14, "class", "prize-card svelte-1xdojpd");
    			add_location(div14, file$1, 81, 4, 2836);
    			attr_dev(h32, "class", "prize-card-category svelte-1xdojpd");
    			add_location(h32, file$1, 88, 6, 3108);
    			attr_dev(h42, "class", "prize-card-model svelte-1xdojpd");
    			...
    			attr_dev(img5, "class", "prize-card-image svelte-1xdojpd");
    			add_location(img5, file$1, 90, 6, 3222);
    			attr_dev(div15, "class", "prize-card svelte-1xdojpd");
    			add_location(div15, file$1, 87, 4, 3077);
    			attr_dev(div16, "class", "additional-prizes svelte-1xdojpd");
    			add_location(div16, file$1, 74, 6, 2544);
    			attr_dev(div17, "class", "header-place svelte-1xdojpd");
    			add_location(div17, file$1, 97, 12, 3453);
    			attr_dev(div18, "class", "header-prize svelte-1xdojpd");
    			add_location(div18, file$1, 98, 12, 3503);
    			attr_dev(div19, "class", "header-freebet svelte-1xdojpd");
    			add_location(div19, file$1, 99, 12, 3552);
    			attr_dev(div20, "class", "leaderboard-headers svelte-1xdojpd");
    			add_location(div20, file$1, 96, 10, 3407);
    			attr_dev(div21, "class", "place svelte-1xdojpd");
    			add_location(div21, file$1, 104, 14, 3708);
    			attr_dev(div22, "class", "prize svelte-1xdojpd");
    			add_location(div22, file$1, 105, 14, 3749);
    			attr_dev(div23, "class", "freebet svelte-1xdojpd");
    			add_location(div23, file$1, 106, 14, 3802);
    			attr_dev(div24, "class", "leaderboard-row svelte-1xdojpd");
    			add_location(div24, file$1, 103, 12, 3664);
    			attr_dev(div25, "class", "place svelte-1xdojpd");
    			add_location(div25, file$1, 110, 14, 3914);
    			attr_dev(div26, "class", "prize svelte-1xdojpd");
    			add_location(div26, file$1, 111, 14, 3955);
    			attr_dev(div27, "class", "freebet svelte-1xdojpd");
    			add_location(div27, file$1, 112, 14, 4008);
    			attr_dev(div28, "class", "leaderboard-row svelte-1xdojpd");
    			add_location(div28, file$1, 109, 12, 3870);
    			attr_dev(div29, "class", "place svelte-1xdojpd");
    			add_location(div29, file$1, 116, 14, 4120);
    			attr_dev(div30, "class", "prize svelte-1xdojpd");
    			add_location(div30, file$1, 117, 14, 4161);
    			attr_dev(div31, "class", "freebet svelte-1xdojpd");
    			add_location(div31, file$1, 118, 14, 4214);
    			attr_dev(div32, "class", "leaderboard-row svelte-1xdojpd");
    			add_location(div32, file$1, 115, 12, 4076);
    			attr_dev(div33, "class", "place svelte-1xdojpd");
    			add_location(div33, file$1, 122, 16, 4330);
    			attr_dev(div34, "class", "prize svelte-1xdojpd");
    			add_location(div34, file$1, 123, 16, 4373);
    			attr_dev(div35, "class", "freebet svelte-1xdojpd");
    			add_location(div35, file$1, 124, 16, 4434);
    			attr_dev(div36, "class", "leaderboard-row svelte-1xdojpd");
    			add_location(div36, file$1, 121, 14, 4284);
    			attr_dev(div37, "class", "place svelte-1xdojpd");
    			add_location(div37, file$1, 128, 16, 4552);
    			attr_dev(div38, "class", "prize svelte-1xdojpd");
    			add_location(div38, file$1, 129, 16, 4595);
    			attr_dev(div39, "class", "freebet svelte-1xdojpd");
    			add_location(div39, file$1, 130, 16, 4656);
    			attr_dev(div40, "class", "leaderboard-row svelte-1xdojpd");
    			add_location(div40, file$1, 127, 14, 4506);
    			attr_dev(div41, "class", "place svelte-1xdojpd");
    			add_location(div41, file$1, 134, 16, 4774);
    			attr_dev(div42, "class", "prize svelte-1xdojpd");
    			add_location(div42, file$1, 135, 16, 4820);
    			attr_dev(div43, "class", "freebet svelte-1xdojpd");
    			add_location(div43, file$1, 136, 16, 4882);
    			attr_dev(div44, "class", "leaderboard-row svelte-1xdojpd");
    			add_location(div44, file$1, 133, 14, 4728);
    			attr_dev(div45, "class", "leaderboard-rows svelte-1xdojpd");
    			add_location(div45, file$1, 102, 10, 3621);
    			attr_dev(div46, "class", "leaderboard-content svelte-1xdojpd");
    			add_location(div46, file$1, 95, 8, 3363);
    			attr_dev(div47, "class", "merch-images");
    			add_location(div47, file$1, 143, 12, 5060);
    			attr_dev(span9, "class", "svelte-1xdojpd");
    			add_location(span9, file$1, 147, 14, 5212);
    			attr_dev(div48, "class", "merch-status svelte-1xdojpd");
    			add_location(div48, file$1, 146, 12, 5171);
    			attr_dev(div49, "class", "merch-content svelte-1xdojpd");
    			add_location(div49, file$1, 142, 10, 5020);
    			attr_dev(div50, "class", "merch-column svelte-1xdojpd");
    			add_location(div50, file$1, 141, 8, 4983);
    			attr_dev(div51, "class", "leaderboard svelte-1xdojpd");
    			add_location(div51, file$1, 94, 6, 3329);
    			attr_dev(section1, "class", "second-screen svelte-1xdojpd");
    			add_location(section1, file$1, 40, 4, 1366);
    			attr_dev(div52, "class", "screen-container");
    			add_location(div52, file$1, 39, 2, 1331);
    			attr_dev(div53, "class", "page-wrapper svelte-1xdojpd");
    			add_location(div53, file$1, 4, 0, 60);
    			attr_dev(h21, "class", "leaderboard-title svelte-1xdojpd");
    			add_location(h21, file$1, 159, 6, 5445);
    			attr_dev(p2, "class", "leaderboard-description svelte-1xdojpd");
    			add_location(p2, file$1, 160, 6, 5503);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-1xdojpd");
    			add_location(a, file$1, 163, 6, 5643);
    			attr_dev(div54, "class", "table-frame svelte-1xdojpd");
    			add_location(div54, file$1, 167, 8, 5811);
    			attr_dev(div55, "class", "leaderboard-table");
    			add_location(div55, file$1, 165, 6, 5734);
    			attr_dev(div56, "class", "leaderboard-left svelte-1xdojpd");
    			add_location(div56, file$1, 158, 4, 5408);
    			attr_dev(button1, "class", "action-button svelte-1xdojpd");
    			add_location(button1, file$1, 175, 8, 6008);
    			attr_dev(button2, "class", "action-button svelte-1xdojpd");
    			add_location(button2, file$1, 176, 8, 6072);
    			attr_dev(p3, "class", "promo-description svelte-1xdojpd");
    			add_location(p3, file$1, 178, 8, 6141);
    			attr_dev(p4, "class", "svelte-1xdojpd");
    			add_location(p4, file$1, 184, 10, 6395);
    			attr_dev(p5, "class", "svelte-1xdojpd");
    			add_location(p5, file$1, 185, 10, 6505);
    			attr_dev(p6, "class", "svelte-1xdojpd");
    			add_location(p6, file$1, 186, 10, 6557);
    			attr_dev(div57, "class", "additional-info svelte-1xdojpd");
    			add_location(div57, file$1, 183, 8, 6355);
    			attr_dev(div58, "class", "actions-container");
    			add_location(div58, file$1, 174, 6, 5968);
    			attr_dev(div59, "class", "leaderboard-right svelte-1xdojpd");
    			add_location(div59, file$1, 173, 4, 5930);
    			attr_dev(div60, "class", "leaderboard-container svelte-1xdojpd");
    			add_location(div60, file$1, 157, 2, 5368);
    			attr_dev(section2, "class", "third-screen svelte-1xdojpd");

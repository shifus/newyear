    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-1ba8a4r");
    			add_location(img0, file$1, 17, 10, 521);
    			attr_dev(div0, "class", "candy-cane svelte-1ba8a4r");
    			add_location(div0, file$1, 18, 10, 593);
    			attr_dev(div1, "class", "logo-container svelte-1ba8a4r");
    			add_location(div1, file$1, 16, 8, 482);
    			attr_dev(div2, "class", "menu-item svelte-1ba8a4r");
    			add_location(div2, file$1, 21, 10, 676);
    			attr_dev(div3, "class", "menu-item svelte-1ba8a4r");
    			add_location(div3, file$1, 22, 10, 734);
    			attr_dev(div4, "class", "menu-item svelte-1ba8a4r");
    			add_location(div4, file$1, 23, 10, 783);
    			attr_dev(div5, "class", "menu svelte-1ba8a4r");
    			add_location(div5, file$1, 20, 8, 647);
    			attr_dev(div6, "class", "header svelte-1ba8a4r");
    			add_location(div6, file$1, 15, 6, 453);
    			attr_dev(br, "class", "svelte-1ba8a4r");
    			add_location(br, file$1, 30, 23, 959);
    			attr_dev(h1, "class", "title svelte-1ba8a4r");
    			add_location(h1, file$1, 29, 10, 917);
    			attr_dev(p0, "class", "description svelte-1ba8a4r");
    			add_location(p0, file$1, 33, 10, 1017);
    			attr_dev(p1, "class", "description svelte-1ba8a4r");
    			add_location(p1, file$1, 38, 10, 1329);
    			attr_dev(button0, "class", "promo-button svelte-1ba8a4r");
    			add_location(button0, file$1, 41, 10, 1493);
    			attr_dev(div7, "class", "left-side svelte-1ba8a4r");
    			...
    			attr_dev(img1, "class", "tree-image svelte-1ba8a4r");
    			add_location(img1, file$1, 46, 10, 1659);
    			attr_dev(div8, "class", "right-side svelte-1ba8a4r");
    			add_location(div8, file$1, 45, 8, 1624);
    			attr_dev(div9, "class", "content svelte-1ba8a4r");
    			add_location(div9, file$1, 27, 6, 853);
    			attr_dev(section0, "class", "first-screen svelte-1ba8a4r");
    			add_location(section0, file$1, 14, 4, 416);
    			attr_dev(div10, "class", "screen-container svelte-1ba8a4r");
    			add_location(div10, file$1, 13, 2, 381);
    			attr_dev(span0, "class", "prize-label svelte-1ba8a4r");
    			add_location(span0, file$1, 57, 10, 1963);
    			attr_dev(div11, "class", "prize-header svelte-1ba8a4r");
    			add_location(div11, file$1, 56, 8, 1926);
    			attr_dev(h20, "class", "prize-title svelte-1ba8a4r");
    			add_location(h20, file$1, 60, 8, 2041);
    			attr_dev(span1, "class", "spec-label svelte-1ba8a4r");
    			add_location(span1, file$1, 65, 14, 2218);
    			attr_dev(span2, "class", "spec-value svelte-1ba8a4r");
    			add_location(span2, file$1, 66, 14, 2277);
    			attr_dev(div12, "class", "spec-item svelte-1ba8a4r");
    			add_location(div12, file$1, 64, 12, 2180);
    			attr_dev(span3, "class", "spec-label svelte-1ba8a4r");
    			add_location(span3, file$1, 69, 14, 2385);
    			attr_dev(span4, "class", "spec-value svelte-1ba8a4r");
    			add_location(span4, file$1, 70, 14, 2441);
    			attr_dev(div13, "class", "spec-item svelte-1ba8a4r");
    			add_location(div13, file$1, 68, 12, 2347);
    			attr_dev(div14, "class", "specs-column svelte-1ba8a4r");
    			add_location(div14, file$1, 63, 10, 2141);
    			attr_dev(span5, "class", "spec-label svelte-1ba8a4r");
    			add_location(span5, file$1, 75, 14, 2607);
    			attr_dev(span6, "class", "spec-value svelte-1ba8a4r");
    			add_location(span6, file$1, 76, 14, 2658);
    			attr_dev(div15, "class", "spec-item svelte-1ba8a4r");
    			add_location(div15, file$1, 74, 12, 2569);
    			attr_dev(span7, "class", "spec-label svelte-1ba8a4r");
    			add_location(span7, file$1, 79, 14, 2778);
    			attr_dev(span8, "class", "spec-value svelte-1ba8a4r");
    			add_location(span8, file$1, 80, 14, 2831);
    			attr_dev(div16, "class", "spec-item svelte-1ba8a4r");
    			add_location(div16, file$1, 78, 12, 2740);
    			attr_dev(div17, "class", "specs-column svelte-1ba8a4r");
    			add_location(div17, file$1, 73, 10, 2530);
    			attr_dev(div18, "class", "specs-container svelte-1ba8a4r");
    			...
    			attr_dev(img2, "class", "prize-image svelte-1ba8a4r");
    			add_location(img2, file$1, 85, 8, 2937);
    			attr_dev(div19, "class", "main-prize svelte-1ba8a4r");
    			add_location(div19, file$1, 55, 6, 1893);
    			attr_dev(h30, "class", "prize-card-category svelte-1ba8a4r");
    			add_location(h30, file$1, 90, 10, 3108);
    			attr_dev(h40, "class", "prize-card-model svelte-1ba8a4r");
    			...
    			attr_dev(img3, "class", "prize-card-image svelte-1ba8a4r");
    			add_location(img3, file$1, 92, 10, 3224);
    			attr_dev(div20, "class", "prize-card svelte-1ba8a4r");
    			add_location(div20, file$1, 89, 8, 3073);
    			attr_dev(h31, "class", "prize-card-category svelte-1ba8a4r");
    			add_location(h31, file$1, 96, 10, 3364);
    			attr_dev(h41, "class", "prize-card-model svelte-1ba8a4r");
    			...
    			attr_dev(img4, "class", "prize-card-image svelte-1ba8a4r");
    			add_location(img4, file$1, 98, 10, 3483);
    			attr_dev(div21, "class", "prize-card svelte-1ba8a4r");
    			add_location(div21, file$1, 95, 8, 3329);
    			attr_dev(h32, "class", "prize-card-category svelte-1ba8a4r");
    			add_location(h32, file$1, 102, 10, 3625);
    			attr_dev(h42, "class", "prize-card-model svelte-1ba8a4r");
    			...
    			attr_dev(img5, "class", "prize-card-image svelte-1ba8a4r");
    			add_location(img5, file$1, 104, 10, 3747);
    			attr_dev(div22, "class", "prize-card svelte-1ba8a4r");
    			add_location(div22, file$1, 101, 8, 3590);
    			attr_dev(div23, "class", "additional-prizes svelte-1ba8a4r");
    			add_location(div23, file$1, 88, 6, 3033);
    			attr_dev(div24, "class", "header-place svelte-1ba8a4r");
    			add_location(div24, file$1, 111, 12, 3986);
    			attr_dev(div25, "class", "header-prize svelte-1ba8a4r");
    			add_location(div25, file$1, 112, 12, 4036);
    			attr_dev(div26, "class", "header-freebet svelte-1ba8a4r");
    			add_location(div26, file$1, 113, 12, 4085);
    			attr_dev(div27, "class", "leaderboard-headers svelte-1ba8a4r");
    			add_location(div27, file$1, 110, 10, 3940);
    			attr_dev(div28, "class", "place svelte-1ba8a4r");
    			add_location(div28, file$1, 118, 14, 4241);
    			attr_dev(div29, "class", "prize svelte-1ba8a4r");
    			add_location(div29, file$1, 119, 14, 4282);
    			attr_dev(div30, "class", "freebet svelte-1ba8a4r");
    			add_location(div30, file$1, 120, 14, 4335);
    			attr_dev(div31, "class", "leaderboard-row svelte-1ba8a4r");
    			add_location(div31, file$1, 117, 12, 4197);
    			attr_dev(div32, "class", "place svelte-1ba8a4r");
    			add_location(div32, file$1, 124, 14, 4447);
    			attr_dev(div33, "class", "prize svelte-1ba8a4r");
    			add_location(div33, file$1, 125, 14, 4488);
    			attr_dev(div34, "class", "freebet svelte-1ba8a4r");
    			add_location(div34, file$1, 126, 14, 4541);
    			attr_dev(div35, "class", "leaderboard-row svelte-1ba8a4r");
    			add_location(div35, file$1, 123, 12, 4403);
    			attr_dev(div36, "class", "place svelte-1ba8a4r");
    			add_location(div36, file$1, 130, 14, 4653);
    			attr_dev(div37, "class", "prize svelte-1ba8a4r");
    			add_location(div37, file$1, 131, 14, 4694);
    			attr_dev(div38, "class", "freebet svelte-1ba8a4r");
    			add_location(div38, file$1, 132, 14, 4747);
    			attr_dev(div39, "class", "leaderboard-row svelte-1ba8a4r");
    			add_location(div39, file$1, 129, 12, 4609);
    			attr_dev(div40, "class", "place svelte-1ba8a4r");
    			add_location(div40, file$1, 136, 14, 4859);
    			attr_dev(div41, "class", "prize svelte-1ba8a4r");
    			add_location(div41, file$1, 137, 14, 4900);
    			attr_dev(div42, "class", "freebet svelte-1ba8a4r");
    			add_location(div42, file$1, 138, 14, 4959);
    			attr_dev(div43, "class", "leaderboard-row svelte-1ba8a4r");
    			add_location(div43, file$1, 135, 12, 4815);
    			attr_dev(div44, "class", "place svelte-1ba8a4r");
    			add_location(div44, file$1, 142, 14, 5071);
    			attr_dev(div45, "class", "prize svelte-1ba8a4r");
    			add_location(div45, file$1, 143, 14, 5112);
    			attr_dev(div46, "class", "freebet svelte-1ba8a4r");
    			add_location(div46, file$1, 144, 14, 5171);
    			attr_dev(div47, "class", "leaderboard-row svelte-1ba8a4r");
    			add_location(div47, file$1, 141, 12, 5027);
    			attr_dev(div48, "class", "place svelte-1ba8a4r");
    			add_location(div48, file$1, 148, 14, 5283);
    			attr_dev(div49, "class", "prize svelte-1ba8a4r");
    			add_location(div49, file$1, 149, 14, 5327);
    			attr_dev(div50, "class", "freebet svelte-1ba8a4r");
    			add_location(div50, file$1, 150, 14, 5387);
    			attr_dev(div51, "class", "leaderboard-row svelte-1ba8a4r");
    			add_location(div51, file$1, 147, 12, 5239);
    			attr_dev(div52, "class", "leaderboard-rows svelte-1ba8a4r");
    			add_location(div52, file$1, 116, 10, 4154);
    			attr_dev(div53, "class", "leaderboard-content svelte-1ba8a4r");
    			add_location(div53, file$1, 109, 8, 3896);
    			attr_dev(div54, "class", "merch-images svelte-1ba8a4r");
    			add_location(div54, file$1, 157, 12, 5559);
    			attr_dev(span9, "class", "svelte-1ba8a4r");
    			add_location(span9, file$1, 161, 14, 5711);
    			attr_dev(div55, "class", "merch-status svelte-1ba8a4r");
    			add_location(div55, file$1, 160, 12, 5670);
    			attr_dev(div56, "class", "merch-content svelte-1ba8a4r");
    			add_location(div56, file$1, 156, 10, 5519);
    			attr_dev(div57, "class", "merch-column svelte-1ba8a4r");
    			add_location(div57, file$1, 155, 8, 5482);
    			attr_dev(div58, "class", "leaderboard svelte-1ba8a4r");
    			add_location(div58, file$1, 108, 6, 3862);
    			attr_dev(section1, "class", "second-screen svelte-1ba8a4r");
    			add_location(section1, file$1, 54, 4, 1855);
    			attr_dev(div59, "class", "screen-container svelte-1ba8a4r");
    			add_location(div59, file$1, 53, 2, 1820);
    			attr_dev(h21, "class", "leaderboard-title svelte-1ba8a4r");
    			add_location(h21, file$1, 173, 8, 5973);
    			attr_dev(p2, "class", "leaderboard-description svelte-1ba8a4r");
    			add_location(p2, file$1, 174, 8, 6033);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-1ba8a4r");
    			add_location(a, file$1, 177, 8, 6179);
    			attr_dev(div60, "class", "table-frame svelte-1ba8a4r");
    			add_location(div60, file$1, 181, 10, 6355);
    			attr_dev(div61, "class", "leaderboard-table svelte-1ba8a4r");
    			add_location(div61, file$1, 179, 8, 6274);
    			attr_dev(div62, "class", "leaderboard-left svelte-1ba8a4r");
    			add_location(div62, file$1, 172, 6, 5934);
    			attr_dev(button1, "class", "action-button svelte-1ba8a4r");
    			add_location(button1, file$1, 189, 8, 6560);
    			attr_dev(button2, "class", "action-button svelte-1ba8a4r");
    			add_location(button2, file$1, 190, 8, 6624);
    			attr_dev(p3, "class", "promo-description svelte-1ba8a4r");
    			add_location(p3, file$1, 192, 8, 6693);
    			attr_dev(p4, "class", "svelte-1ba8a4r");
    			add_location(p4, file$1, 198, 12, 6949);
    			attr_dev(p5, "class", "svelte-1ba8a4r");
    			add_location(p5, file$1, 199, 12, 7061);
    			attr_dev(p6, "class", "svelte-1ba8a4r");
    			add_location(p6, file$1, 200, 12, 7115);
    			attr_dev(div63, "class", "additional-info svelte-1ba8a4r");
    			add_location(div63, file$1, 197, 10, 6907);
    			attr_dev(div64, "class", "actions-container svelte-1ba8a4r");
    			add_location(div64, file$1, 188, 6, 6520);
    			attr_dev(div65, "class", "leaderboard-right svelte-1ba8a4r");
    			add_location(div65, file$1, 187, 4, 6482);
    			attr_dev(div66, "class", "leaderboard-container svelte-1ba8a4r");
    			add_location(div66, file$1, 171, 4, 5892);
    			attr_dev(section2, "class", "third-screen svelte-1ba8a4r");
    			add_location(section2, file$1, 170, 2, 5857);
    			attr_dev(div67, "class", "page-wrapper svelte-1ba8a4r");

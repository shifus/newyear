    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-140qpsh");
    			add_location(img0, file$1, 17, 10, 520);
    			attr_dev(div0, "class", "candy-cane svelte-140qpsh");
    			add_location(div0, file$1, 18, 10, 592);
    			attr_dev(div1, "class", "logo-container svelte-140qpsh");
    			add_location(div1, file$1, 16, 8, 481);
    			attr_dev(div2, "class", "menu-item svelte-140qpsh");
    			add_location(div2, file$1, 21, 10, 675);
    			attr_dev(div3, "class", "menu-item svelte-140qpsh");
    			add_location(div3, file$1, 22, 10, 733);
    			attr_dev(div4, "class", "menu-item svelte-140qpsh");
    			add_location(div4, file$1, 23, 10, 782);
    			attr_dev(div5, "class", "menu svelte-140qpsh");
    			add_location(div5, file$1, 20, 8, 646);
    			attr_dev(div6, "class", "header svelte-140qpsh");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-140qpsh");
    			add_location(img1, file$1, 27, 8, 887);
    			attr_dev(div7, "class", "header-mobile svelte-140qpsh");
    			add_location(div7, file$1, 26, 6, 851);
    			attr_dev(span0, "class", "first-line svelte-140qpsh");
    			add_location(span0, file$1, 34, 12, 1134);
    			attr_dev(span1, "class", "second-line svelte-140qpsh");
    			add_location(span1, file$1, 35, 12, 1190);
    			attr_dev(h10, "class", "title svelte-140qpsh");
    			add_location(h10, file$1, 33, 10, 1103);
    			attr_dev(p0, "class", "description svelte-140qpsh");
    			add_location(p0, file$1, 38, 12, 1312);
    			attr_dev(p1, "class", "description description-secondary svelte-140qpsh");
    			add_location(p1, file$1, 44, 12, 1647);
    			attr_dev(div8, "class", "description-container svelte-140qpsh");
    			add_location(div8, file$1, 37, 10, 1264);
    			attr_dev(button0, "class", "promo-button svelte-140qpsh");
    			...
    			attr_dev(img2, "class", "santa-image svelte-140qpsh");
    			add_location(img2, file$1, 52, 12, 2023);
    			attr_dev(div9, "class", "promo-container svelte-140qpsh");
    			add_location(div9, file$1, 48, 10, 1857);
    			attr_dev(div10, "class", "left-side svelte-140qpsh");
    			...
    			attr_dev(img3, "class", "tree-image svelte-140qpsh");
    			...
    			attr_dev(img4, "class", "gifts-image svelte-140qpsh");
    			...
    			attr_dev(img5, "class", "star star-1 svelte-140qpsh");
    			...
    			attr_dev(img6, "class", "star star-2 svelte-140qpsh");
    			...
    			attr_dev(img7, "class", "star star-3 svelte-140qpsh");
    			add_location(img7, file$1, 62, 12, 2539);
    			attr_dev(div11, "class", "tree-container svelte-140qpsh");
    			add_location(div11, file$1, 57, 10, 2171);
    			attr_dev(div12, "class", "right-side svelte-140qpsh");
    			add_location(div12, file$1, 56, 8, 2136);
    			attr_dev(div13, "class", "content desktop-version svelte-140qpsh");
    			add_location(div13, file$1, 31, 6, 1023);
    			attr_dev(span2, "class", "first-line svelte-140qpsh");
    			add_location(span2, file$1, 71, 12, 2805);
    			attr_dev(span3, "class", "second-line svelte-140qpsh");
    			add_location(span3, file$1, 72, 12, 2861);
    			attr_dev(h11, "class", "title svelte-140qpsh");
    			add_location(h11, file$1, 70, 10, 2774);
    			attr_dev(p2, "class", "description svelte-140qpsh");
    			add_location(p2, file$1, 75, 12, 2983);
    			attr_dev(p3, "class", "description description-secondary svelte-140qpsh");
    			add_location(p3, file$1, 81, 12, 3318);
    			attr_dev(div14, "class", "description-container svelte-140qpsh");
    			add_location(div14, file$1, 74, 10, 2935);
    			attr_dev(button1, "class", "promo-button svelte-140qpsh");
    			...
    			attr_dev(img8, "class", "santa-image svelte-140qpsh");
    			add_location(img8, file$1, 89, 12, 3694);
    			attr_dev(div15, "class", "promo-container svelte-140qpsh");
    			add_location(div15, file$1, 85, 10, 3528);
    			attr_dev(div16, "class", "left-side svelte-140qpsh");
    			...
    			attr_dev(img9, "class", "tree-image svelte-140qpsh");
    			...
    			attr_dev(img10, "class", "gifts-image svelte-140qpsh");
    			...
    			attr_dev(img11, "class", "star star-1 svelte-140qpsh");
    			...
    			attr_dev(img12, "class", "star star-2 svelte-140qpsh");
    			...
    			attr_dev(img13, "class", "star star-3 svelte-140qpsh");
    			add_location(img13, file$1, 99, 12, 4210);
    			attr_dev(div17, "class", "tree-container svelte-140qpsh");
    			add_location(div17, file$1, 94, 10, 3842);
    			attr_dev(div18, "class", "right-side svelte-140qpsh");
    			add_location(div18, file$1, 93, 8, 3807);
    			attr_dev(div19, "class", "content mobile-container svelte-140qpsh");
    			add_location(div19, file$1, 68, 6, 2693);
    			attr_dev(section0, "class", "first-screen svelte-140qpsh");
    			add_location(section0, file$1, 14, 4, 415);
    			attr_dev(div20, "class", "screen-container svelte-140qpsh");
    			add_location(div20, file$1, 13, 2, 380);
    			attr_dev(span4, "class", "prize-label svelte-140qpsh");
    			add_location(span4, file$1, 111, 10, 4521);
    			attr_dev(div21, "class", "prize-header svelte-140qpsh");
    			add_location(div21, file$1, 110, 8, 4484);
    			attr_dev(h20, "class", "prize-title svelte-140qpsh");
    			add_location(h20, file$1, 114, 8, 4599);
    			attr_dev(span5, "class", "spec-label svelte-140qpsh");
    			add_location(span5, file$1, 119, 14, 4776);
    			attr_dev(span6, "class", "spec-value svelte-140qpsh");
    			add_location(span6, file$1, 120, 14, 4835);
    			attr_dev(div22, "class", "spec-item svelte-140qpsh");
    			add_location(div22, file$1, 118, 12, 4738);
    			attr_dev(span7, "class", "spec-label svelte-140qpsh");
    			add_location(span7, file$1, 123, 14, 4943);
    			attr_dev(span8, "class", "spec-value svelte-140qpsh");
    			add_location(span8, file$1, 124, 14, 4999);
    			attr_dev(div23, "class", "spec-item svelte-140qpsh");
    			add_location(div23, file$1, 122, 12, 4905);
    			attr_dev(div24, "class", "specs-column svelte-140qpsh");
    			add_location(div24, file$1, 117, 10, 4699);
    			attr_dev(span9, "class", "spec-label svelte-140qpsh");
    			add_location(span9, file$1, 129, 14, 5165);
    			attr_dev(span10, "class", "spec-value svelte-140qpsh");
    			add_location(span10, file$1, 130, 14, 5216);
    			attr_dev(div25, "class", "spec-item svelte-140qpsh");
    			add_location(div25, file$1, 128, 12, 5127);
    			attr_dev(span11, "class", "spec-label svelte-140qpsh");
    			add_location(span11, file$1, 133, 14, 5336);
    			attr_dev(span12, "class", "spec-value svelte-140qpsh");
    			add_location(span12, file$1, 134, 14, 5389);
    			attr_dev(div26, "class", "spec-item svelte-140qpsh");
    			add_location(div26, file$1, 132, 12, 5298);
    			attr_dev(div27, "class", "specs-column svelte-140qpsh");
    			add_location(div27, file$1, 127, 10, 5088);
    			attr_dev(div28, "class", "specs-container svelte-140qpsh");
    			...
    			attr_dev(img14, "class", "prize-image svelte-140qpsh");
    			...
    			attr_dev(img15, "class", "gift-decoration svelte-140qpsh");
    			attr_dev(img15, "alt", "gift");
    			set_style(img15, "position", "absolute");
    			set_style(img15, "top", "-80px");
    			set_style(img15, "right", "-20px");
    			set_style(img15, "width", "180px");
    			set_style(img15, "height", "auto");
    			set_style(img15, "z-index", "-1");
    			set_style(img15, "opacity", "1");
    			add_location(img15, file$1, 140, 8, 5579);
    			attr_dev(div29, "class", "main-prize svelte-140qpsh");
    			add_location(div29, file$1, 109, 6, 4451);
    			attr_dev(h30, "class", "prize-card-category svelte-140qpsh");
    			add_location(h30, file$1, 145, 10, 5845);
    			attr_dev(h40, "class", "prize-card-model svelte-140qpsh");
    			add_location(h40, file$1, 146, 10, 5901);
    			...
    			attr_dev(img16, "class", "prize-card-image svelte-140qpsh");
    			add_location(img16, file$1, 147, 10, 5961);
    			attr_dev(div30, "class", "prize-card svelte-140qpsh");
    			add_location(div30, file$1, 144, 8, 5810);
    			attr_dev(h31, "class", "prize-card-category svelte-140qpsh");
    			add_location(h31, file$1, 151, 10, 6101);
    			attr_dev(h41, "class", "prize-card-model svelte-140qpsh");
    			add_location(h41, file$1, 152, 10, 6160);
    			...
    			attr_dev(img17, "class", "prize-card-image svelte-140qpsh");
    			add_location(img17, file$1, 153, 10, 6220);
    			attr_dev(div31, "class", "prize-card svelte-140qpsh");
    			add_location(div31, file$1, 150, 8, 6066);
    			attr_dev(h32, "class", "prize-card-category svelte-140qpsh");
    			add_location(h32, file$1, 157, 10, 6362);
    			attr_dev(h42, "class", "prize-card-model svelte-140qpsh");
    			add_location(h42, file$1, 158, 10, 6423);
    			...
    			attr_dev(img18, "class", "prize-card-image svelte-140qpsh");
    			add_location(img18, file$1, 159, 10, 6484);
    			attr_dev(div32, "class", "prize-card svelte-140qpsh");
    			add_location(div32, file$1, 156, 8, 6327);
    			attr_dev(div33, "class", "additional-prizes svelte-140qpsh");
    			add_location(div33, file$1, 143, 6, 5770);
    			attr_dev(div34, "class", "header-place svelte-140qpsh");
    			add_location(div34, file$1, 166, 12, 6723);
    			attr_dev(div35, "class", "header-prize svelte-140qpsh");
    			add_location(div35, file$1, 167, 12, 6773);
    			attr_dev(div36, "class", "header-freebet svelte-140qpsh");
    			add_location(div36, file$1, 168, 12, 6822);
    			attr_dev(div37, "class", "leaderboard-headers svelte-140qpsh");
    			add_location(div37, file$1, 165, 10, 6677);
    			attr_dev(div38, "class", "place svelte-140qpsh");
    			add_location(div38, file$1, 173, 14, 6978);
    			attr_dev(div39, "class", "prize svelte-140qpsh");
    			add_location(div39, file$1, 174, 14, 7019);
    			attr_dev(div40, "class", "freebet svelte-140qpsh");
    			add_location(div40, file$1, 175, 14, 7072);
    			attr_dev(div41, "class", "leaderboard-row svelte-140qpsh");
    			add_location(div41, file$1, 172, 12, 6934);
    			attr_dev(div42, "class", "place svelte-140qpsh");
    			add_location(div42, file$1, 179, 14, 7184);
    			attr_dev(div43, "class", "prize svelte-140qpsh");
    			add_location(div43, file$1, 180, 14, 7225);
    			attr_dev(div44, "class", "freebet svelte-140qpsh");
    			add_location(div44, file$1, 181, 14, 7278);
    			attr_dev(div45, "class", "leaderboard-row svelte-140qpsh");
    			add_location(div45, file$1, 178, 12, 7140);
    			attr_dev(div46, "class", "place svelte-140qpsh");
    			add_location(div46, file$1, 185, 14, 7390);
    			attr_dev(div47, "class", "prize svelte-140qpsh");
    			add_location(div47, file$1, 186, 14, 7431);
    			attr_dev(div48, "class", "freebet svelte-140qpsh");
    			add_location(div48, file$1, 187, 14, 7484);
    			attr_dev(div49, "class", "leaderboard-row svelte-140qpsh");
    			add_location(div49, file$1, 184, 12, 7346);
    			attr_dev(div50, "class", "place svelte-140qpsh");
    			add_location(div50, file$1, 191, 14, 7596);
    			attr_dev(div51, "class", "prize svelte-140qpsh");
    			add_location(div51, file$1, 192, 14, 7637);
    			attr_dev(div52, "class", "freebet svelte-140qpsh");
    			add_location(div52, file$1, 193, 14, 7696);
    			attr_dev(div53, "class", "leaderboard-row svelte-140qpsh");
    			add_location(div53, file$1, 190, 12, 7552);
    			attr_dev(div54, "class", "place svelte-140qpsh");
    			add_location(div54, file$1, 197, 14, 7808);
    			attr_dev(div55, "class", "prize svelte-140qpsh");
    			add_location(div55, file$1, 198, 14, 7849);
    			attr_dev(div56, "class", "freebet svelte-140qpsh");
    			add_location(div56, file$1, 199, 14, 7908);
    			attr_dev(div57, "class", "leaderboard-row svelte-140qpsh");
    			add_location(div57, file$1, 196, 12, 7764);
    			attr_dev(div58, "class", "place svelte-140qpsh");
    			add_location(div58, file$1, 203, 14, 8020);
    			attr_dev(div59, "class", "prize svelte-140qpsh");
    			add_location(div59, file$1, 204, 14, 8064);
    			attr_dev(div60, "class", "freebet svelte-140qpsh");
    			add_location(div60, file$1, 205, 14, 8124);
    			attr_dev(div61, "class", "leaderboard-row svelte-140qpsh");
    			add_location(div61, file$1, 202, 12, 7976);
    			attr_dev(div62, "class", "leaderboard-rows svelte-140qpsh");
    			add_location(div62, file$1, 171, 10, 6891);
    			attr_dev(div63, "class", "leaderboard-content svelte-140qpsh");
    			add_location(div63, file$1, 164, 8, 6633);
    			attr_dev(div64, "class", "merch-images svelte-140qpsh");
    			add_location(div64, file$1, 212, 12, 8296);
    			attr_dev(span13, "class", "svelte-140qpsh");
    			add_location(span13, file$1, 216, 14, 8448);
    			attr_dev(div65, "class", "merch-status svelte-140qpsh");
    			add_location(div65, file$1, 215, 12, 8407);
    			attr_dev(div66, "class", "merch-content svelte-140qpsh");
    			add_location(div66, file$1, 211, 10, 8256);
    			attr_dev(div67, "class", "merch-column svelte-140qpsh");
    			add_location(div67, file$1, 210, 8, 8219);
    			attr_dev(div68, "class", "leaderboard svelte-140qpsh");
    			add_location(div68, file$1, 163, 6, 6599);
    			attr_dev(section1, "class", "second-screen svelte-140qpsh");
    			add_location(section1, file$1, 108, 4, 4413);
    			attr_dev(div69, "class", "screen-container svelte-140qpsh");
    			add_location(div69, file$1, 107, 2, 4378);
    			attr_dev(h21, "class", "leaderboard-title svelte-140qpsh");
    			add_location(h21, file$1, 228, 8, 8710);
    			attr_dev(p4, "class", "leaderboard-description svelte-140qpsh");
    			add_location(p4, file$1, 229, 8, 8770);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-140qpsh");
    			add_location(a, file$1, 232, 8, 8916);
    			attr_dev(div70, "class", "table-frame svelte-140qpsh");
    			add_location(div70, file$1, 236, 10, 9092);
    			attr_dev(div71, "class", "leaderboard-table svelte-140qpsh");
    			add_location(div71, file$1, 234, 8, 9011);
    			attr_dev(div72, "class", "leaderboard-left svelte-140qpsh");
    			add_location(div72, file$1, 227, 6, 8671);
    			attr_dev(button2, "class", "action-button svelte-140qpsh");
    			add_location(button2, file$1, 244, 8, 9297);
    			attr_dev(button3, "class", "action-button svelte-140qpsh");
    			add_location(button3, file$1, 245, 8, 9361);
    			attr_dev(p5, "class", "promo-description svelte-140qpsh");
    			add_location(p5, file$1, 247, 8, 9430);
    			attr_dev(p6, "class", "svelte-140qpsh");
    			add_location(p6, file$1, 253, 12, 9686);
    			attr_dev(p7, "class", "svelte-140qpsh");
    			add_location(p7, file$1, 254, 12, 9798);
    			attr_dev(p8, "class", "svelte-140qpsh");
    			add_location(p8, file$1, 255, 12, 9852);
    			attr_dev(div73, "class", "additional-info svelte-140qpsh");
    			add_location(div73, file$1, 252, 10, 9644);
    			attr_dev(div74, "class", "actions-container svelte-140qpsh");
    			add_location(div74, file$1, 243, 6, 9257);
    			attr_dev(div75, "class", "leaderboard-right svelte-140qpsh");
    			add_location(div75, file$1, 242, 4, 9219);
    			attr_dev(div76, "class", "leaderboard-container svelte-140qpsh");
    			add_location(div76, file$1, 226, 4, 8629);
    			attr_dev(section2, "class", "third-screen svelte-140qpsh");
    			add_location(section2, file$1, 225, 2, 8594);
    			attr_dev(div77, "class", "page-wrapper svelte-140qpsh");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div66, t120);
    			append_dev(div66, div65);
    			append_dev(div65, span13);
    			append_dev(div77, t122);
    			...
    			append_dev(div74, t133);
    			append_dev(div74, p5);
    			append_dev(div74, t135);
    			append_dev(div74, div73);
    			append_dev(div73, p6);
    			append_dev(div73, t137);
    			append_dev(div73, p7);
    			append_dev(div73, t139);
    			append_dev(div73, p8);

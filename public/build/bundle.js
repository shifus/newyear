    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-1sws20d");
    			add_location(img0, file$1, 17, 10, 521);
    			attr_dev(div0, "class", "candy-cane svelte-1sws20d");
    			add_location(div0, file$1, 18, 10, 593);
    			attr_dev(div1, "class", "logo-container svelte-1sws20d");
    			add_location(div1, file$1, 16, 8, 482);
    			attr_dev(div2, "class", "menu-item svelte-1sws20d");
    			add_location(div2, file$1, 21, 10, 676);
    			attr_dev(div3, "class", "menu-item svelte-1sws20d");
    			add_location(div3, file$1, 22, 10, 734);
    			attr_dev(div4, "class", "menu-item svelte-1sws20d");
    			add_location(div4, file$1, 23, 10, 783);
    			attr_dev(div5, "class", "menu svelte-1sws20d");
    			add_location(div5, file$1, 20, 8, 647);
    			attr_dev(div6, "class", "header svelte-1sws20d");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-1sws20d");
    			add_location(img1, file$1, 27, 8, 888);
    			attr_dev(div7, "class", "header-mobile svelte-1sws20d");
    			add_location(div7, file$1, 26, 6, 852);
    			attr_dev(br, "class", "svelte-1sws20d");
    			add_location(br, file$1, 33, 23, 1105);
    			attr_dev(h1, "class", "title svelte-1sws20d");
    			add_location(h1, file$1, 32, 10, 1063);
    			attr_dev(p0, "class", "description svelte-1sws20d");
    			add_location(p0, file$1, 36, 10, 1163);
    			attr_dev(p1, "class", "description svelte-1sws20d");
    			add_location(p1, file$1, 41, 10, 1475);
    			attr_dev(button0, "class", "promo-button svelte-1sws20d");
    			add_location(button0, file$1, 44, 10, 1639);
    			attr_dev(div8, "class", "left-side svelte-1sws20d");
    			add_location(div8, file$1, 31, 8, 1029);
    			...
    			attr_dev(img2, "class", "tree-image svelte-1sws20d");
    			add_location(img2, file$1, 49, 10, 1805);
    			attr_dev(div9, "class", "right-side svelte-1sws20d");
    			add_location(div9, file$1, 48, 8, 1770);
    			attr_dev(div10, "class", "content svelte-1sws20d");
    			add_location(div10, file$1, 30, 6, 999);
    			attr_dev(section0, "class", "first-screen svelte-1sws20d");
    			add_location(section0, file$1, 14, 4, 416);
    			attr_dev(div11, "class", "screen-container svelte-1sws20d");
    			add_location(div11, file$1, 13, 2, 381);
    			attr_dev(span0, "class", "prize-label svelte-1sws20d");
    			add_location(span0, file$1, 60, 10, 2109);
    			attr_dev(div12, "class", "prize-header svelte-1sws20d");
    			add_location(div12, file$1, 59, 8, 2072);
    			attr_dev(h20, "class", "prize-title svelte-1sws20d");
    			add_location(h20, file$1, 63, 8, 2187);
    			attr_dev(span1, "class", "spec-label svelte-1sws20d");
    			add_location(span1, file$1, 68, 14, 2364);
    			attr_dev(span2, "class", "spec-value svelte-1sws20d");
    			add_location(span2, file$1, 69, 14, 2423);
    			attr_dev(div13, "class", "spec-item svelte-1sws20d");
    			add_location(div13, file$1, 67, 12, 2326);
    			attr_dev(span3, "class", "spec-label svelte-1sws20d");
    			add_location(span3, file$1, 72, 14, 2531);
    			attr_dev(span4, "class", "spec-value svelte-1sws20d");
    			add_location(span4, file$1, 73, 14, 2587);
    			attr_dev(div14, "class", "spec-item svelte-1sws20d");
    			add_location(div14, file$1, 71, 12, 2493);
    			attr_dev(div15, "class", "specs-column svelte-1sws20d");
    			add_location(div15, file$1, 66, 10, 2287);
    			attr_dev(span5, "class", "spec-label svelte-1sws20d");
    			add_location(span5, file$1, 78, 14, 2753);
    			attr_dev(span6, "class", "spec-value svelte-1sws20d");
    			add_location(span6, file$1, 79, 14, 2804);
    			attr_dev(div16, "class", "spec-item svelte-1sws20d");
    			add_location(div16, file$1, 77, 12, 2715);
    			attr_dev(span7, "class", "spec-label svelte-1sws20d");
    			add_location(span7, file$1, 82, 14, 2924);
    			attr_dev(span8, "class", "spec-value svelte-1sws20d");
    			add_location(span8, file$1, 83, 14, 2977);
    			attr_dev(div17, "class", "spec-item svelte-1sws20d");
    			add_location(div17, file$1, 81, 12, 2886);
    			attr_dev(div18, "class", "specs-column svelte-1sws20d");
    			add_location(div18, file$1, 76, 10, 2676);
    			attr_dev(div19, "class", "specs-container svelte-1sws20d");
    			add_location(div19, file$1, 65, 8, 2247);
    			...
    			attr_dev(img3, "class", "prize-image svelte-1sws20d");
    			add_location(img3, file$1, 88, 8, 3083);
    			attr_dev(div20, "class", "main-prize svelte-1sws20d");
    			add_location(div20, file$1, 58, 6, 2039);
    			attr_dev(h30, "class", "prize-card-category svelte-1sws20d");
    			add_location(h30, file$1, 93, 10, 3254);
    			attr_dev(h40, "class", "prize-card-model svelte-1sws20d");
    			add_location(h40, file$1, 94, 10, 3310);
    			...
    			attr_dev(img4, "class", "prize-card-image svelte-1sws20d");
    			add_location(img4, file$1, 95, 10, 3370);
    			attr_dev(div21, "class", "prize-card svelte-1sws20d");
    			add_location(div21, file$1, 92, 8, 3219);
    			attr_dev(h31, "class", "prize-card-category svelte-1sws20d");
    			add_location(h31, file$1, 99, 10, 3510);
    			attr_dev(h41, "class", "prize-card-model svelte-1sws20d");
    			add_location(h41, file$1, 100, 10, 3569);
    			...
    			attr_dev(img5, "class", "prize-card-image svelte-1sws20d");
    			add_location(img5, file$1, 101, 10, 3629);
    			attr_dev(div22, "class", "prize-card svelte-1sws20d");
    			add_location(div22, file$1, 98, 8, 3475);
    			attr_dev(h32, "class", "prize-card-category svelte-1sws20d");
    			add_location(h32, file$1, 105, 10, 3771);
    			attr_dev(h42, "class", "prize-card-model svelte-1sws20d");
    			add_location(h42, file$1, 106, 10, 3832);
    			...
    			attr_dev(img6, "class", "prize-card-image svelte-1sws20d");
    			add_location(img6, file$1, 107, 10, 3893);
    			attr_dev(div23, "class", "prize-card svelte-1sws20d");
    			add_location(div23, file$1, 104, 8, 3736);
    			attr_dev(div24, "class", "additional-prizes svelte-1sws20d");
    			add_location(div24, file$1, 91, 6, 3179);
    			attr_dev(div25, "class", "header-place svelte-1sws20d");
    			add_location(div25, file$1, 114, 12, 4132);
    			attr_dev(div26, "class", "header-prize svelte-1sws20d");
    			add_location(div26, file$1, 115, 12, 4182);
    			attr_dev(div27, "class", "header-freebet svelte-1sws20d");
    			add_location(div27, file$1, 116, 12, 4231);
    			attr_dev(div28, "class", "leaderboard-headers svelte-1sws20d");
    			add_location(div28, file$1, 113, 10, 4086);
    			attr_dev(div29, "class", "place svelte-1sws20d");
    			add_location(div29, file$1, 121, 14, 4387);
    			attr_dev(div30, "class", "prize svelte-1sws20d");
    			add_location(div30, file$1, 122, 14, 4428);
    			attr_dev(div31, "class", "freebet svelte-1sws20d");
    			add_location(div31, file$1, 123, 14, 4481);
    			attr_dev(div32, "class", "leaderboard-row svelte-1sws20d");
    			add_location(div32, file$1, 120, 12, 4343);
    			attr_dev(div33, "class", "place svelte-1sws20d");
    			add_location(div33, file$1, 127, 14, 4593);
    			attr_dev(div34, "class", "prize svelte-1sws20d");
    			add_location(div34, file$1, 128, 14, 4634);
    			attr_dev(div35, "class", "freebet svelte-1sws20d");
    			add_location(div35, file$1, 129, 14, 4687);
    			attr_dev(div36, "class", "leaderboard-row svelte-1sws20d");
    			add_location(div36, file$1, 126, 12, 4549);
    			attr_dev(div37, "class", "place svelte-1sws20d");
    			add_location(div37, file$1, 133, 14, 4799);
    			attr_dev(div38, "class", "prize svelte-1sws20d");
    			add_location(div38, file$1, 134, 14, 4840);
    			attr_dev(div39, "class", "freebet svelte-1sws20d");
    			add_location(div39, file$1, 135, 14, 4893);
    			attr_dev(div40, "class", "leaderboard-row svelte-1sws20d");
    			add_location(div40, file$1, 132, 12, 4755);
    			attr_dev(div41, "class", "place svelte-1sws20d");
    			add_location(div41, file$1, 139, 14, 5005);
    			attr_dev(div42, "class", "prize svelte-1sws20d");
    			add_location(div42, file$1, 140, 14, 5046);
    			attr_dev(div43, "class", "freebet svelte-1sws20d");
    			add_location(div43, file$1, 141, 14, 5105);
    			attr_dev(div44, "class", "leaderboard-row svelte-1sws20d");
    			add_location(div44, file$1, 138, 12, 4961);
    			attr_dev(div45, "class", "place svelte-1sws20d");
    			add_location(div45, file$1, 145, 14, 5217);
    			attr_dev(div46, "class", "prize svelte-1sws20d");
    			add_location(div46, file$1, 146, 14, 5258);
    			attr_dev(div47, "class", "freebet svelte-1sws20d");
    			add_location(div47, file$1, 147, 14, 5317);
    			attr_dev(div48, "class", "leaderboard-row svelte-1sws20d");
    			add_location(div48, file$1, 144, 12, 5173);
    			attr_dev(div49, "class", "place svelte-1sws20d");
    			add_location(div49, file$1, 151, 14, 5429);
    			attr_dev(div50, "class", "prize svelte-1sws20d");
    			add_location(div50, file$1, 152, 14, 5473);
    			attr_dev(div51, "class", "freebet svelte-1sws20d");
    			add_location(div51, file$1, 153, 14, 5533);
    			attr_dev(div52, "class", "leaderboard-row svelte-1sws20d");
    			add_location(div52, file$1, 150, 12, 5385);
    			attr_dev(div53, "class", "leaderboard-rows svelte-1sws20d");
    			add_location(div53, file$1, 119, 10, 4300);
    			attr_dev(div54, "class", "leaderboard-content svelte-1sws20d");
    			add_location(div54, file$1, 112, 8, 4042);
    			attr_dev(div55, "class", "merch-images svelte-1sws20d");
    			add_location(div55, file$1, 160, 12, 5705);
    			attr_dev(span9, "class", "svelte-1sws20d");
    			add_location(span9, file$1, 164, 14, 5857);
    			attr_dev(div56, "class", "merch-status svelte-1sws20d");
    			add_location(div56, file$1, 163, 12, 5816);
    			attr_dev(div57, "class", "merch-content svelte-1sws20d");
    			add_location(div57, file$1, 159, 10, 5665);
    			attr_dev(div58, "class", "merch-column svelte-1sws20d");
    			add_location(div58, file$1, 158, 8, 5628);
    			attr_dev(div59, "class", "leaderboard svelte-1sws20d");
    			add_location(div59, file$1, 111, 6, 4008);
    			attr_dev(section1, "class", "second-screen svelte-1sws20d");
    			add_location(section1, file$1, 57, 4, 2001);
    			attr_dev(div60, "class", "screen-container svelte-1sws20d");
    			add_location(div60, file$1, 56, 2, 1966);
    			attr_dev(h21, "class", "leaderboard-title svelte-1sws20d");
    			add_location(h21, file$1, 176, 8, 6119);
    			attr_dev(p2, "class", "leaderboard-description svelte-1sws20d");
    			add_location(p2, file$1, 177, 8, 6179);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-1sws20d");
    			add_location(a, file$1, 180, 8, 6325);
    			attr_dev(div61, "class", "table-frame svelte-1sws20d");
    			add_location(div61, file$1, 184, 10, 6501);
    			attr_dev(div62, "class", "leaderboard-table svelte-1sws20d");
    			add_location(div62, file$1, 182, 8, 6420);
    			attr_dev(div63, "class", "leaderboard-left svelte-1sws20d");
    			add_location(div63, file$1, 175, 6, 6080);
    			attr_dev(button1, "class", "action-button svelte-1sws20d");
    			add_location(button1, file$1, 192, 8, 6706);
    			attr_dev(button2, "class", "action-button svelte-1sws20d");
    			add_location(button2, file$1, 193, 8, 6770);
    			attr_dev(p3, "class", "promo-description svelte-1sws20d");
    			add_location(p3, file$1, 195, 8, 6839);
    			attr_dev(p4, "class", "svelte-1sws20d");
    			add_location(p4, file$1, 201, 12, 7095);
    			attr_dev(p5, "class", "svelte-1sws20d");
    			add_location(p5, file$1, 202, 12, 7207);
    			attr_dev(p6, "class", "svelte-1sws20d");
    			add_location(p6, file$1, 203, 12, 7261);
    			attr_dev(div64, "class", "additional-info svelte-1sws20d");
    			add_location(div64, file$1, 200, 10, 7053);
    			attr_dev(div65, "class", "actions-container svelte-1sws20d");
    			add_location(div65, file$1, 191, 6, 6666);
    			attr_dev(div66, "class", "leaderboard-right svelte-1sws20d");
    			add_location(div66, file$1, 190, 4, 6628);
    			attr_dev(div67, "class", "leaderboard-container svelte-1sws20d");
    			add_location(div67, file$1, 174, 4, 6038);
    			attr_dev(section2, "class", "third-screen svelte-1sws20d");
    			add_location(section2, file$1, 173, 2, 6003);
    			attr_dev(div68, "class", "page-wrapper svelte-1sws20d");

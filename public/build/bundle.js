    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(source, "class", "svelte-4rbpar");
    			...
    			attr_dev(img0, "class", "header-image svelte-4rbpar");
    			add_location(img0, file$1, 19, 8, 656);
    			attr_dev(picture, "class", "svelte-4rbpar");
    			add_location(picture, file$1, 15, 6, 493);
    			attr_dev(br, "class", "svelte-4rbpar");
    			add_location(br, file$1, 25, 23, 853);
    			attr_dev(h1, "class", "title svelte-4rbpar");
    			add_location(h1, file$1, 24, 10, 811);
    			attr_dev(p0, "class", "description svelte-4rbpar");
    			add_location(p0, file$1, 28, 10, 911);
    			attr_dev(p1, "class", "description svelte-4rbpar");
    			add_location(p1, file$1, 33, 10, 1223);
    			attr_dev(button0, "class", "promo-button svelte-4rbpar");
    			add_location(button0, file$1, 37, 10, 1434);
    			attr_dev(div0, "class", "left-side svelte-4rbpar");
    			...
    			attr_dev(img1, "class", "tree-image svelte-4rbpar");
    			add_location(img1, file$1, 42, 10, 1600);
    			attr_dev(div1, "class", "right-side svelte-4rbpar");
    			add_location(div1, file$1, 41, 8, 1565);
    			attr_dev(div2, "class", "content svelte-4rbpar");
    			add_location(div2, file$1, 22, 6, 747);
    			attr_dev(section0, "class", "first-screen svelte-4rbpar");
    			add_location(section0, file$1, 14, 4, 456);
    			attr_dev(div3, "class", "screen-container svelte-4rbpar");
    			add_location(div3, file$1, 13, 2, 421);
    			attr_dev(span0, "class", "prize-label svelte-4rbpar");
    			add_location(span0, file$1, 53, 10, 1904);
    			attr_dev(div4, "class", "prize-header svelte-4rbpar");
    			add_location(div4, file$1, 52, 8, 1867);
    			attr_dev(h20, "class", "prize-title svelte-4rbpar");
    			add_location(h20, file$1, 56, 8, 1982);
    			attr_dev(span1, "class", "spec-label svelte-4rbpar");
    			add_location(span1, file$1, 61, 14, 2159);
    			attr_dev(span2, "class", "spec-value svelte-4rbpar");
    			add_location(span2, file$1, 62, 14, 2218);
    			attr_dev(div5, "class", "spec-item svelte-4rbpar");
    			add_location(div5, file$1, 60, 12, 2121);
    			attr_dev(span3, "class", "spec-label svelte-4rbpar");
    			add_location(span3, file$1, 65, 14, 2326);
    			attr_dev(span4, "class", "spec-value svelte-4rbpar");
    			add_location(span4, file$1, 66, 14, 2382);
    			attr_dev(div6, "class", "spec-item svelte-4rbpar");
    			add_location(div6, file$1, 64, 12, 2288);
    			attr_dev(div7, "class", "specs-column svelte-4rbpar");
    			add_location(div7, file$1, 59, 10, 2082);
    			attr_dev(span5, "class", "spec-label svelte-4rbpar");
    			add_location(span5, file$1, 71, 14, 2548);
    			attr_dev(span6, "class", "spec-value svelte-4rbpar");
    			add_location(span6, file$1, 72, 14, 2599);
    			attr_dev(div8, "class", "spec-item svelte-4rbpar");
    			add_location(div8, file$1, 70, 12, 2510);
    			attr_dev(span7, "class", "spec-label svelte-4rbpar");
    			add_location(span7, file$1, 75, 14, 2719);
    			attr_dev(span8, "class", "spec-value svelte-4rbpar");
    			add_location(span8, file$1, 76, 14, 2772);
    			attr_dev(div9, "class", "spec-item svelte-4rbpar");
    			add_location(div9, file$1, 74, 12, 2681);
    			attr_dev(div10, "class", "specs-column svelte-4rbpar");
    			add_location(div10, file$1, 69, 10, 2471);
    			attr_dev(div11, "class", "specs-container svelte-4rbpar");
    			...
    			attr_dev(img2, "class", "prize-image svelte-4rbpar");
    			add_location(img2, file$1, 81, 8, 2878);
    			attr_dev(div12, "class", "main-prize svelte-4rbpar");
    			add_location(div12, file$1, 51, 6, 1834);
    			attr_dev(h30, "class", "prize-card-category svelte-4rbpar");
    			add_location(h30, file$1, 86, 10, 3049);
    			attr_dev(h40, "class", "prize-card-model svelte-4rbpar");
    			...
    			attr_dev(img3, "class", "prize-card-image svelte-4rbpar");
    			add_location(img3, file$1, 88, 10, 3165);
    			attr_dev(div13, "class", "prize-card svelte-4rbpar");
    			add_location(div13, file$1, 85, 8, 3014);
    			attr_dev(h31, "class", "prize-card-category svelte-4rbpar");
    			add_location(h31, file$1, 92, 10, 3305);
    			attr_dev(h41, "class", "prize-card-model svelte-4rbpar");
    			...
    			attr_dev(img4, "class", "prize-card-image svelte-4rbpar");
    			add_location(img4, file$1, 94, 10, 3424);
    			attr_dev(div14, "class", "prize-card svelte-4rbpar");
    			add_location(div14, file$1, 91, 8, 3270);
    			attr_dev(h32, "class", "prize-card-category svelte-4rbpar");
    			add_location(h32, file$1, 98, 10, 3566);
    			attr_dev(h42, "class", "prize-card-model svelte-4rbpar");
    			...
    			attr_dev(img5, "class", "prize-card-image svelte-4rbpar");
    			add_location(img5, file$1, 100, 10, 3688);
    			attr_dev(div15, "class", "prize-card svelte-4rbpar");
    			add_location(div15, file$1, 97, 8, 3531);
    			attr_dev(div16, "class", "additional-prizes svelte-4rbpar");
    			add_location(div16, file$1, 84, 6, 2974);
    			attr_dev(div17, "class", "header-place svelte-4rbpar");
    			add_location(div17, file$1, 107, 12, 3927);
    			attr_dev(div18, "class", "header-prize svelte-4rbpar");
    			add_location(div18, file$1, 108, 12, 3977);
    			attr_dev(div19, "class", "header-freebet svelte-4rbpar");
    			add_location(div19, file$1, 109, 12, 4026);
    			attr_dev(div20, "class", "leaderboard-headers svelte-4rbpar");
    			add_location(div20, file$1, 106, 10, 3881);
    			attr_dev(div21, "class", "place svelte-4rbpar");
    			add_location(div21, file$1, 114, 14, 4182);
    			attr_dev(div22, "class", "prize svelte-4rbpar");
    			add_location(div22, file$1, 115, 14, 4223);
    			attr_dev(div23, "class", "freebet svelte-4rbpar");
    			add_location(div23, file$1, 116, 14, 4276);
    			attr_dev(div24, "class", "leaderboard-row svelte-4rbpar");
    			add_location(div24, file$1, 113, 12, 4138);
    			attr_dev(div25, "class", "place svelte-4rbpar");
    			add_location(div25, file$1, 120, 14, 4388);
    			attr_dev(div26, "class", "prize svelte-4rbpar");
    			add_location(div26, file$1, 121, 14, 4429);
    			attr_dev(div27, "class", "freebet svelte-4rbpar");
    			add_location(div27, file$1, 122, 14, 4482);
    			attr_dev(div28, "class", "leaderboard-row svelte-4rbpar");
    			add_location(div28, file$1, 119, 12, 4344);
    			attr_dev(div29, "class", "place svelte-4rbpar");
    			add_location(div29, file$1, 126, 14, 4594);
    			attr_dev(div30, "class", "prize svelte-4rbpar");
    			add_location(div30, file$1, 127, 14, 4635);
    			attr_dev(div31, "class", "freebet svelte-4rbpar");
    			add_location(div31, file$1, 128, 14, 4688);
    			attr_dev(div32, "class", "leaderboard-row svelte-4rbpar");
    			add_location(div32, file$1, 125, 12, 4550);
    			attr_dev(div33, "class", "place svelte-4rbpar");
    			add_location(div33, file$1, 132, 14, 4800);
    			attr_dev(div34, "class", "prize svelte-4rbpar");
    			add_location(div34, file$1, 133, 14, 4841);
    			attr_dev(div35, "class", "freebet svelte-4rbpar");
    			add_location(div35, file$1, 134, 14, 4900);
    			attr_dev(div36, "class", "leaderboard-row svelte-4rbpar");
    			add_location(div36, file$1, 131, 12, 4756);
    			attr_dev(div37, "class", "place svelte-4rbpar");
    			add_location(div37, file$1, 138, 14, 5012);
    			attr_dev(div38, "class", "prize svelte-4rbpar");
    			add_location(div38, file$1, 139, 14, 5053);
    			attr_dev(div39, "class", "freebet svelte-4rbpar");
    			add_location(div39, file$1, 140, 14, 5112);
    			attr_dev(div40, "class", "leaderboard-row svelte-4rbpar");
    			add_location(div40, file$1, 137, 12, 4968);
    			attr_dev(div41, "class", "place svelte-4rbpar");
    			add_location(div41, file$1, 144, 14, 5224);
    			attr_dev(div42, "class", "prize svelte-4rbpar");
    			add_location(div42, file$1, 145, 14, 5268);
    			attr_dev(div43, "class", "freebet svelte-4rbpar");
    			add_location(div43, file$1, 146, 14, 5328);
    			attr_dev(div44, "class", "leaderboard-row svelte-4rbpar");
    			add_location(div44, file$1, 143, 12, 5180);
    			attr_dev(div45, "class", "leaderboard-rows svelte-4rbpar");
    			add_location(div45, file$1, 112, 10, 4095);
    			attr_dev(div46, "class", "leaderboard-content svelte-4rbpar");
    			add_location(div46, file$1, 105, 8, 3837);
    			attr_dev(div47, "class", "merch-images svelte-4rbpar");
    			add_location(div47, file$1, 153, 12, 5500);
    			attr_dev(span9, "class", "svelte-4rbpar");
    			add_location(span9, file$1, 157, 14, 5652);
    			attr_dev(div48, "class", "merch-status svelte-4rbpar");
    			add_location(div48, file$1, 156, 12, 5611);
    			attr_dev(div49, "class", "merch-content svelte-4rbpar");
    			add_location(div49, file$1, 152, 10, 5460);
    			attr_dev(div50, "class", "merch-column svelte-4rbpar");
    			add_location(div50, file$1, 151, 8, 5423);
    			attr_dev(div51, "class", "leaderboard svelte-4rbpar");
    			add_location(div51, file$1, 104, 6, 3803);
    			attr_dev(section1, "class", "second-screen svelte-4rbpar");
    			add_location(section1, file$1, 50, 4, 1796);
    			attr_dev(div52, "class", "screen-container svelte-4rbpar");
    			add_location(div52, file$1, 49, 2, 1761);
    			attr_dev(div53, "class", "screen1 svelte-4rbpar");
    			add_location(div53, file$1, 166, 2, 5811);
    			attr_dev(div54, "class", "page-wrapper svelte-4rbpar");
    			add_location(div54, file$1, 11, 0, 368);
    			attr_dev(h21, "class", "leaderboard-title svelte-4rbpar");
    			add_location(h21, file$1, 181, 6, 6244);
    			attr_dev(p2, "class", "leaderboard-description svelte-4rbpar");
    			add_location(p2, file$1, 182, 6, 6302);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-4rbpar");
    			add_location(a, file$1, 185, 6, 6442);
    			attr_dev(div55, "class", "table-frame svelte-4rbpar");
    			add_location(div55, file$1, 189, 8, 6610);
    			attr_dev(div56, "class", "leaderboard-table svelte-4rbpar");
    			add_location(div56, file$1, 187, 6, 6533);
    			attr_dev(div57, "class", "leaderboard-left svelte-4rbpar");
    			add_location(div57, file$1, 180, 4, 6207);
    			attr_dev(button1, "class", "action-button svelte-4rbpar");
    			add_location(button1, file$1, 197, 8, 6807);
    			attr_dev(button2, "class", "action-button svelte-4rbpar");
    			add_location(button2, file$1, 198, 8, 6871);
    			attr_dev(p3, "class", "promo-description svelte-4rbpar");
    			add_location(p3, file$1, 200, 8, 6940);
    			attr_dev(p4, "class", "svelte-4rbpar");
    			add_location(p4, file$1, 206, 10, 7194);
    			attr_dev(p5, "class", "svelte-4rbpar");
    			add_location(p5, file$1, 207, 10, 7304);
    			attr_dev(p6, "class", "svelte-4rbpar");
    			add_location(p6, file$1, 208, 10, 7356);
    			attr_dev(div58, "class", "additional-info svelte-4rbpar");
    			add_location(div58, file$1, 205, 8, 7154);
    			attr_dev(div59, "class", "actions-container svelte-4rbpar");
    			add_location(div59, file$1, 196, 6, 6767);
    			attr_dev(div60, "class", "leaderboard-right svelte-4rbpar");
    			add_location(div60, file$1, 195, 4, 6729);
    			attr_dev(div61, "class", "leaderboard-container svelte-4rbpar");
    			add_location(div61, file$1, 179, 2, 6167);
    			attr_dev(section2, "class", "third-screen svelte-4rbpar");

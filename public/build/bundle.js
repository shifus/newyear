    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-1qpwu2v");
    			add_location(img0, file$1, 17, 10, 520);
    			attr_dev(div0, "class", "candy-cane svelte-1qpwu2v");
    			add_location(div0, file$1, 18, 10, 592);
    			attr_dev(div1, "class", "logo-container svelte-1qpwu2v");
    			add_location(div1, file$1, 16, 8, 481);
    			attr_dev(div2, "class", "menu-item svelte-1qpwu2v");
    			add_location(div2, file$1, 21, 10, 675);
    			attr_dev(div3, "class", "menu-item svelte-1qpwu2v");
    			add_location(div3, file$1, 22, 10, 733);
    			attr_dev(div4, "class", "menu-item svelte-1qpwu2v");
    			add_location(div4, file$1, 23, 10, 782);
    			attr_dev(div5, "class", "menu svelte-1qpwu2v");
    			add_location(div5, file$1, 20, 8, 646);
    			attr_dev(div6, "class", "header svelte-1qpwu2v");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-1qpwu2v");
    			add_location(img1, file$1, 27, 8, 887);
    			attr_dev(div7, "class", "header-mobile svelte-1qpwu2v");
    			add_location(div7, file$1, 26, 6, 851);
    			attr_dev(span0, "class", "first-line svelte-1qpwu2v");
    			add_location(span0, file$1, 34, 12, 1134);
    			attr_dev(span1, "class", "second-line svelte-1qpwu2v");
    			add_location(span1, file$1, 35, 12, 1190);
    			attr_dev(h10, "class", "title svelte-1qpwu2v");
    			add_location(h10, file$1, 33, 10, 1103);
    			attr_dev(p0, "class", "description svelte-1qpwu2v");
    			add_location(p0, file$1, 38, 12, 1312);
    			attr_dev(p1, "class", "description description-secondary svelte-1qpwu2v");
    			add_location(p1, file$1, 44, 12, 1647);
    			attr_dev(div8, "class", "description-container svelte-1qpwu2v");
    			add_location(div8, file$1, 37, 10, 1264);
    			attr_dev(button0, "class", "promo-button svelte-1qpwu2v");
    			...
    			attr_dev(img2, "class", "santa-image svelte-1qpwu2v");
    			add_location(img2, file$1, 52, 12, 2023);
    			attr_dev(div9, "class", "promo-container svelte-1qpwu2v");
    			add_location(div9, file$1, 48, 10, 1857);
    			attr_dev(div10, "class", "left-side svelte-1qpwu2v");
    			...
    			attr_dev(img3, "class", "tree-image svelte-1qpwu2v");
    			...
    			attr_dev(img4, "class", "gifts-image svelte-1qpwu2v");
    			...
    			attr_dev(img5, "class", "star star-1 svelte-1qpwu2v");
    			...
    			attr_dev(img6, "class", "star star-2 svelte-1qpwu2v");
    			...
    			attr_dev(img7, "class", "star star-3 svelte-1qpwu2v");
    			add_location(img7, file$1, 62, 12, 2539);
    			attr_dev(div11, "class", "tree-container svelte-1qpwu2v");
    			add_location(div11, file$1, 57, 10, 2171);
    			attr_dev(div12, "class", "right-side svelte-1qpwu2v");
    			add_location(div12, file$1, 56, 8, 2136);
    			attr_dev(div13, "class", "content desktop-version svelte-1qpwu2v");
    			add_location(div13, file$1, 31, 6, 1023);
    			attr_dev(span2, "class", "first-line svelte-1qpwu2v");
    			add_location(span2, file$1, 71, 12, 2805);
    			attr_dev(span3, "class", "second-line svelte-1qpwu2v");
    			add_location(span3, file$1, 72, 12, 2861);
    			attr_dev(h11, "class", "title svelte-1qpwu2v");
    			add_location(h11, file$1, 70, 10, 2774);
    			attr_dev(p2, "class", "description svelte-1qpwu2v");
    			add_location(p2, file$1, 75, 12, 2983);
    			attr_dev(p3, "class", "description description-secondary svelte-1qpwu2v");
    			add_location(p3, file$1, 81, 12, 3318);
    			attr_dev(div14, "class", "description-container svelte-1qpwu2v");
    			add_location(div14, file$1, 74, 10, 2935);
    			attr_dev(button1, "class", "promo-button svelte-1qpwu2v");
    			...
    			attr_dev(img8, "class", "santa-image svelte-1qpwu2v");
    			add_location(img8, file$1, 89, 12, 3694);
    			attr_dev(div15, "class", "promo-container svelte-1qpwu2v");
    			add_location(div15, file$1, 85, 10, 3528);
    			attr_dev(div16, "class", "left-side svelte-1qpwu2v");
    			...
    			attr_dev(img9, "class", "tree-image svelte-1qpwu2v");
    			...
    			attr_dev(img10, "class", "gifts-image svelte-1qpwu2v");
    			...
    			attr_dev(img11, "class", "star star-1 svelte-1qpwu2v");
    			...
    			attr_dev(img12, "class", "star star-2 svelte-1qpwu2v");
    			...
    			attr_dev(img13, "class", "star star-3 svelte-1qpwu2v");
    			add_location(img13, file$1, 99, 12, 4210);
    			attr_dev(div17, "class", "tree-container svelte-1qpwu2v");
    			add_location(div17, file$1, 94, 10, 3842);
    			attr_dev(div18, "class", "right-side svelte-1qpwu2v");
    			add_location(div18, file$1, 93, 8, 3807);
    			attr_dev(div19, "class", "content mobile-container svelte-1qpwu2v");
    			add_location(div19, file$1, 68, 6, 2693);
    			attr_dev(section0, "class", "first-screen svelte-1qpwu2v");
    			add_location(section0, file$1, 14, 4, 415);
    			attr_dev(div20, "class", "screen-container svelte-1qpwu2v");
    			add_location(div20, file$1, 13, 2, 380);
    			attr_dev(span4, "class", "prize-label svelte-1qpwu2v");
    			add_location(span4, file$1, 111, 10, 4549);
    			attr_dev(div21, "class", "prize-header svelte-1qpwu2v");
    			add_location(div21, file$1, 110, 8, 4512);
    			attr_dev(h2, "class", "prize-title svelte-1qpwu2v");
    			add_location(h2, file$1, 114, 8, 4627);
    			attr_dev(span5, "class", "spec-label svelte-1qpwu2v");
    			add_location(span5, file$1, 119, 14, 4804);
    			attr_dev(span6, "class", "spec-value svelte-1qpwu2v");
    			add_location(span6, file$1, 120, 14, 4863);
    			attr_dev(div22, "class", "spec-item svelte-1qpwu2v");
    			add_location(div22, file$1, 118, 12, 4766);
    			attr_dev(span7, "class", "spec-label svelte-1qpwu2v");
    			add_location(span7, file$1, 123, 14, 4971);
    			attr_dev(span8, "class", "spec-value svelte-1qpwu2v");
    			add_location(span8, file$1, 124, 14, 5027);
    			attr_dev(div23, "class", "spec-item svelte-1qpwu2v");
    			add_location(div23, file$1, 122, 12, 4933);
    			attr_dev(div24, "class", "specs-column svelte-1qpwu2v");
    			add_location(div24, file$1, 117, 10, 4727);
    			attr_dev(span9, "class", "spec-label svelte-1qpwu2v");
    			add_location(span9, file$1, 129, 14, 5193);
    			attr_dev(span10, "class", "spec-value svelte-1qpwu2v");
    			add_location(span10, file$1, 130, 14, 5244);
    			attr_dev(div25, "class", "spec-item svelte-1qpwu2v");
    			add_location(div25, file$1, 128, 12, 5155);
    			attr_dev(span11, "class", "spec-label svelte-1qpwu2v");
    			add_location(span11, file$1, 133, 14, 5364);
    			attr_dev(span12, "class", "spec-value svelte-1qpwu2v");
    			add_location(span12, file$1, 134, 14, 5417);
    			attr_dev(div26, "class", "spec-item svelte-1qpwu2v");
    			add_location(div26, file$1, 132, 12, 5326);
    			attr_dev(div27, "class", "specs-column svelte-1qpwu2v");
    			add_location(div27, file$1, 127, 10, 5116);
    			attr_dev(div28, "class", "specs-container svelte-1qpwu2v");
    			...
    			attr_dev(img14, "class", "prize-image svelte-1qpwu2v");
    			...
    			attr_dev(img15, "class", "gift-decoration svelte-1qpwu2v");
    			...
    			attr_dev(div29, "class", "main-prize svelte-1qpwu2v");
    			set_style(div29, "position", "relative");
    			add_location(div29, file$1, 109, 6, 4451);
    			attr_dev(h30, "class", "prize-card-category svelte-1qpwu2v");
    			add_location(h30, file$1, 145, 10, 5887);
    			attr_dev(h40, "class", "prize-card-model svelte-1qpwu2v");
    			...
    			attr_dev(img16, "class", "prize-card-image svelte-1qpwu2v");
    			add_location(img16, file$1, 147, 10, 6003);
    			attr_dev(div30, "class", "prize-card svelte-1qpwu2v");
    			add_location(div30, file$1, 144, 8, 5852);
    			attr_dev(h31, "class", "prize-card-category svelte-1qpwu2v");
    			add_location(h31, file$1, 151, 10, 6143);
    			attr_dev(h41, "class", "prize-card-model svelte-1qpwu2v");
    			...
    			attr_dev(img17, "class", "prize-card-image svelte-1qpwu2v");
    			add_location(img17, file$1, 153, 10, 6262);
    			attr_dev(div31, "class", "prize-card svelte-1qpwu2v");
    			add_location(div31, file$1, 150, 8, 6108);
    			attr_dev(h32, "class", "prize-card-category svelte-1qpwu2v");
    			add_location(h32, file$1, 157, 10, 6404);
    			attr_dev(h42, "class", "prize-card-model svelte-1qpwu2v");
    			...
    			attr_dev(img18, "class", "prize-card-image svelte-1qpwu2v");
    			add_location(img18, file$1, 159, 10, 6526);
    			attr_dev(div32, "class", "prize-card svelte-1qpwu2v");
    			add_location(div32, file$1, 156, 8, 6369);
    			attr_dev(div33, "class", "additional-prizes svelte-1qpwu2v");
    			add_location(div33, file$1, 143, 6, 5812);
    			attr_dev(div34, "class", "header-place svelte-1qpwu2v");
    			add_location(div34, file$1, 166, 12, 6765);
    			attr_dev(div35, "class", "header-prize svelte-1qpwu2v");
    			add_location(div35, file$1, 167, 12, 6815);
    			attr_dev(div36, "class", "header-freebet svelte-1qpwu2v");
    			add_location(div36, file$1, 168, 12, 6864);
    			attr_dev(div37, "class", "leaderboard-headers svelte-1qpwu2v");
    			add_location(div37, file$1, 165, 10, 6719);
    			attr_dev(div38, "class", "place svelte-1qpwu2v");
    			add_location(div38, file$1, 173, 14, 7020);
    			attr_dev(div39, "class", "prize svelte-1qpwu2v");
    			add_location(div39, file$1, 174, 14, 7061);
    			attr_dev(div40, "class", "freebet svelte-1qpwu2v");
    			add_location(div40, file$1, 175, 14, 7114);
    			attr_dev(div41, "class", "leaderboard-row svelte-1qpwu2v");
    			add_location(div41, file$1, 172, 12, 6976);
    			attr_dev(div42, "class", "place svelte-1qpwu2v");
    			add_location(div42, file$1, 179, 14, 7226);
    			attr_dev(div43, "class", "prize svelte-1qpwu2v");
    			add_location(div43, file$1, 180, 14, 7267);
    			attr_dev(div44, "class", "freebet svelte-1qpwu2v");
    			add_location(div44, file$1, 181, 14, 7320);
    			attr_dev(div45, "class", "leaderboard-row svelte-1qpwu2v");
    			add_location(div45, file$1, 178, 12, 7182);
    			attr_dev(div46, "class", "place svelte-1qpwu2v");
    			add_location(div46, file$1, 185, 14, 7432);
    			attr_dev(div47, "class", "prize svelte-1qpwu2v");
    			add_location(div47, file$1, 186, 14, 7473);
    			attr_dev(div48, "class", "freebet svelte-1qpwu2v");
    			add_location(div48, file$1, 187, 14, 7526);
    			attr_dev(div49, "class", "leaderboard-row svelte-1qpwu2v");
    			add_location(div49, file$1, 184, 12, 7388);
    			attr_dev(div50, "class", "place svelte-1qpwu2v");
    			add_location(div50, file$1, 191, 14, 7638);
    			attr_dev(div51, "class", "prize svelte-1qpwu2v");
    			add_location(div51, file$1, 192, 14, 7679);
    			attr_dev(div52, "class", "freebet svelte-1qpwu2v");
    			add_location(div52, file$1, 193, 14, 7738);
    			attr_dev(div53, "class", "leaderboard-row svelte-1qpwu2v");
    			add_location(div53, file$1, 190, 12, 7594);
    			attr_dev(div54, "class", "place svelte-1qpwu2v");
    			add_location(div54, file$1, 197, 14, 7850);
    			attr_dev(div55, "class", "prize svelte-1qpwu2v");
    			add_location(div55, file$1, 198, 14, 7891);
    			attr_dev(div56, "class", "freebet svelte-1qpwu2v");
    			add_location(div56, file$1, 199, 14, 7950);
    			attr_dev(div57, "class", "leaderboard-row svelte-1qpwu2v");
    			add_location(div57, file$1, 196, 12, 7806);
    			attr_dev(div58, "class", "place svelte-1qpwu2v");
    			add_location(div58, file$1, 203, 14, 8062);
    			attr_dev(div59, "class", "prize svelte-1qpwu2v");
    			add_location(div59, file$1, 204, 14, 8106);
    			attr_dev(div60, "class", "freebet svelte-1qpwu2v");
    			add_location(div60, file$1, 205, 14, 8166);
    			attr_dev(div61, "class", "leaderboard-row svelte-1qpwu2v");
    			add_location(div61, file$1, 202, 12, 8018);
    			attr_dev(div62, "class", "leaderboard-rows svelte-1qpwu2v");
    			add_location(div62, file$1, 171, 10, 6933);
    			attr_dev(div63, "class", "leaderboard-content svelte-1qpwu2v");
    			...
    			attr_dev(img19, "class", "svelte-1qpwu2v");
    			add_location(img19, file$1, 213, 14, 8379);
    			attr_dev(div64, "class", "merch-images svelte-1qpwu2v");
    			add_location(div64, file$1, 212, 12, 8338);
    			attr_dev(div65, "class", "merch-content svelte-1qpwu2v");
    			add_location(div65, file$1, 211, 10, 8298);
    			attr_dev(div66, "class", "merch-column svelte-1qpwu2v");
    			add_location(div66, file$1, 210, 8, 8261);
    			attr_dev(div67, "class", "leaderboard svelte-1qpwu2v");
    			add_location(div67, file$1, 163, 6, 6641);
    			attr_dev(section1, "class", "second-screen svelte-1qpwu2v");
    			add_location(section1, file$1, 108, 4, 4413);
    			attr_dev(div68, "class", "screen-container svelte-1qpwu2v");
    			add_location(div68, file$1, 107, 2, 4378);
    			attr_dev(div69, "class", "contest-title svelte-1qpwu2v");
    			add_location(div69, file$1, 227, 10, 8783);
    			attr_dev(div70, "class", "contest-description svelte-1qpwu2v");
    			add_location(div70, file$1, 228, 10, 8843);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-1qpwu2v");
    			add_location(a, file$1, 229, 10, 8971);
    			attr_dev(div71, "class", "header-left svelte-1qpwu2v");
    			add_location(div71, file$1, 233, 12, 9129);
    			attr_dev(div72, "class", "header-right svelte-1qpwu2v");
    			add_location(div72, file$1, 234, 12, 9176);
    			attr_dev(div73, "class", "table-headers svelte-1qpwu2v");
    			add_location(div73, file$1, 232, 10, 9089);
    			attr_dev(div74, "class", "name svelte-1qpwu2v");
    			add_location(div74, file$1, 241, 16, 9399);
    			attr_dev(div75, "class", "phone svelte-1qpwu2v");
    			add_location(div75, file$1, 242, 16, 9449);
    			attr_dev(div76, "class", "left-column svelte-1qpwu2v");
    			add_location(div76, file$1, 240, 14, 9357);
    			attr_dev(div77, "class", "coefficient svelte-1qpwu2v");
    			add_location(div77, file$1, 245, 16, 9571);
    			attr_dev(div78, "class", "right-column svelte-1qpwu2v");
    			add_location(div78, file$1, 244, 14, 9528);
    			attr_dev(div79, "class", "table-row svelte-1qpwu2v");
    			add_location(div79, file$1, 239, 12, 9319);
    			attr_dev(div80, "class", "name svelte-1qpwu2v");
    			add_location(div80, file$1, 250, 16, 9740);
    			attr_dev(div81, "class", "phone svelte-1qpwu2v");
    			add_location(div81, file$1, 251, 16, 9793);
    			attr_dev(div82, "class", "left-column svelte-1qpwu2v");
    			add_location(div82, file$1, 249, 14, 9698);
    			attr_dev(div83, "class", "coefficient svelte-1qpwu2v");
    			add_location(div83, file$1, 254, 16, 9915);
    			attr_dev(div84, "class", "right-column svelte-1qpwu2v");
    			add_location(div84, file$1, 253, 14, 9872);
    			attr_dev(div85, "class", "table-row svelte-1qpwu2v");
    			add_location(div85, file$1, 248, 12, 9660);
    			attr_dev(div86, "class", "name svelte-1qpwu2v");
    			add_location(div86, file$1, 259, 16, 10083);
    			attr_dev(div87, "class", "phone svelte-1qpwu2v");
    			add_location(div87, file$1, 260, 16, 10134);
    			attr_dev(div88, "class", "left-column svelte-1qpwu2v");
    			add_location(div88, file$1, 258, 14, 10041);
    			attr_dev(div89, "class", "coefficient svelte-1qpwu2v");
    			add_location(div89, file$1, 263, 16, 10256);
    			attr_dev(div90, "class", "right-column svelte-1qpwu2v");
    			add_location(div90, file$1, 262, 14, 10213);
    			attr_dev(div91, "class", "table-row svelte-1qpwu2v");
    			add_location(div91, file$1, 257, 12, 10003);
    			attr_dev(div92, "class", "name svelte-1qpwu2v");
    			add_location(div92, file$1, 268, 16, 10424);
    			attr_dev(div93, "class", "phone svelte-1qpwu2v");
    			add_location(div93, file$1, 269, 16, 10472);
    			attr_dev(div94, "class", "left-column svelte-1qpwu2v");
    			add_location(div94, file$1, 267, 14, 10382);
    			attr_dev(div95, "class", "coefficient svelte-1qpwu2v");
    			add_location(div95, file$1, 272, 16, 10594);
    			attr_dev(div96, "class", "right-column svelte-1qpwu2v");
    			add_location(div96, file$1, 271, 14, 10551);
    			attr_dev(div97, "class", "table-row svelte-1qpwu2v");
    			add_location(div97, file$1, 266, 12, 10344);
    			attr_dev(div98, "class", "name svelte-1qpwu2v");
    			add_location(div98, file$1, 277, 16, 10762);
    			attr_dev(div99, "class", "phone svelte-1qpwu2v");
    			add_location(div99, file$1, 278, 16, 10812);
    			attr_dev(div100, "class", "left-column svelte-1qpwu2v");
    			add_location(div100, file$1, 276, 14, 10720);
    			attr_dev(div101, "class", "coefficient svelte-1qpwu2v");
    			add_location(div101, file$1, 281, 16, 10934);
    			attr_dev(div102, "class", "right-column svelte-1qpwu2v");
    			add_location(div102, file$1, 280, 14, 10891);
    			attr_dev(div103, "class", "table-row svelte-1qpwu2v");
    			add_location(div103, file$1, 275, 12, 10682);
    			attr_dev(div104, "class", "name svelte-1qpwu2v");
    			add_location(div104, file$1, 286, 16, 11102);
    			attr_dev(div105, "class", "phone svelte-1qpwu2v");
    			add_location(div105, file$1, 287, 16, 11152);
    			attr_dev(div106, "class", "left-column svelte-1qpwu2v");
    			add_location(div106, file$1, 285, 14, 11060);
    			attr_dev(div107, "class", "coefficient svelte-1qpwu2v");
    			add_location(div107, file$1, 290, 16, 11274);
    			attr_dev(div108, "class", "right-column svelte-1qpwu2v");
    			add_location(div108, file$1, 289, 14, 11231);
    			attr_dev(div109, "class", "table-row svelte-1qpwu2v");
    			add_location(div109, file$1, 284, 12, 11022);
    			attr_dev(div110, "class", "table-rows svelte-1qpwu2v");
    			add_location(div110, file$1, 238, 10, 9282);
    			attr_dev(div111, "class", "table-frame svelte-1qpwu2v");
    			add_location(div111, file$1, 225, 8, 8709);
    			attr_dev(div112, "class", "leaderboard-left svelte-1qpwu2v");
    			add_location(div112, file$1, 224, 6, 8670);
    			attr_dev(button2, "class", "action-button svelte-1qpwu2v");
    			add_location(button2, file$1, 299, 10, 11511);
    			attr_dev(button3, "class", "action-button svelte-1qpwu2v");
    			add_location(button3, file$1, 300, 10, 11577);
    			attr_dev(p4, "class", "promo-description svelte-1qpwu2v");
    			add_location(p4, file$1, 302, 10, 11650);
    			attr_dev(p5, "class", "svelte-1qpwu2v");
    			add_location(p5, file$1, 308, 12, 11911);
    			attr_dev(p6, "class", "svelte-1qpwu2v");
    			add_location(p6, file$1, 309, 12, 12024);
    			attr_dev(p7, "class", "svelte-1qpwu2v");
    			add_location(p7, file$1, 310, 12, 12079);
    			attr_dev(div113, "class", "additional-info svelte-1qpwu2v");
    			add_location(div113, file$1, 307, 10, 11869);
    			attr_dev(div114, "class", "actions-container svelte-1qpwu2v");
    			set_style(div114, "margin-top", "190px");
    			add_location(div114, file$1, 298, 8, 11442);
    			attr_dev(div115, "class", "leaderboard-right svelte-1qpwu2v");
    			add_location(div115, file$1, 297, 6, 11402);
    			attr_dev(div116, "class", "leaderboard-container svelte-1qpwu2v");
    			add_location(div116, file$1, 223, 4, 8628);
    			attr_dev(section2, "class", "third-screen svelte-1qpwu2v");
    			add_location(section2, file$1, 222, 2, 8593);
    			attr_dev(div117, "class", "page-wrapper svelte-1qpwu2v");

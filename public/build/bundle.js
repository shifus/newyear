    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "header-image svelte-12fx4s");
    			add_location(img0, file$1, 9, 2, 237);
    			add_location(picture, file$1, 5, 0, 98);
    			attr_dev(br, "class", "svelte-12fx4s");
    			add_location(br, file$1, 15, 17, 404);
    			attr_dev(h1, "class", "title svelte-12fx4s");
    			add_location(h1, file$1, 14, 4, 368);
    			attr_dev(p0, "class", "description svelte-12fx4s");
    			add_location(p0, file$1, 18, 4, 444);
    			attr_dev(p1, "class", "description svelte-12fx4s");
    			add_location(p1, file$1, 23, 4, 727);
    			attr_dev(button0, "class", "promo-button svelte-12fx4s");
    			add_location(button0, file$1, 26, 4, 872);
    			attr_dev(div0, "class", "left-side svelte-12fx4s");
    			...
    			attr_dev(img1, "class", "tree-image svelte-12fx4s");
    			add_location(img1, file$1, 31, 4, 980);
    			attr_dev(div1, "class", "right-side svelte-12fx4s");
    			add_location(div1, file$1, 30, 2, 951);
    			attr_dev(div2, "class", "content svelte-12fx4s");
    			add_location(div2, file$1, 12, 0, 316);
    			attr_dev(section0, "class", "screen first-screen svelte-12fx4s");
    			...
    			attr_dev(img2, "class", "second-screen-image svelte-12fx4s");
    			add_location(img2, file$1, 37, 2, 1122);
    			attr_dev(section1, "class", "second-screen svelte-12fx4s");
    			add_location(section1, file$1, 36, 0, 1088);
    			attr_dev(h2, "class", "leaderboard-title svelte-12fx4s");
    			add_location(h2, file$1, 43, 6, 1331);
    			attr_dev(p2, "class", "leaderboard-description svelte-12fx4s");
    			add_location(p2, file$1, 44, 6, 1389);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-12fx4s");
    			add_location(a, file$1, 47, 6, 1529);
    			attr_dev(div3, "class", "table-frame svelte-12fx4s");
    			add_location(div3, file$1, 51, 8, 1697);
    			attr_dev(div4, "class", "leaderboard-table");
    			add_location(div4, file$1, 49, 6, 1620);
    			attr_dev(div5, "class", "leaderboard-left svelte-12fx4s");
    			add_location(div5, file$1, 42, 4, 1294);
    			attr_dev(button1, "class", "action-button svelte-12fx4s");
    			add_location(button1, file$1, 59, 8, 1894);
    			attr_dev(button2, "class", "action-button svelte-12fx4s");
    			add_location(button2, file$1, 60, 8, 1958);
    			attr_dev(p3, "class", "promo-description svelte-12fx4s");
    			add_location(p3, file$1, 62, 8, 2027);
    			attr_dev(p4, "class", "svelte-12fx4s");
    			add_location(p4, file$1, 68, 10, 2281);
    			attr_dev(p5, "class", "svelte-12fx4s");
    			add_location(p5, file$1, 69, 10, 2391);
    			attr_dev(p6, "class", "svelte-12fx4s");
    			add_location(p6, file$1, 70, 10, 2443);
    			attr_dev(div6, "class", "additional-info svelte-12fx4s");
    			add_location(div6, file$1, 67, 8, 2241);
    			attr_dev(div7, "class", "actions-container");
    			add_location(div7, file$1, 58, 6, 1854);
    			attr_dev(div8, "class", "leaderboard-right svelte-12fx4s");
    			add_location(div8, file$1, 57, 4, 1816);
    			attr_dev(div9, "class", "leaderboard-container svelte-12fx4s");
    			add_location(div9, file$1, 41, 2, 1254);
    			attr_dev(section2, "class", "third-screen svelte-12fx4s");

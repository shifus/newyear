    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-1rpcyb2");
    			add_location(img0, file$1, 17, 10, 520);
    			attr_dev(div0, "class", "candy-cane svelte-1rpcyb2");
    			add_location(div0, file$1, 18, 10, 592);
    			attr_dev(div1, "class", "logo-container svelte-1rpcyb2");
    			add_location(div1, file$1, 16, 8, 481);
    			attr_dev(div2, "class", "menu-item svelte-1rpcyb2");
    			add_location(div2, file$1, 21, 10, 675);
    			attr_dev(div3, "class", "menu-item svelte-1rpcyb2");
    			add_location(div3, file$1, 22, 10, 733);
    			attr_dev(div4, "class", "menu-item svelte-1rpcyb2");
    			add_location(div4, file$1, 23, 10, 782);
    			attr_dev(div5, "class", "menu svelte-1rpcyb2");
    			add_location(div5, file$1, 20, 8, 646);
    			attr_dev(div6, "class", "header svelte-1rpcyb2");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-1rpcyb2");
    			add_location(img1, file$1, 27, 8, 887);
    			attr_dev(div7, "class", "header-mobile svelte-1rpcyb2");
    			add_location(div7, file$1, 26, 6, 851);
    			attr_dev(br, "class", "svelte-1rpcyb2");
    			add_location(br, file$1, 33, 23, 1104);
    			attr_dev(h1, "class", "title svelte-1rpcyb2");
    			add_location(h1, file$1, 32, 10, 1062);
    			attr_dev(p0, "class", "description svelte-1rpcyb2");
    			add_location(p0, file$1, 36, 10, 1162);
    			attr_dev(p1, "class", "description svelte-1rpcyb2");
    			add_location(p1, file$1, 41, 10, 1474);
    			attr_dev(button0, "class", "promo-button svelte-1rpcyb2");
    			...
    			attr_dev(img2, "class", "santa-image svelte-1rpcyb2");
    			add_location(img2, file$1, 48, 12, 1804);
    			attr_dev(div8, "class", "promo-container svelte-1rpcyb2");
    			add_location(div8, file$1, 44, 10, 1638);
    			attr_dev(div9, "class", "left-side svelte-1rpcyb2");
    			...
    			attr_dev(img3, "class", "tree-image svelte-1rpcyb2");
    			add_location(img3, file$1, 52, 10, 1943);
    			attr_dev(div10, "class", "right-side svelte-1rpcyb2");
    			add_location(div10, file$1, 51, 8, 1908);
    			attr_dev(div11, "class", "content svelte-1rpcyb2");
    			add_location(div11, file$1, 30, 6, 998);
    			attr_dev(section0, "class", "first-screen svelte-1rpcyb2");
    			add_location(section0, file$1, 14, 4, 415);
    			attr_dev(div12, "class", "screen-container svelte-1rpcyb2");
    			add_location(div12, file$1, 13, 2, 380);
    			attr_dev(span0, "class", "prize-label svelte-1rpcyb2");
    			add_location(span0, file$1, 63, 10, 2247);
    			attr_dev(div13, "class", "prize-header svelte-1rpcyb2");
    			add_location(div13, file$1, 62, 8, 2210);
    			attr_dev(h20, "class", "prize-title svelte-1rpcyb2");
    			add_location(h20, file$1, 66, 8, 2325);
    			attr_dev(span1, "class", "spec-label svelte-1rpcyb2");
    			add_location(span1, file$1, 71, 14, 2502);
    			attr_dev(span2, "class", "spec-value svelte-1rpcyb2");
    			add_location(span2, file$1, 72, 14, 2561);
    			attr_dev(div14, "class", "spec-item svelte-1rpcyb2");
    			add_location(div14, file$1, 70, 12, 2464);
    			attr_dev(span3, "class", "spec-label svelte-1rpcyb2");
    			add_location(span3, file$1, 75, 14, 2669);
    			attr_dev(span4, "class", "spec-value svelte-1rpcyb2");
    			add_location(span4, file$1, 76, 14, 2725);
    			attr_dev(div15, "class", "spec-item svelte-1rpcyb2");
    			add_location(div15, file$1, 74, 12, 2631);
    			attr_dev(div16, "class", "specs-column svelte-1rpcyb2");
    			add_location(div16, file$1, 69, 10, 2425);
    			attr_dev(span5, "class", "spec-label svelte-1rpcyb2");
    			add_location(span5, file$1, 81, 14, 2891);
    			attr_dev(span6, "class", "spec-value svelte-1rpcyb2");
    			add_location(span6, file$1, 82, 14, 2942);
    			attr_dev(div17, "class", "spec-item svelte-1rpcyb2");
    			add_location(div17, file$1, 80, 12, 2853);
    			attr_dev(span7, "class", "spec-label svelte-1rpcyb2");
    			add_location(span7, file$1, 85, 14, 3062);
    			attr_dev(span8, "class", "spec-value svelte-1rpcyb2");
    			add_location(span8, file$1, 86, 14, 3115);
    			attr_dev(div18, "class", "spec-item svelte-1rpcyb2");
    			add_location(div18, file$1, 84, 12, 3024);
    			attr_dev(div19, "class", "specs-column svelte-1rpcyb2");
    			add_location(div19, file$1, 79, 10, 2814);
    			attr_dev(div20, "class", "specs-container svelte-1rpcyb2");
    			...
    			attr_dev(img4, "class", "prize-image svelte-1rpcyb2");
    			add_location(img4, file$1, 91, 8, 3221);
    			attr_dev(div21, "class", "main-prize svelte-1rpcyb2");
    			add_location(div21, file$1, 61, 6, 2177);
    			attr_dev(h30, "class", "prize-card-category svelte-1rpcyb2");
    			add_location(h30, file$1, 96, 10, 3392);
    			attr_dev(h40, "class", "prize-card-model svelte-1rpcyb2");
    			...
    			attr_dev(img5, "class", "prize-card-image svelte-1rpcyb2");
    			add_location(img5, file$1, 98, 10, 3508);
    			attr_dev(div22, "class", "prize-card svelte-1rpcyb2");
    			add_location(div22, file$1, 95, 8, 3357);
    			attr_dev(h31, "class", "prize-card-category svelte-1rpcyb2");
    			add_location(h31, file$1, 102, 10, 3648);
    			attr_dev(h41, "class", "prize-card-model svelte-1rpcyb2");
    			...
    			attr_dev(img6, "class", "prize-card-image svelte-1rpcyb2");
    			add_location(img6, file$1, 104, 10, 3767);
    			attr_dev(div23, "class", "prize-card svelte-1rpcyb2");
    			add_location(div23, file$1, 101, 8, 3613);
    			attr_dev(h32, "class", "prize-card-category svelte-1rpcyb2");
    			add_location(h32, file$1, 108, 10, 3909);
    			attr_dev(h42, "class", "prize-card-model svelte-1rpcyb2");
    			...
    			attr_dev(img7, "class", "prize-card-image svelte-1rpcyb2");
    			add_location(img7, file$1, 110, 10, 4031);
    			attr_dev(div24, "class", "prize-card svelte-1rpcyb2");
    			add_location(div24, file$1, 107, 8, 3874);
    			attr_dev(div25, "class", "additional-prizes svelte-1rpcyb2");
    			add_location(div25, file$1, 94, 6, 3317);
    			attr_dev(div26, "class", "header-place svelte-1rpcyb2");
    			add_location(div26, file$1, 117, 12, 4270);
    			attr_dev(div27, "class", "header-prize svelte-1rpcyb2");
    			add_location(div27, file$1, 118, 12, 4320);
    			attr_dev(div28, "class", "header-freebet svelte-1rpcyb2");
    			add_location(div28, file$1, 119, 12, 4369);
    			attr_dev(div29, "class", "leaderboard-headers svelte-1rpcyb2");
    			add_location(div29, file$1, 116, 10, 4224);
    			attr_dev(div30, "class", "place svelte-1rpcyb2");
    			add_location(div30, file$1, 124, 14, 4530);
    			attr_dev(div31, "class", "prize svelte-1rpcyb2");
    			add_location(div31, file$1, 125, 14, 4571);
    			attr_dev(div32, "class", "freebet svelte-1rpcyb2");
    			add_location(div32, file$1, 126, 14, 4624);
    			attr_dev(div33, "class", "leaderboard-row svelte-1rpcyb2");
    			add_location(div33, file$1, 123, 12, 4486);
    			attr_dev(div34, "class", "place svelte-1rpcyb2");
    			add_location(div34, file$1, 130, 14, 4736);
    			attr_dev(div35, "class", "prize svelte-1rpcyb2");
    			add_location(div35, file$1, 131, 14, 4777);
    			attr_dev(div36, "class", "freebet svelte-1rpcyb2");
    			add_location(div36, file$1, 132, 14, 4830);
    			attr_dev(div37, "class", "leaderboard-row svelte-1rpcyb2");
    			add_location(div37, file$1, 129, 12, 4692);
    			attr_dev(div38, "class", "place svelte-1rpcyb2");
    			add_location(div38, file$1, 136, 14, 4942);
    			attr_dev(div39, "class", "prize svelte-1rpcyb2");
    			add_location(div39, file$1, 137, 14, 4983);
    			attr_dev(div40, "class", "freebet svelte-1rpcyb2");
    			add_location(div40, file$1, 138, 14, 5036);
    			attr_dev(div41, "class", "leaderboard-row svelte-1rpcyb2");
    			add_location(div41, file$1, 135, 12, 4898);
    			attr_dev(div42, "class", "place svelte-1rpcyb2");
    			add_location(div42, file$1, 142, 14, 5148);
    			attr_dev(div43, "class", "prize svelte-1rpcyb2");
    			add_location(div43, file$1, 143, 14, 5189);
    			attr_dev(div44, "class", "freebet svelte-1rpcyb2");
    			add_location(div44, file$1, 144, 14, 5248);
    			attr_dev(div45, "class", "leaderboard-row svelte-1rpcyb2");
    			add_location(div45, file$1, 141, 12, 5104);
    			attr_dev(div46, "class", "place svelte-1rpcyb2");
    			add_location(div46, file$1, 148, 14, 5360);
    			attr_dev(div47, "class", "prize svelte-1rpcyb2");
    			add_location(div47, file$1, 149, 14, 5401);
    			attr_dev(div48, "class", "freebet svelte-1rpcyb2");
    			add_location(div48, file$1, 150, 14, 5460);
    			attr_dev(div49, "class", "leaderboard-row svelte-1rpcyb2");
    			add_location(div49, file$1, 147, 12, 5316);
    			attr_dev(div50, "class", "place svelte-1rpcyb2");
    			add_location(div50, file$1, 154, 14, 5572);
    			attr_dev(div51, "class", "prize svelte-1rpcyb2");
    			add_location(div51, file$1, 155, 14, 5616);
    			attr_dev(div52, "class", "freebet svelte-1rpcyb2");
    			add_location(div52, file$1, 156, 14, 5676);
    			attr_dev(div53, "class", "leaderboard-row svelte-1rpcyb2");
    			add_location(div53, file$1, 153, 12, 5528);
    			attr_dev(div54, "class", "leaderboard-rows svelte-1rpcyb2");
    			add_location(div54, file$1, 122, 10, 4443);
    			attr_dev(div55, "class", "leaderboard-content svelte-1rpcyb2");
    			add_location(div55, file$1, 115, 8, 4180);
    			attr_dev(div56, "class", "merch-images svelte-1rpcyb2");
    			add_location(div56, file$1, 163, 12, 5848);
    			attr_dev(span9, "class", "svelte-1rpcyb2");
    			add_location(span9, file$1, 167, 14, 6000);
    			attr_dev(div57, "class", "merch-status svelte-1rpcyb2");
    			add_location(div57, file$1, 166, 12, 5959);
    			attr_dev(div58, "class", "merch-content svelte-1rpcyb2");
    			add_location(div58, file$1, 162, 10, 5808);
    			attr_dev(div59, "class", "merch-column svelte-1rpcyb2");
    			add_location(div59, file$1, 161, 8, 5771);
    			attr_dev(div60, "class", "leaderboard svelte-1rpcyb2");
    			add_location(div60, file$1, 114, 6, 4146);
    			attr_dev(section1, "class", "second-screen svelte-1rpcyb2");
    			add_location(section1, file$1, 60, 4, 2139);
    			attr_dev(div61, "class", "screen-container svelte-1rpcyb2");
    			add_location(div61, file$1, 59, 2, 2104);
    			attr_dev(h21, "class", "leaderboard-title svelte-1rpcyb2");
    			add_location(h21, file$1, 179, 8, 6262);
    			attr_dev(p2, "class", "leaderboard-description svelte-1rpcyb2");
    			add_location(p2, file$1, 180, 8, 6322);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-1rpcyb2");
    			add_location(a, file$1, 183, 8, 6468);
    			attr_dev(div62, "class", "table-frame svelte-1rpcyb2");
    			add_location(div62, file$1, 187, 10, 6644);
    			attr_dev(div63, "class", "leaderboard-table svelte-1rpcyb2");
    			add_location(div63, file$1, 185, 8, 6563);
    			attr_dev(div64, "class", "leaderboard-left svelte-1rpcyb2");
    			add_location(div64, file$1, 178, 6, 6223);
    			attr_dev(button1, "class", "action-button svelte-1rpcyb2");
    			add_location(button1, file$1, 195, 8, 6849);
    			attr_dev(button2, "class", "action-button svelte-1rpcyb2");
    			add_location(button2, file$1, 196, 8, 6913);
    			attr_dev(p3, "class", "promo-description svelte-1rpcyb2");
    			add_location(p3, file$1, 198, 8, 6982);
    			attr_dev(p4, "class", "svelte-1rpcyb2");
    			add_location(p4, file$1, 204, 12, 7238);
    			attr_dev(p5, "class", "svelte-1rpcyb2");
    			add_location(p5, file$1, 205, 12, 7350);
    			attr_dev(p6, "class", "svelte-1rpcyb2");
    			add_location(p6, file$1, 206, 12, 7404);
    			attr_dev(div65, "class", "additional-info svelte-1rpcyb2");
    			add_location(div65, file$1, 203, 10, 7196);
    			attr_dev(div66, "class", "actions-container svelte-1rpcyb2");
    			add_location(div66, file$1, 194, 6, 6809);
    			attr_dev(div67, "class", "leaderboard-right svelte-1rpcyb2");
    			add_location(div67, file$1, 193, 4, 6771);
    			attr_dev(div68, "class", "leaderboard-container svelte-1rpcyb2");
    			add_location(div68, file$1, 177, 4, 6181);
    			attr_dev(section2, "class", "third-screen svelte-1rpcyb2");
    			add_location(section2, file$1, 176, 2, 6146);
    			attr_dev(div69, "class", "page-wrapper svelte-1rpcyb2");

    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button1.textContent = "В��едите промокод";
    			t108 = space();
    			...
    			attr_dev(img0, "class", "logo svelte-1desxya");
    			add_location(img0, file$1, 17, 10, 521);
    			attr_dev(div0, "class", "candy-cane svelte-1desxya");
    			add_location(div0, file$1, 18, 10, 593);
    			attr_dev(div1, "class", "logo-container svelte-1desxya");
    			add_location(div1, file$1, 16, 8, 482);
    			attr_dev(div2, "class", "menu-item svelte-1desxya");
    			add_location(div2, file$1, 21, 10, 676);
    			attr_dev(div3, "class", "menu-item svelte-1desxya");
    			add_location(div3, file$1, 22, 10, 734);
    			attr_dev(div4, "class", "menu-item svelte-1desxya");
    			add_location(div4, file$1, 23, 10, 783);
    			attr_dev(div5, "class", "menu svelte-1desxya");
    			add_location(div5, file$1, 20, 8, 647);
    			attr_dev(div6, "class", "header svelte-1desxya");
    			...
    			attr_dev(img1, "alt", "Мобильны�� заголовок");
    			attr_dev(img1, "class", "header-mobile-image svelte-1desxya");
    			add_location(img1, file$1, 27, 8, 888);
    			attr_dev(div7, "class", "header-mobile svelte-1desxya");
    			add_location(div7, file$1, 26, 6, 852);
    			attr_dev(br, "class", "svelte-1desxya");
    			add_location(br, file$1, 33, 23, 1106);
    			attr_dev(h1, "class", "title svelte-1desxya");
    			add_location(h1, file$1, 32, 10, 1064);
    			attr_dev(p0, "class", "description svelte-1desxya");
    			add_location(p0, file$1, 36, 10, 1164);
    			attr_dev(p1, "class", "description svelte-1desxya");
    			add_location(p1, file$1, 41, 10, 1476);
    			attr_dev(button0, "class", "promo-button svelte-1desxya");
    			add_location(button0, file$1, 44, 10, 1640);
    			attr_dev(div8, "class", "left-side svelte-1desxya");
    			add_location(div8, file$1, 31, 8, 1030);
    			...
    			attr_dev(img2, "class", "tree-image svelte-1desxya");
    			add_location(img2, file$1, 49, 10, 1806);
    			attr_dev(div9, "class", "right-side svelte-1desxya");
    			add_location(div9, file$1, 48, 8, 1771);
    			attr_dev(div10, "class", "content svelte-1desxya");
    			add_location(div10, file$1, 30, 6, 1000);
    			attr_dev(section0, "class", "first-screen svelte-1desxya");
    			add_location(section0, file$1, 14, 4, 416);
    			attr_dev(div11, "class", "screen-container svelte-1desxya");
    			add_location(div11, file$1, 13, 2, 381);
    			attr_dev(span0, "class", "prize-label svelte-1desxya");
    			add_location(span0, file$1, 60, 10, 2110);
    			attr_dev(div12, "class", "prize-header svelte-1desxya");
    			add_location(div12, file$1, 59, 8, 2073);
    			attr_dev(h20, "class", "prize-title svelte-1desxya");
    			add_location(h20, file$1, 63, 8, 2188);
    			attr_dev(span1, "class", "spec-label svelte-1desxya");
    			add_location(span1, file$1, 68, 14, 2365);
    			attr_dev(span2, "class", "spec-value svelte-1desxya");
    			add_location(span2, file$1, 69, 14, 2424);
    			attr_dev(div13, "class", "spec-item svelte-1desxya");
    			add_location(div13, file$1, 67, 12, 2327);
    			attr_dev(span3, "class", "spec-label svelte-1desxya");
    			add_location(span3, file$1, 72, 14, 2532);
    			attr_dev(span4, "class", "spec-value svelte-1desxya");
    			add_location(span4, file$1, 73, 14, 2588);
    			attr_dev(div14, "class", "spec-item svelte-1desxya");
    			add_location(div14, file$1, 71, 12, 2494);
    			attr_dev(div15, "class", "specs-column svelte-1desxya");
    			add_location(div15, file$1, 66, 10, 2288);
    			attr_dev(span5, "class", "spec-label svelte-1desxya");
    			add_location(span5, file$1, 78, 14, 2754);
    			attr_dev(span6, "class", "spec-value svelte-1desxya");
    			add_location(span6, file$1, 79, 14, 2805);
    			attr_dev(div16, "class", "spec-item svelte-1desxya");
    			add_location(div16, file$1, 77, 12, 2716);
    			attr_dev(span7, "class", "spec-label svelte-1desxya");
    			add_location(span7, file$1, 82, 14, 2925);
    			attr_dev(span8, "class", "spec-value svelte-1desxya");
    			add_location(span8, file$1, 83, 14, 2978);
    			attr_dev(div17, "class", "spec-item svelte-1desxya");
    			add_location(div17, file$1, 81, 12, 2887);
    			attr_dev(div18, "class", "specs-column svelte-1desxya");
    			add_location(div18, file$1, 76, 10, 2677);
    			attr_dev(div19, "class", "specs-container svelte-1desxya");
    			add_location(div19, file$1, 65, 8, 2248);
    			...
    			attr_dev(img3, "class", "prize-image svelte-1desxya");
    			add_location(img3, file$1, 88, 8, 3084);
    			attr_dev(div20, "class", "main-prize svelte-1desxya");
    			add_location(div20, file$1, 58, 6, 2040);
    			attr_dev(h30, "class", "prize-card-category svelte-1desxya");
    			add_location(h30, file$1, 93, 10, 3255);
    			attr_dev(h40, "class", "prize-card-model svelte-1desxya");
    			add_location(h40, file$1, 94, 10, 3311);
    			...
    			attr_dev(img4, "class", "prize-card-image svelte-1desxya");
    			add_location(img4, file$1, 95, 10, 3371);
    			attr_dev(div21, "class", "prize-card svelte-1desxya");
    			add_location(div21, file$1, 92, 8, 3220);
    			attr_dev(h31, "class", "prize-card-category svelte-1desxya");
    			add_location(h31, file$1, 99, 10, 3511);
    			attr_dev(h41, "class", "prize-card-model svelte-1desxya");
    			add_location(h41, file$1, 100, 10, 3570);
    			...
    			attr_dev(img5, "class", "prize-card-image svelte-1desxya");
    			add_location(img5, file$1, 101, 10, 3630);
    			attr_dev(div22, "class", "prize-card svelte-1desxya");
    			add_location(div22, file$1, 98, 8, 3476);
    			attr_dev(h32, "class", "prize-card-category svelte-1desxya");
    			add_location(h32, file$1, 105, 10, 3772);
    			attr_dev(h42, "class", "prize-card-model svelte-1desxya");
    			add_location(h42, file$1, 106, 10, 3833);
    			...
    			attr_dev(img6, "class", "prize-card-image svelte-1desxya");
    			add_location(img6, file$1, 107, 10, 3894);
    			attr_dev(div23, "class", "prize-card svelte-1desxya");
    			add_location(div23, file$1, 104, 8, 3737);
    			attr_dev(div24, "class", "additional-prizes svelte-1desxya");
    			add_location(div24, file$1, 91, 6, 3180);
    			attr_dev(div25, "class", "header-place svelte-1desxya");
    			add_location(div25, file$1, 114, 12, 4133);
    			attr_dev(div26, "class", "header-prize svelte-1desxya");
    			add_location(div26, file$1, 115, 12, 4183);
    			attr_dev(div27, "class", "header-freebet svelte-1desxya");
    			add_location(div27, file$1, 116, 12, 4232);
    			attr_dev(div28, "class", "leaderboard-headers svelte-1desxya");
    			add_location(div28, file$1, 113, 10, 4087);
    			attr_dev(div29, "class", "place svelte-1desxya");
    			add_location(div29, file$1, 121, 14, 4388);
    			attr_dev(div30, "class", "prize svelte-1desxya");
    			add_location(div30, file$1, 122, 14, 4429);
    			attr_dev(div31, "class", "freebet svelte-1desxya");
    			add_location(div31, file$1, 123, 14, 4482);
    			attr_dev(div32, "class", "leaderboard-row svelte-1desxya");
    			add_location(div32, file$1, 120, 12, 4344);
    			attr_dev(div33, "class", "place svelte-1desxya");
    			add_location(div33, file$1, 127, 14, 4594);
    			attr_dev(div34, "class", "prize svelte-1desxya");
    			add_location(div34, file$1, 128, 14, 4635);
    			attr_dev(div35, "class", "freebet svelte-1desxya");
    			add_location(div35, file$1, 129, 14, 4688);
    			attr_dev(div36, "class", "leaderboard-row svelte-1desxya");
    			add_location(div36, file$1, 126, 12, 4550);
    			attr_dev(div37, "class", "place svelte-1desxya");
    			add_location(div37, file$1, 133, 14, 4800);
    			attr_dev(div38, "class", "prize svelte-1desxya");
    			add_location(div38, file$1, 134, 14, 4841);
    			attr_dev(div39, "class", "freebet svelte-1desxya");
    			add_location(div39, file$1, 135, 14, 4894);
    			attr_dev(div40, "class", "leaderboard-row svelte-1desxya");
    			add_location(div40, file$1, 132, 12, 4756);
    			attr_dev(div41, "class", "place svelte-1desxya");
    			add_location(div41, file$1, 139, 14, 5006);
    			attr_dev(div42, "class", "prize svelte-1desxya");
    			add_location(div42, file$1, 140, 14, 5047);
    			attr_dev(div43, "class", "freebet svelte-1desxya");
    			add_location(div43, file$1, 141, 14, 5106);
    			attr_dev(div44, "class", "leaderboard-row svelte-1desxya");
    			add_location(div44, file$1, 138, 12, 4962);
    			attr_dev(div45, "class", "place svelte-1desxya");
    			add_location(div45, file$1, 145, 14, 5218);
    			attr_dev(div46, "class", "prize svelte-1desxya");
    			add_location(div46, file$1, 146, 14, 5259);
    			attr_dev(div47, "class", "freebet svelte-1desxya");
    			add_location(div47, file$1, 147, 14, 5318);
    			attr_dev(div48, "class", "leaderboard-row svelte-1desxya");
    			add_location(div48, file$1, 144, 12, 5174);
    			attr_dev(div49, "class", "place svelte-1desxya");
    			add_location(div49, file$1, 151, 14, 5430);
    			attr_dev(div50, "class", "prize svelte-1desxya");
    			add_location(div50, file$1, 152, 14, 5474);
    			attr_dev(div51, "class", "freebet svelte-1desxya");
    			add_location(div51, file$1, 153, 14, 5534);
    			attr_dev(div52, "class", "leaderboard-row svelte-1desxya");
    			add_location(div52, file$1, 150, 12, 5386);
    			attr_dev(div53, "class", "leaderboard-rows svelte-1desxya");
    			add_location(div53, file$1, 119, 10, 4301);
    			attr_dev(div54, "class", "leaderboard-content svelte-1desxya");
    			add_location(div54, file$1, 112, 8, 4043);
    			attr_dev(div55, "class", "merch-images svelte-1desxya");
    			add_location(div55, file$1, 160, 12, 5706);
    			attr_dev(span9, "class", "svelte-1desxya");
    			add_location(span9, file$1, 164, 14, 5858);
    			attr_dev(div56, "class", "merch-status svelte-1desxya");
    			add_location(div56, file$1, 163, 12, 5817);
    			attr_dev(div57, "class", "merch-content svelte-1desxya");
    			add_location(div57, file$1, 159, 10, 5666);
    			attr_dev(div58, "class", "merch-column svelte-1desxya");
    			add_location(div58, file$1, 158, 8, 5629);
    			attr_dev(div59, "class", "leaderboard svelte-1desxya");
    			add_location(div59, file$1, 111, 6, 4009);
    			attr_dev(section1, "class", "second-screen svelte-1desxya");
    			add_location(section1, file$1, 57, 4, 2002);
    			attr_dev(div60, "class", "screen-container svelte-1desxya");
    			add_location(div60, file$1, 56, 2, 1967);
    			attr_dev(h21, "class", "leaderboard-title svelte-1desxya");
    			add_location(h21, file$1, 176, 8, 6120);
    			attr_dev(p2, "class", "leaderboard-description svelte-1desxya");
    			add_location(p2, file$1, 177, 8, 6180);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-1desxya");
    			add_location(a, file$1, 180, 8, 6326);
    			attr_dev(div61, "class", "table-frame svelte-1desxya");
    			add_location(div61, file$1, 184, 10, 6502);
    			attr_dev(div62, "class", "leaderboard-table svelte-1desxya");
    			add_location(div62, file$1, 182, 8, 6421);
    			attr_dev(div63, "class", "leaderboard-left svelte-1desxya");
    			add_location(div63, file$1, 175, 6, 6081);
    			attr_dev(button1, "class", "action-button svelte-1desxya");
    			add_location(button1, file$1, 192, 8, 6707);
    			attr_dev(button2, "class", "action-button svelte-1desxya");
    			add_location(button2, file$1, 193, 8, 6772);
    			attr_dev(p3, "class", "promo-description svelte-1desxya");
    			add_location(p3, file$1, 195, 8, 6841);
    			attr_dev(p4, "class", "svelte-1desxya");
    			add_location(p4, file$1, 201, 12, 7097);
    			attr_dev(p5, "class", "svelte-1desxya");
    			add_location(p5, file$1, 202, 12, 7209);
    			attr_dev(p6, "class", "svelte-1desxya");
    			add_location(p6, file$1, 203, 12, 7263);
    			attr_dev(div64, "class", "additional-info svelte-1desxya");
    			add_location(div64, file$1, 200, 10, 7055);
    			attr_dev(div65, "class", "actions-container svelte-1desxya");
    			add_location(div65, file$1, 191, 6, 6667);
    			attr_dev(div66, "class", "leaderboard-right svelte-1desxya");
    			add_location(div66, file$1, 190, 4, 6629);
    			attr_dev(div67, "class", "leaderboard-container svelte-1desxya");
    			add_location(div67, file$1, 174, 4, 6039);
    			attr_dev(section2, "class", "third-screen svelte-1desxya");
    			add_location(section2, file$1, 173, 2, 6004);
    			attr_dev(div68, "class", "page-wrapper svelte-1desxya");
    			add_location(div68, file$1, 11, 0, 322);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},

    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			div2 = element("div");
    			attr_dev(h2, "class", "schedule-title svelte-lvwkzl");
    			...
    			attr_dev(a1, "href", "#");
    			attr_dev(a1, "class", "user-agreement svelte-lvwkzl");
    			add_location(a1, file$2, 13, 4, 414);
    			attr_dev(p2, "class", "developer-text svelte-lvwkzl");
    			add_location(p2, file$2, 14, 4, 485);
    			attr_dev(div2, "class", "vector svelte-lvwkzl");
    			add_location(div2, file$2, 16, 6, 565);
    			attr_dev(div3, "class", "logo svelte-lvwkzl");
    			add_location(div3, file$2, 15, 4, 540);
    			attr_dev(div4, "class", "footer-frame svelte-lvwkzl");
    			add_location(div4, file$2, 12, 2, 383);
    			attr_dev(div5, "class", "final-section svelte-lvwkzl");
    			add_location(div5, file$2, 4, 0, 60);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},

    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "project-title svelte-191d3ue");
    			add_location(h2, file$3, 5, 2, 90);
    			attr_dev(p0, "class", "highlight-text svelte-191d3ue");
    			add_location(p0, file$3, 8, 6, 205);
    			attr_dev(p1, "class", "rules-text svelte-191d3ue");
    			add_location(p1, file$3, 9, 6, 323);
    			attr_dev(p2, "class", "details-text svelte-191d3ue");
    			add_location(p2, file$3, 10, 6, 369);
    			attr_dev(span, "class", "promo-button-text svelte-191d3ue");
    			add_location(span, file$3, 12, 8, 614);
    			attr_dev(div0, "class", "promo-button svelte-191d3ue");
    			add_location(div0, file$3, 11, 6, 579);
    			attr_dev(div1, "class", "project-description svelte-191d3ue");
    			add_location(div1, file$3, 7, 4, 165);
    			attr_dev(div2, "class", "image svelte-191d3ue");
    			add_location(div2, file$3, 17, 8, 766);
    			attr_dev(div3, "class", "image svelte-191d3ue");
    			add_location(div3, file$3, 18, 8, 800);
    			attr_dev(div4, "class", "image-frame svelte-191d3ue");
    			add_location(div4, file$3, 16, 6, 732);
    			attr_dev(p3, "class", "row-text svelte-191d3ue");
    			add_location(p3, file$3, 20, 6, 845);
    			attr_dev(div5, "class", "image svelte-191d3ue");
    			add_location(div5, file$3, 22, 8, 941);
    			attr_dev(div6, "class", "image svelte-191d3ue");
    			add_location(div6, file$3, 23, 8, 975);
    			attr_dev(div7, "class", "image svelte-191d3ue");
    			add_location(div7, file$3, 24, 8, 1009);
    			attr_dev(div8, "class", "image-frame svelte-191d3ue");
    			add_location(div8, file$3, 21, 6, 907);
    			attr_dev(p4, "class", "row-text svelte-191d3ue");
    			add_location(p4, file$3, 26, 6, 1054);
    			attr_dev(div9, "class", "right-column svelte-191d3ue");
    			add_location(div9, file$3, 15, 4, 699);
    			attr_dev(div10, "class", "project-frame svelte-191d3ue");
    			add_location(div10, file$3, 6, 2, 133);
    			attr_dev(div11, "class", "about-project svelte-191d3ue");

    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-lxsv7z");
    			add_location(img0, file$1, 39, 10, 1098);
    			attr_dev(div0, "class", "candy-cane svelte-lxsv7z");
    			add_location(div0, file$1, 40, 10, 1170);
    			attr_dev(div1, "class", "logo-container svelte-lxsv7z");
    			add_location(div1, file$1, 38, 8, 1059);
    			attr_dev(a0, "href", "#leaderboard-table");
    			attr_dev(a0, "class", "menu-item svelte-lxsv7z");
    			add_location(a0, file$1, 43, 10, 1253);
    			attr_dev(a1, "href", "#about-project");
    			attr_dev(a1, "class", "menu-item svelte-lxsv7z");
    			add_location(a1, file$1, 44, 10, 1333);
    			attr_dev(a2, "href", "#prizes");
    			attr_dev(a2, "class", "menu-item svelte-lxsv7z");
    			add_location(a2, file$1, 45, 10, 1400);
    			attr_dev(div2, "class", "menu svelte-lxsv7z");
    			add_location(div2, file$1, 42, 8, 1224);
    			attr_dev(div3, "class", "header svelte-lxsv7z");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-lxsv7z");
    			add_location(img1, file$1, 49, 8, 1516);
    			attr_dev(div4, "class", "header-mobile svelte-lxsv7z");
    			add_location(div4, file$1, 48, 6, 1480);
    			attr_dev(span0, "class", "first-line svelte-lxsv7z");
    			add_location(span0, file$1, 56, 12, 1763);
    			attr_dev(span1, "class", "second-line svelte-lxsv7z");
    			add_location(span1, file$1, 57, 12, 1819);
    			attr_dev(h10, "class", "title svelte-lxsv7z");
    			add_location(h10, file$1, 55, 10, 1732);
    			attr_dev(span2, "class", "description-line svelte-lxsv7z");
    			add_location(span2, file$1, 61, 14, 1979);
    			attr_dev(span3, "class", "description-line svelte-lxsv7z");
    			add_location(span3, file$1, 62, 14, 2076);
    			attr_dev(span4, "class", "description-line svelte-lxsv7z");
    			add_location(span4, file$1, 63, 14, 2196);
    			attr_dev(span5, "class", "description-line svelte-lxsv7z");
    			add_location(span5, file$1, 64, 14, 2308);
    			attr_dev(p0, "class", "description svelte-lxsv7z");
    			add_location(p0, file$1, 60, 12, 1941);
    			attr_dev(span6, "class", "description-line svelte-lxsv7z");
    			add_location(span6, file$1, 68, 14, 2502);
    			attr_dev(span7, "class", "description-line svelte-lxsv7z");
    			add_location(span7, file$1, 69, 14, 2595);
    			attr_dev(span8, "class", "description-line svelte-lxsv7z");
    			add_location(span8, file$1, 70, 14, 2694);
    			attr_dev(p1, "class", "description description-secondary svelte-lxsv7z");
    			add_location(p1, file$1, 67, 12, 2442);
    			attr_dev(div5, "class", "description-container svelte-lxsv7z");
    			add_location(div5, file$1, 59, 10, 1893);
    			attr_dev(button0, "class", "promo-button svelte-lxsv7z");
    			...
    			attr_dev(img2, "class", "santa-image svelte-lxsv7z");
    			add_location(img2, file$1, 77, 12, 2960);
    			attr_dev(div6, "class", "promo-container svelte-lxsv7z");
    			add_location(div6, file$1, 73, 10, 2794);
    			attr_dev(div7, "class", "left-side svelte-lxsv7z");
    			...
    			attr_dev(img3, "class", "tree-image svelte-lxsv7z");
    			...
    			attr_dev(img4, "class", "gifts-image svelte-lxsv7z");
    			...
    			attr_dev(img5, "class", "star star-1 svelte-lxsv7z");
    			...
    			attr_dev(img6, "class", "star star-2 svelte-lxsv7z");
    			...
    			attr_dev(img7, "class", "star star-3 svelte-lxsv7z");
    			add_location(img7, file$1, 87, 12, 3476);
    			attr_dev(div8, "class", "tree-container svelte-lxsv7z");
    			add_location(div8, file$1, 82, 10, 3108);
    			attr_dev(div9, "class", "right-side svelte-lxsv7z");
    			add_location(div9, file$1, 81, 8, 3073);
    			attr_dev(div10, "class", "content desktop-version svelte-lxsv7z");
    			add_location(div10, file$1, 53, 6, 1652);
    			attr_dev(span9, "class", "first-line svelte-lxsv7z");
    			add_location(span9, file$1, 96, 12, 3742);
    			attr_dev(span10, "class", "second-line svelte-lxsv7z");
    			add_location(span10, file$1, 97, 12, 3798);
    			attr_dev(h11, "class", "title svelte-lxsv7z");
    			add_location(h11, file$1, 95, 10, 3711);
    			attr_dev(span11, "class", "description-line svelte-lxsv7z");
    			add_location(span11, file$1, 101, 14, 3958);
    			attr_dev(span12, "class", "description-line svelte-lxsv7z");
    			add_location(span12, file$1, 102, 14, 4055);
    			attr_dev(span13, "class", "description-line svelte-lxsv7z");
    			add_location(span13, file$1, 103, 14, 4175);
    			attr_dev(span14, "class", "description-line svelte-lxsv7z");
    			add_location(span14, file$1, 104, 14, 4287);
    			attr_dev(p2, "class", "description svelte-lxsv7z");
    			add_location(p2, file$1, 100, 12, 3920);
    			attr_dev(span15, "class", "description-line svelte-lxsv7z");
    			add_location(span15, file$1, 108, 14, 4481);
    			attr_dev(span16, "class", "description-line svelte-lxsv7z");
    			add_location(span16, file$1, 109, 14, 4574);
    			attr_dev(span17, "class", "description-line svelte-lxsv7z");
    			add_location(span17, file$1, 110, 14, 4673);
    			attr_dev(p3, "class", "description description-secondary svelte-lxsv7z");
    			add_location(p3, file$1, 107, 12, 4421);
    			attr_dev(div11, "class", "description-container svelte-lxsv7z");
    			add_location(div11, file$1, 99, 10, 3872);
    			attr_dev(button1, "class", "promo-button svelte-lxsv7z");
    			...
    			attr_dev(img8, "class", "santa-image svelte-lxsv7z");
    			add_location(img8, file$1, 117, 12, 4939);
    			attr_dev(div12, "class", "promo-container svelte-lxsv7z");
    			add_location(div12, file$1, 113, 10, 4773);
    			attr_dev(div13, "class", "left-side svelte-lxsv7z");
    			...
    			attr_dev(img9, "class", "tree-image svelte-lxsv7z");
    			...
    			attr_dev(img10, "class", "gifts-image svelte-lxsv7z");
    			...
    			attr_dev(img11, "class", "star star-1 svelte-lxsv7z");
    			...
    			attr_dev(img12, "class", "star star-2 svelte-lxsv7z");
    			...
    			attr_dev(img13, "class", "star star-3 svelte-lxsv7z");
    			add_location(img13, file$1, 127, 12, 5455);
    			attr_dev(div14, "class", "tree-container svelte-lxsv7z");
    			add_location(div14, file$1, 122, 10, 5087);
    			attr_dev(div15, "class", "right-side svelte-lxsv7z");
    			add_location(div15, file$1, 121, 8, 5052);
    			attr_dev(div16, "class", "content mobile-container svelte-lxsv7z");
    			add_location(div16, file$1, 93, 6, 3630);
    			attr_dev(section0, "class", "first-screen svelte-lxsv7z");
    			add_location(section0, file$1, 36, 4, 993);
    			attr_dev(div17, "class", "screen-container svelte-lxsv7z");
    			add_location(div17, file$1, 35, 2, 958);
    			attr_dev(span18, "class", "prize-label svelte-lxsv7z");
    			add_location(span18, file$1, 139, 10, 5806);
    			attr_dev(div18, "class", "prize-header svelte-lxsv7z");
    			add_location(div18, file$1, 138, 8, 5769);
    			attr_dev(h2, "class", "prize-title svelte-lxsv7z");
    			add_location(h2, file$1, 142, 8, 5884);
    			attr_dev(span19, "class", "spec-label svelte-lxsv7z");
    			add_location(span19, file$1, 147, 14, 6061);
    			attr_dev(span20, "class", "spec-value svelte-lxsv7z");
    			add_location(span20, file$1, 148, 14, 6120);
    			attr_dev(div19, "class", "spec-item svelte-lxsv7z");
    			add_location(div19, file$1, 146, 12, 6023);
    			attr_dev(span21, "class", "spec-label svelte-lxsv7z");
    			add_location(span21, file$1, 151, 14, 6228);
    			attr_dev(span22, "class", "spec-value svelte-lxsv7z");
    			add_location(span22, file$1, 152, 14, 6284);
    			attr_dev(div20, "class", "spec-item svelte-lxsv7z");
    			add_location(div20, file$1, 150, 12, 6190);
    			attr_dev(div21, "class", "specs-column svelte-lxsv7z");
    			add_location(div21, file$1, 145, 10, 5984);
    			attr_dev(span23, "class", "spec-label svelte-lxsv7z");
    			add_location(span23, file$1, 157, 14, 6450);
    			attr_dev(span24, "class", "spec-value svelte-lxsv7z");
    			add_location(span24, file$1, 158, 14, 6501);
    			attr_dev(div22, "class", "spec-item svelte-lxsv7z");
    			add_location(div22, file$1, 156, 12, 6412);
    			attr_dev(span25, "class", "spec-label svelte-lxsv7z");
    			add_location(span25, file$1, 161, 14, 6621);
    			attr_dev(span26, "class", "spec-value svelte-lxsv7z");
    			add_location(span26, file$1, 162, 14, 6674);
    			attr_dev(div23, "class", "spec-item svelte-lxsv7z");
    			add_location(div23, file$1, 160, 12, 6583);
    			attr_dev(div24, "class", "specs-column svelte-lxsv7z");
    			add_location(div24, file$1, 155, 10, 6373);
    			attr_dev(div25, "class", "specs-container svelte-lxsv7z");
    			...
    			attr_dev(img14, "class", "prize-image svelte-lxsv7z");
    			...
    			attr_dev(img15, "class", "gift-decoration svelte-lxsv7z");
    			...
    			attr_dev(div26, "class", "main-prize svelte-lxsv7z");
    			set_style(div26, "position", "relative");
    			add_location(div26, file$1, 137, 6, 5708);
    			attr_dev(h30, "class", "prize-card-category svelte-lxsv7z");
    			add_location(h30, file$1, 173, 10, 7144);
    			attr_dev(h40, "class", "prize-card-model svelte-lxsv7z");
    			...
    			attr_dev(img16, "class", "prize-card-image svelte-lxsv7z");
    			add_location(img16, file$1, 175, 10, 7260);
    			attr_dev(div27, "class", "prize-card svelte-lxsv7z");
    			add_location(div27, file$1, 172, 8, 7109);
    			attr_dev(h31, "class", "prize-card-category svelte-lxsv7z");
    			add_location(h31, file$1, 179, 10, 7400);
    			attr_dev(h41, "class", "prize-card-model svelte-lxsv7z");
    			...
    			attr_dev(img17, "class", "prize-card-image svelte-lxsv7z");
    			add_location(img17, file$1, 181, 10, 7519);
    			attr_dev(div28, "class", "prize-card svelte-lxsv7z");
    			add_location(div28, file$1, 178, 8, 7365);
    			attr_dev(h32, "class", "prize-card-category svelte-lxsv7z");
    			add_location(h32, file$1, 185, 10, 7661);
    			attr_dev(h42, "class", "prize-card-model svelte-lxsv7z");
    			...
    			attr_dev(img18, "class", "prize-card-image svelte-lxsv7z");
    			add_location(img18, file$1, 187, 10, 7783);
    			attr_dev(div29, "class", "prize-card svelte-lxsv7z");
    			add_location(div29, file$1, 184, 8, 7626);
    			attr_dev(div30, "class", "additional-prizes svelte-lxsv7z");
    			add_location(div30, file$1, 171, 6, 7069);
    			attr_dev(div31, "class", "header-place svelte-lxsv7z");
    			add_location(div31, file$1, 194, 12, 8022);
    			attr_dev(div32, "class", "header-prize svelte-lxsv7z");
    			add_location(div32, file$1, 195, 12, 8072);
    			attr_dev(div33, "class", "header-freebet svelte-lxsv7z");
    			add_location(div33, file$1, 196, 12, 8121);
    			attr_dev(div34, "class", "leaderboard-headers svelte-lxsv7z");
    			add_location(div34, file$1, 193, 10, 7976);
    			attr_dev(div35, "class", "place svelte-lxsv7z");
    			add_location(div35, file$1, 201, 14, 8277);
    			attr_dev(div36, "class", "prize svelte-lxsv7z");
    			add_location(div36, file$1, 202, 14, 8318);
    			attr_dev(div37, "class", "freebet svelte-lxsv7z");
    			add_location(div37, file$1, 203, 14, 8371);
    			attr_dev(div38, "class", "leaderboard-row svelte-lxsv7z");
    			add_location(div38, file$1, 200, 12, 8233);
    			attr_dev(div39, "class", "place svelte-lxsv7z");
    			add_location(div39, file$1, 207, 14, 8483);
    			attr_dev(div40, "class", "prize svelte-lxsv7z");
    			add_location(div40, file$1, 208, 14, 8524);
    			attr_dev(div41, "class", "freebet svelte-lxsv7z");
    			add_location(div41, file$1, 209, 14, 8577);
    			attr_dev(div42, "class", "leaderboard-row svelte-lxsv7z");
    			add_location(div42, file$1, 206, 12, 8439);
    			attr_dev(div43, "class", "place svelte-lxsv7z");
    			add_location(div43, file$1, 213, 14, 8689);
    			attr_dev(div44, "class", "prize svelte-lxsv7z");
    			add_location(div44, file$1, 214, 14, 8730);
    			attr_dev(div45, "class", "freebet svelte-lxsv7z");
    			add_location(div45, file$1, 215, 14, 8783);
    			attr_dev(div46, "class", "leaderboard-row svelte-lxsv7z");
    			add_location(div46, file$1, 212, 12, 8645);
    			attr_dev(div47, "class", "place svelte-lxsv7z");
    			add_location(div47, file$1, 219, 14, 8895);
    			attr_dev(div48, "class", "prize svelte-lxsv7z");
    			add_location(div48, file$1, 220, 14, 8936);
    			attr_dev(div49, "class", "freebet svelte-lxsv7z");
    			add_location(div49, file$1, 221, 14, 8995);
    			attr_dev(div50, "class", "leaderboard-row svelte-lxsv7z");
    			add_location(div50, file$1, 218, 12, 8851);
    			attr_dev(div51, "class", "place svelte-lxsv7z");
    			add_location(div51, file$1, 225, 14, 9107);
    			attr_dev(div52, "class", "prize svelte-lxsv7z");
    			add_location(div52, file$1, 226, 14, 9148);
    			attr_dev(div53, "class", "freebet svelte-lxsv7z");
    			add_location(div53, file$1, 227, 14, 9207);
    			attr_dev(div54, "class", "leaderboard-row svelte-lxsv7z");
    			add_location(div54, file$1, 224, 12, 9063);
    			attr_dev(div55, "class", "place svelte-lxsv7z");
    			add_location(div55, file$1, 231, 14, 9319);
    			attr_dev(div56, "class", "prize svelte-lxsv7z");
    			add_location(div56, file$1, 232, 14, 9363);
    			attr_dev(div57, "class", "freebet svelte-lxsv7z");
    			add_location(div57, file$1, 233, 14, 9423);
    			attr_dev(div58, "class", "leaderboard-row svelte-lxsv7z");
    			add_location(div58, file$1, 230, 12, 9275);
    			attr_dev(div59, "class", "leaderboard-rows svelte-lxsv7z");
    			add_location(div59, file$1, 199, 10, 8190);
    			attr_dev(div60, "class", "leaderboard-content svelte-lxsv7z");
    			...
    			attr_dev(img19, "class", "svelte-lxsv7z");
    			add_location(img19, file$1, 241, 14, 9636);
    			attr_dev(div61, "class", "merch-images svelte-lxsv7z");
    			add_location(div61, file$1, 240, 12, 9595);
    			attr_dev(div62, "class", "merch-content svelte-lxsv7z");
    			add_location(div62, file$1, 239, 10, 9555);
    			attr_dev(div63, "class", "merch-column svelte-lxsv7z");
    			add_location(div63, file$1, 238, 8, 9518);
    			attr_dev(div64, "class", "leaderboard svelte-lxsv7z");
    			add_location(div64, file$1, 191, 6, 7898);
    			attr_dev(section1, "class", "second-screen svelte-lxsv7z");
    			attr_dev(section1, "id", "prizes");
    			add_location(section1, file$1, 136, 4, 5658);
    			attr_dev(div65, "class", "screen-container svelte-lxsv7z");
    			add_location(div65, file$1, 135, 2, 5623);
    			attr_dev(div66, "class", "contest-title svelte-lxsv7z");
    			add_location(div66, file$1, 255, 10, 10063);
    			attr_dev(div67, "class", "contest-description svelte-lxsv7z");
    			add_location(div67, file$1, 256, 10, 10123);
    			attr_dev(a3, "href", "#");
    			attr_dev(a3, "class", "previous-winners-link svelte-lxsv7z");
    			add_location(a3, file$1, 257, 10, 10251);
    			attr_dev(div68, "class", "header-left svelte-lxsv7z");
    			add_location(div68, file$1, 261, 12, 10409);
    			attr_dev(div69, "class", "header-right svelte-lxsv7z");
    			add_location(div69, file$1, 262, 12, 10456);
    			attr_dev(div70, "class", "table-headers svelte-lxsv7z");
    			add_location(div70, file$1, 260, 10, 10369);
    			attr_dev(div71, "class", "name svelte-lxsv7z");
    			add_location(div71, file$1, 269, 16, 10679);
    			attr_dev(div72, "class", "phone svelte-lxsv7z");
    			add_location(div72, file$1, 270, 16, 10729);
    			attr_dev(div73, "class", "left-column svelte-lxsv7z");
    			add_location(div73, file$1, 268, 14, 10637);
    			attr_dev(div74, "class", "coefficient svelte-lxsv7z");
    			add_location(div74, file$1, 273, 16, 10851);
    			attr_dev(div75, "class", "right-column svelte-lxsv7z");
    			add_location(div75, file$1, 272, 14, 10808);
    			attr_dev(div76, "class", "table-row svelte-lxsv7z");
    			add_location(div76, file$1, 267, 12, 10599);
    			attr_dev(div77, "class", "name svelte-lxsv7z");
    			add_location(div77, file$1, 278, 16, 11020);
    			attr_dev(div78, "class", "phone svelte-lxsv7z");
    			add_location(div78, file$1, 279, 16, 11073);
    			attr_dev(div79, "class", "left-column svelte-lxsv7z");
    			add_location(div79, file$1, 277, 14, 10978);
    			attr_dev(div80, "class", "coefficient svelte-lxsv7z");
    			add_location(div80, file$1, 282, 16, 11195);
    			attr_dev(div81, "class", "right-column svelte-lxsv7z");
    			add_location(div81, file$1, 281, 14, 11152);
    			attr_dev(div82, "class", "table-row svelte-lxsv7z");
    			add_location(div82, file$1, 276, 12, 10940);
    			attr_dev(div83, "class", "name svelte-lxsv7z");
    			add_location(div83, file$1, 287, 16, 11363);
    			attr_dev(div84, "class", "phone svelte-lxsv7z");
    			add_location(div84, file$1, 288, 16, 11414);
    			attr_dev(div85, "class", "left-column svelte-lxsv7z");
    			add_location(div85, file$1, 286, 14, 11321);
    			attr_dev(div86, "class", "coefficient svelte-lxsv7z");
    			add_location(div86, file$1, 291, 16, 11536);
    			attr_dev(div87, "class", "right-column svelte-lxsv7z");
    			add_location(div87, file$1, 290, 14, 11493);
    			attr_dev(div88, "class", "table-row svelte-lxsv7z");
    			add_location(div88, file$1, 285, 12, 11283);
    			attr_dev(div89, "class", "name svelte-lxsv7z");
    			add_location(div89, file$1, 296, 16, 11704);
    			attr_dev(div90, "class", "phone svelte-lxsv7z");
    			add_location(div90, file$1, 297, 16, 11752);
    			attr_dev(div91, "class", "left-column svelte-lxsv7z");
    			add_location(div91, file$1, 295, 14, 11662);
    			attr_dev(div92, "class", "coefficient svelte-lxsv7z");
    			add_location(div92, file$1, 300, 16, 11874);
    			attr_dev(div93, "class", "right-column svelte-lxsv7z");
    			add_location(div93, file$1, 299, 14, 11831);
    			attr_dev(div94, "class", "table-row svelte-lxsv7z");
    			add_location(div94, file$1, 294, 12, 11624);
    			attr_dev(div95, "class", "name svelte-lxsv7z");
    			add_location(div95, file$1, 305, 16, 12042);
    			attr_dev(div96, "class", "phone svelte-lxsv7z");
    			add_location(div96, file$1, 306, 16, 12092);
    			attr_dev(div97, "class", "left-column svelte-lxsv7z");
    			add_location(div97, file$1, 304, 14, 12000);
    			attr_dev(div98, "class", "coefficient svelte-lxsv7z");
    			add_location(div98, file$1, 309, 16, 12214);
    			attr_dev(div99, "class", "right-column svelte-lxsv7z");
    			add_location(div99, file$1, 308, 14, 12171);
    			attr_dev(div100, "class", "table-row svelte-lxsv7z");
    			add_location(div100, file$1, 303, 12, 11962);
    			attr_dev(div101, "class", "name svelte-lxsv7z");
    			add_location(div101, file$1, 314, 16, 12382);
    			attr_dev(div102, "class", "phone svelte-lxsv7z");
    			add_location(div102, file$1, 315, 16, 12432);
    			attr_dev(div103, "class", "left-column svelte-lxsv7z");
    			add_location(div103, file$1, 313, 14, 12340);
    			attr_dev(div104, "class", "coefficient svelte-lxsv7z");
    			add_location(div104, file$1, 318, 16, 12554);
    			attr_dev(div105, "class", "right-column svelte-lxsv7z");
    			add_location(div105, file$1, 317, 14, 12511);
    			attr_dev(div106, "class", "table-row svelte-lxsv7z");
    			add_location(div106, file$1, 312, 12, 12302);
    			attr_dev(div107, "class", "table-rows svelte-lxsv7z");
    			add_location(div107, file$1, 266, 10, 10562);
    			attr_dev(div108, "class", "table-frame svelte-lxsv7z");
    			add_location(div108, file$1, 253, 8, 9989);
    			attr_dev(div109, "class", "leaderboard-left svelte-lxsv7z");
    			add_location(div109, file$1, 252, 6, 9950);
    			attr_dev(button2, "class", "action-button svelte-lxsv7z");
    			add_location(button2, file$1, 327, 10, 12816);
    			attr_dev(button3, "class", "action-button svelte-lxsv7z");
    			add_location(button3, file$1, 328, 10, 12914);
    			attr_dev(p4, "class", "promo-description svelte-lxsv7z");
    			add_location(p4, file$1, 330, 10, 13015);
    			attr_dev(p5, "class", "svelte-lxsv7z");
    			add_location(p5, file$1, 336, 12, 13276);
    			attr_dev(p6, "class", "svelte-lxsv7z");
    			add_location(p6, file$1, 337, 12, 13389);
    			attr_dev(p7, "class", "svelte-lxsv7z");
    			add_location(p7, file$1, 338, 12, 13444);
    			attr_dev(div110, "class", "additional-info svelte-lxsv7z");
    			add_location(div110, file$1, 335, 10, 13234);
    			attr_dev(div111, "class", "actions-container actions-container-mobile svelte-lxsv7z");
    			set_style(div111, "margin-top", "190px");
    			add_location(div111, file$1, 326, 8, 12722);
    			attr_dev(div112, "class", "leaderboard-right svelte-lxsv7z");
    			add_location(div112, file$1, 325, 6, 12682);
    			attr_dev(div113, "class", "leaderboard-container svelte-lxsv7z");
    			add_location(div113, file$1, 251, 4, 9908);
    			attr_dev(section2, "class", "third-screen svelte-lxsv7z");
    			attr_dev(section2, "id", "leaderboard-table");
    			add_location(section2, file$1, 250, 2, 9850);
    			attr_dev(section3, "id", "about-project");
    			attr_dev(section3, "class", "svelte-lxsv7z");
    			add_location(section3, file$1, 346, 2, 13644);
    			attr_dev(div114, "class", "page-wrapper svelte-lxsv7z");

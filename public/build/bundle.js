    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-1t4muhr");
    			add_location(img0, file$1, 17, 10, 520);
    			attr_dev(div0, "class", "candy-cane svelte-1t4muhr");
    			add_location(div0, file$1, 18, 10, 592);
    			attr_dev(div1, "class", "logo-container svelte-1t4muhr");
    			add_location(div1, file$1, 16, 8, 481);
    			attr_dev(div2, "class", "menu-item svelte-1t4muhr");
    			add_location(div2, file$1, 21, 10, 675);
    			attr_dev(div3, "class", "menu-item svelte-1t4muhr");
    			add_location(div3, file$1, 22, 10, 733);
    			attr_dev(div4, "class", "menu-item svelte-1t4muhr");
    			add_location(div4, file$1, 23, 10, 782);
    			attr_dev(div5, "class", "menu svelte-1t4muhr");
    			add_location(div5, file$1, 20, 8, 646);
    			attr_dev(div6, "class", "header svelte-1t4muhr");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-1t4muhr");
    			add_location(img1, file$1, 27, 8, 887);
    			attr_dev(div7, "class", "header-mobile svelte-1t4muhr");
    			add_location(div7, file$1, 26, 6, 851);
    			attr_dev(span0, "class", "first-line svelte-1t4muhr");
    			add_location(span0, file$1, 34, 12, 1134);
    			attr_dev(span1, "class", "second-line svelte-1t4muhr");
    			add_location(span1, file$1, 35, 12, 1190);
    			attr_dev(h10, "class", "title svelte-1t4muhr");
    			add_location(h10, file$1, 33, 10, 1103);
    			attr_dev(p0, "class", "description svelte-1t4muhr");
    			add_location(p0, file$1, 38, 12, 1312);
    			attr_dev(p1, "class", "description description-secondary svelte-1t4muhr");
    			add_location(p1, file$1, 44, 12, 1647);
    			attr_dev(div8, "class", "description-container svelte-1t4muhr");
    			add_location(div8, file$1, 37, 10, 1264);
    			attr_dev(button0, "class", "promo-button svelte-1t4muhr");
    			...
    			attr_dev(img2, "class", "santa-image svelte-1t4muhr");
    			add_location(img2, file$1, 52, 12, 2023);
    			attr_dev(div9, "class", "promo-container svelte-1t4muhr");
    			add_location(div9, file$1, 48, 10, 1857);
    			attr_dev(div10, "class", "left-side svelte-1t4muhr");
    			...
    			attr_dev(img3, "class", "tree-image svelte-1t4muhr");
    			...
    			attr_dev(img4, "class", "gifts-image svelte-1t4muhr");
    			...
    			attr_dev(img5, "class", "star star-1 svelte-1t4muhr");
    			...
    			attr_dev(img6, "class", "star star-2 svelte-1t4muhr");
    			...
    			attr_dev(img7, "class", "star star-3 svelte-1t4muhr");
    			add_location(img7, file$1, 62, 12, 2539);
    			attr_dev(div11, "class", "tree-container svelte-1t4muhr");
    			add_location(div11, file$1, 57, 10, 2171);
    			attr_dev(div12, "class", "right-side svelte-1t4muhr");
    			add_location(div12, file$1, 56, 8, 2136);
    			attr_dev(div13, "class", "content desktop-version svelte-1t4muhr");
    			add_location(div13, file$1, 31, 6, 1023);
    			attr_dev(span2, "class", "first-line svelte-1t4muhr");
    			add_location(span2, file$1, 71, 12, 2805);
    			attr_dev(span3, "class", "second-line svelte-1t4muhr");
    			add_location(span3, file$1, 72, 12, 2861);
    			attr_dev(h11, "class", "title svelte-1t4muhr");
    			add_location(h11, file$1, 70, 10, 2774);
    			attr_dev(p2, "class", "description svelte-1t4muhr");
    			add_location(p2, file$1, 75, 12, 2983);
    			attr_dev(p3, "class", "description description-secondary svelte-1t4muhr");
    			add_location(p3, file$1, 81, 12, 3318);
    			attr_dev(div14, "class", "description-container svelte-1t4muhr");
    			add_location(div14, file$1, 74, 10, 2935);
    			attr_dev(button1, "class", "promo-button svelte-1t4muhr");
    			...
    			attr_dev(img8, "class", "santa-image svelte-1t4muhr");
    			add_location(img8, file$1, 89, 12, 3694);
    			attr_dev(div15, "class", "promo-container svelte-1t4muhr");
    			add_location(div15, file$1, 85, 10, 3528);
    			attr_dev(div16, "class", "left-side svelte-1t4muhr");
    			...
    			attr_dev(img9, "class", "tree-image svelte-1t4muhr");
    			...
    			attr_dev(img10, "class", "gifts-image svelte-1t4muhr");
    			...
    			attr_dev(img11, "class", "star star-1 svelte-1t4muhr");
    			...
    			attr_dev(img12, "class", "star star-2 svelte-1t4muhr");
    			...
    			attr_dev(img13, "class", "star star-3 svelte-1t4muhr");
    			add_location(img13, file$1, 99, 12, 4210);
    			attr_dev(div17, "class", "tree-container svelte-1t4muhr");
    			add_location(div17, file$1, 94, 10, 3842);
    			attr_dev(div18, "class", "right-side svelte-1t4muhr");
    			add_location(div18, file$1, 93, 8, 3807);
    			attr_dev(div19, "class", "content mobile-container svelte-1t4muhr");
    			add_location(div19, file$1, 68, 6, 2693);
    			attr_dev(section0, "class", "first-screen svelte-1t4muhr");
    			add_location(section0, file$1, 14, 4, 415);
    			attr_dev(div20, "class", "screen-container svelte-1t4muhr");
    			add_location(div20, file$1, 13, 2, 380);
    			attr_dev(span4, "class", "prize-label svelte-1t4muhr");
    			add_location(span4, file$1, 111, 10, 4521);
    			attr_dev(div21, "class", "prize-header svelte-1t4muhr");
    			add_location(div21, file$1, 110, 8, 4484);
    			attr_dev(h20, "class", "prize-title svelte-1t4muhr");
    			add_location(h20, file$1, 114, 8, 4599);
    			attr_dev(span5, "class", "spec-label svelte-1t4muhr");
    			add_location(span5, file$1, 119, 14, 4776);
    			attr_dev(span6, "class", "spec-value svelte-1t4muhr");
    			add_location(span6, file$1, 120, 14, 4835);
    			attr_dev(div22, "class", "spec-item svelte-1t4muhr");
    			add_location(div22, file$1, 118, 12, 4738);
    			attr_dev(span7, "class", "spec-label svelte-1t4muhr");
    			add_location(span7, file$1, 123, 14, 4943);
    			attr_dev(span8, "class", "spec-value svelte-1t4muhr");
    			add_location(span8, file$1, 124, 14, 4999);
    			attr_dev(div23, "class", "spec-item svelte-1t4muhr");
    			add_location(div23, file$1, 122, 12, 4905);
    			attr_dev(div24, "class", "specs-column svelte-1t4muhr");
    			add_location(div24, file$1, 117, 10, 4699);
    			attr_dev(span9, "class", "spec-label svelte-1t4muhr");
    			add_location(span9, file$1, 129, 14, 5165);
    			attr_dev(span10, "class", "spec-value svelte-1t4muhr");
    			add_location(span10, file$1, 130, 14, 5216);
    			attr_dev(div25, "class", "spec-item svelte-1t4muhr");
    			add_location(div25, file$1, 128, 12, 5127);
    			attr_dev(span11, "class", "spec-label svelte-1t4muhr");
    			add_location(span11, file$1, 133, 14, 5336);
    			attr_dev(span12, "class", "spec-value svelte-1t4muhr");
    			add_location(span12, file$1, 134, 14, 5389);
    			attr_dev(div26, "class", "spec-item svelte-1t4muhr");
    			add_location(div26, file$1, 132, 12, 5298);
    			attr_dev(div27, "class", "specs-column svelte-1t4muhr");
    			add_location(div27, file$1, 127, 10, 5088);
    			attr_dev(div28, "class", "specs-container svelte-1t4muhr");
    			...
    			attr_dev(img14, "class", "prize-image svelte-1t4muhr");
    			add_location(img14, file$1, 139, 8, 5495);
    			attr_dev(div29, "class", "main-prize svelte-1t4muhr");
    			add_location(div29, file$1, 109, 6, 4451);
    			attr_dev(h30, "class", "prize-card-category svelte-1t4muhr");
    			add_location(h30, file$1, 144, 10, 5666);
    			attr_dev(h40, "class", "prize-card-model svelte-1t4muhr");
    			...
    			attr_dev(img15, "class", "prize-card-image svelte-1t4muhr");
    			add_location(img15, file$1, 146, 10, 5782);
    			attr_dev(div30, "class", "prize-card svelte-1t4muhr");
    			add_location(div30, file$1, 143, 8, 5631);
    			attr_dev(h31, "class", "prize-card-category svelte-1t4muhr");
    			add_location(h31, file$1, 150, 10, 5922);
    			attr_dev(h41, "class", "prize-card-model svelte-1t4muhr");
    			...
    			attr_dev(img16, "class", "prize-card-image svelte-1t4muhr");
    			add_location(img16, file$1, 152, 10, 6041);
    			attr_dev(div31, "class", "prize-card svelte-1t4muhr");
    			add_location(div31, file$1, 149, 8, 5887);
    			attr_dev(h32, "class", "prize-card-category svelte-1t4muhr");
    			add_location(h32, file$1, 156, 10, 6183);
    			attr_dev(h42, "class", "prize-card-model svelte-1t4muhr");
    			...
    			attr_dev(img17, "class", "prize-card-image svelte-1t4muhr");
    			add_location(img17, file$1, 158, 10, 6305);
    			attr_dev(div32, "class", "prize-card svelte-1t4muhr");
    			add_location(div32, file$1, 155, 8, 6148);
    			attr_dev(div33, "class", "additional-prizes svelte-1t4muhr");
    			add_location(div33, file$1, 142, 6, 5591);
    			attr_dev(div34, "class", "header-place svelte-1t4muhr");
    			add_location(div34, file$1, 165, 12, 6544);
    			attr_dev(div35, "class", "header-prize svelte-1t4muhr");
    			add_location(div35, file$1, 166, 12, 6594);
    			attr_dev(div36, "class", "header-freebet svelte-1t4muhr");
    			add_location(div36, file$1, 167, 12, 6643);
    			attr_dev(div37, "class", "leaderboard-headers svelte-1t4muhr");
    			add_location(div37, file$1, 164, 10, 6498);
    			attr_dev(div38, "class", "place svelte-1t4muhr");
    			add_location(div38, file$1, 172, 14, 6799);
    			attr_dev(div39, "class", "prize svelte-1t4muhr");
    			add_location(div39, file$1, 173, 14, 6840);
    			attr_dev(div40, "class", "freebet svelte-1t4muhr");
    			add_location(div40, file$1, 174, 14, 6893);
    			attr_dev(div41, "class", "leaderboard-row svelte-1t4muhr");
    			add_location(div41, file$1, 171, 12, 6755);
    			attr_dev(div42, "class", "place svelte-1t4muhr");
    			add_location(div42, file$1, 178, 14, 7005);
    			attr_dev(div43, "class", "prize svelte-1t4muhr");
    			add_location(div43, file$1, 179, 14, 7046);
    			attr_dev(div44, "class", "freebet svelte-1t4muhr");
    			add_location(div44, file$1, 180, 14, 7099);
    			attr_dev(div45, "class", "leaderboard-row svelte-1t4muhr");
    			add_location(div45, file$1, 177, 12, 6961);
    			attr_dev(div46, "class", "place svelte-1t4muhr");
    			add_location(div46, file$1, 184, 14, 7211);
    			attr_dev(div47, "class", "prize svelte-1t4muhr");
    			add_location(div47, file$1, 185, 14, 7252);
    			attr_dev(div48, "class", "freebet svelte-1t4muhr");
    			add_location(div48, file$1, 186, 14, 7305);
    			attr_dev(div49, "class", "leaderboard-row svelte-1t4muhr");
    			add_location(div49, file$1, 183, 12, 7167);
    			attr_dev(div50, "class", "place svelte-1t4muhr");
    			add_location(div50, file$1, 190, 14, 7417);
    			attr_dev(div51, "class", "prize svelte-1t4muhr");
    			add_location(div51, file$1, 191, 14, 7458);
    			attr_dev(div52, "class", "freebet svelte-1t4muhr");
    			add_location(div52, file$1, 192, 14, 7517);
    			attr_dev(div53, "class", "leaderboard-row svelte-1t4muhr");
    			add_location(div53, file$1, 189, 12, 7373);
    			attr_dev(div54, "class", "place svelte-1t4muhr");
    			add_location(div54, file$1, 196, 14, 7629);
    			attr_dev(div55, "class", "prize svelte-1t4muhr");
    			add_location(div55, file$1, 197, 14, 7670);
    			attr_dev(div56, "class", "freebet svelte-1t4muhr");
    			add_location(div56, file$1, 198, 14, 7729);
    			attr_dev(div57, "class", "leaderboard-row svelte-1t4muhr");
    			add_location(div57, file$1, 195, 12, 7585);
    			attr_dev(div58, "class", "place svelte-1t4muhr");
    			add_location(div58, file$1, 202, 14, 7841);
    			attr_dev(div59, "class", "prize svelte-1t4muhr");
    			add_location(div59, file$1, 203, 14, 7885);
    			attr_dev(div60, "class", "freebet svelte-1t4muhr");
    			add_location(div60, file$1, 204, 14, 7945);
    			attr_dev(div61, "class", "leaderboard-row svelte-1t4muhr");
    			add_location(div61, file$1, 201, 12, 7797);
    			attr_dev(div62, "class", "leaderboard-rows svelte-1t4muhr");
    			add_location(div62, file$1, 170, 10, 6712);
    			attr_dev(div63, "class", "leaderboard-content svelte-1t4muhr");
    			add_location(div63, file$1, 163, 8, 6454);
    			attr_dev(div64, "class", "merch-images svelte-1t4muhr");
    			add_location(div64, file$1, 211, 12, 8117);
    			attr_dev(span13, "class", "svelte-1t4muhr");
    			add_location(span13, file$1, 215, 14, 8269);
    			attr_dev(div65, "class", "merch-status svelte-1t4muhr");
    			add_location(div65, file$1, 214, 12, 8228);
    			attr_dev(div66, "class", "merch-content svelte-1t4muhr");
    			add_location(div66, file$1, 210, 10, 8077);
    			attr_dev(div67, "class", "merch-column svelte-1t4muhr");
    			add_location(div67, file$1, 209, 8, 8040);
    			attr_dev(div68, "class", "leaderboard svelte-1t4muhr");
    			add_location(div68, file$1, 162, 6, 6420);
    			attr_dev(section1, "class", "second-screen svelte-1t4muhr");
    			add_location(section1, file$1, 108, 4, 4413);
    			attr_dev(div69, "class", "screen-container svelte-1t4muhr");
    			add_location(div69, file$1, 107, 2, 4378);
    			attr_dev(h21, "class", "leaderboard-title svelte-1t4muhr");
    			add_location(h21, file$1, 227, 8, 8531);
    			attr_dev(p4, "class", "leaderboard-description svelte-1t4muhr");
    			add_location(p4, file$1, 228, 8, 8591);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-1t4muhr");
    			add_location(a, file$1, 231, 8, 8737);
    			attr_dev(div70, "class", "table-frame svelte-1t4muhr");
    			add_location(div70, file$1, 235, 10, 8913);
    			attr_dev(div71, "class", "leaderboard-table svelte-1t4muhr");
    			add_location(div71, file$1, 233, 8, 8832);
    			attr_dev(div72, "class", "leaderboard-left svelte-1t4muhr");
    			add_location(div72, file$1, 226, 6, 8492);
    			attr_dev(button2, "class", "action-button svelte-1t4muhr");
    			add_location(button2, file$1, 243, 8, 9118);
    			attr_dev(button3, "class", "action-button svelte-1t4muhr");
    			add_location(button3, file$1, 244, 8, 9182);
    			attr_dev(p5, "class", "promo-description svelte-1t4muhr");
    			add_location(p5, file$1, 246, 8, 9251);
    			attr_dev(p6, "class", "svelte-1t4muhr");
    			add_location(p6, file$1, 252, 12, 9507);
    			attr_dev(p7, "class", "svelte-1t4muhr");
    			add_location(p7, file$1, 253, 12, 9619);
    			attr_dev(p8, "class", "svelte-1t4muhr");
    			add_location(p8, file$1, 254, 12, 9673);
    			attr_dev(div73, "class", "additional-info svelte-1t4muhr");
    			add_location(div73, file$1, 251, 10, 9465);
    			attr_dev(div74, "class", "actions-container svelte-1t4muhr");
    			add_location(div74, file$1, 242, 6, 9078);
    			attr_dev(div75, "class", "leaderboard-right svelte-1t4muhr");
    			add_location(div75, file$1, 241, 4, 9040);
    			attr_dev(div76, "class", "leaderboard-container svelte-1t4muhr");
    			add_location(div76, file$1, 225, 4, 8450);
    			attr_dev(section2, "class", "third-screen svelte-1t4muhr");
    			add_location(section2, file$1, 224, 2, 8415);
    			attr_dev(div77, "class", "page-wrapper svelte-1t4muhr");

    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "header-image svelte-txjldq");
    			add_location(img0, file$1, 9, 2, 224);
    			add_location(picture, file$1, 5, 0, 85);
    			attr_dev(br, "class", "svelte-txjldq");
    			add_location(br, file$1, 15, 17, 391);
    			attr_dev(h1, "class", "title svelte-txjldq");
    			add_location(h1, file$1, 14, 4, 355);
    			attr_dev(p0, "class", "description svelte-txjldq");
    			add_location(p0, file$1, 18, 4, 431);
    			attr_dev(p1, "class", "description svelte-txjldq");
    			add_location(p1, file$1, 23, 4, 714);
    			attr_dev(button, "class", "promo-button svelte-txjldq");
    			add_location(button, file$1, 26, 4, 863);
    			attr_dev(div0, "class", "left-side svelte-txjldq");
    			...
    			attr_dev(img1, "class", "tree-image svelte-txjldq");
    			add_location(img1, file$1, 31, 4, 971);
    			attr_dev(div1, "class", "right-side svelte-txjldq");
    			add_location(div1, file$1, 30, 2, 942);
    			attr_dev(div2, "class", "content svelte-txjldq");
    			add_location(div2, file$1, 12, 0, 303);
    			attr_dev(section, "class", "screen svelte-txjldq");

    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t21 = text("\n\n\n```");
    			attr_dev(h2, "class", "project-title svelte-1whjp9i");
    			add_location(h2, file$3, 5, 2, 90);
    			attr_dev(p0, "class", "highlight-text svelte-1whjp9i");
    			add_location(p0, file$3, 8, 6, 205);
    			attr_dev(p1, "class", "rules-text svelte-1whjp9i");
    			add_location(p1, file$3, 9, 6, 323);
    			attr_dev(p2, "class", "details-text svelte-1whjp9i");
    			add_location(p2, file$3, 10, 6, 369);
    			attr_dev(span, "class", "promo-button-text svelte-1whjp9i");
    			add_location(span, file$3, 12, 8, 614);
    			attr_dev(div0, "class", "promo-button svelte-1whjp9i");
    			add_location(div0, file$3, 11, 6, 579);
    			attr_dev(div1, "class", "project-description svelte-1whjp9i");
    			add_location(div1, file$3, 7, 4, 165);
    			attr_dev(div2, "class", "image image-lamp svelte-1whjp9i");
    			add_location(div2, file$3, 19, 10, 868);
    			attr_dev(div3, "class", "image-frame svelte-1whjp9i");
    			add_location(div3, file$3, 18, 8, 832);
    			attr_dev(p3, "class", "row-text svelte-1whjp9i");
    			add_location(p3, file$3, 21, 8, 928);
    			attr_dev(div4, "class", "lamp-text-block svelte-1whjp9i");
    			add_location(div4, file$3, 17, 6, 794);
    			attr_dev(div5, "class", "image image-lamp svelte-1whjp9i");
    			add_location(div5, file$3, 27, 10, 1131);
    			attr_dev(div6, "class", "image image-lamp svelte-1whjp9i");
    			add_location(div6, file$3, 28, 10, 1178);
    			attr_dev(div7, "class", "image-frame svelte-1whjp9i");
    			add_location(div7, file$3, 26, 8, 1095);
    			attr_dev(p4, "class", "row-text svelte-1whjp9i");
    			add_location(p4, file$3, 30, 8, 1238);
    			attr_dev(div8, "class", "lamp-text-block svelte-1whjp9i");
    			add_location(div8, file$3, 25, 6, 1057);
    			attr_dev(div9, "class", "image image-lamp svelte-1whjp9i");
    			add_location(div9, file$3, 36, 10, 1469);
    			attr_dev(div10, "class", "image image-lamp svelte-1whjp9i");
    			add_location(div10, file$3, 37, 10, 1516);
    			attr_dev(div11, "class", "image image-lamp svelte-1whjp9i");
    			add_location(div11, file$3, 38, 10, 1563);
    			attr_dev(div12, "class", "image-frame svelte-1whjp9i");
    			add_location(div12, file$3, 35, 8, 1433);
    			attr_dev(p5, "class", "row-text svelte-1whjp9i");
    			add_location(p5, file$3, 40, 8, 1623);
    			attr_dev(div13, "class", "lamp-text-block svelte-1whjp9i");
    			add_location(div13, file$3, 34, 6, 1395);
    			attr_dev(div14, "class", "right-column svelte-1whjp9i");
    			add_location(div14, file$3, 15, 4, 699);
    			attr_dev(div15, "class", "project-frame svelte-1whjp9i");
    			add_location(div15, file$3, 6, 2, 133);
    			attr_dev(div16, "class", "about-project svelte-1whjp9i");
    			add_location(div16, file$3, 4, 0, 60);
    		},

    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-8momyt");
    			add_location(img0, file$1, 17, 10, 520);
    			attr_dev(div0, "class", "candy-cane svelte-8momyt");
    			add_location(div0, file$1, 18, 10, 592);
    			attr_dev(div1, "class", "logo-container svelte-8momyt");
    			add_location(div1, file$1, 16, 8, 481);
    			attr_dev(div2, "class", "menu-item svelte-8momyt");
    			add_location(div2, file$1, 21, 10, 675);
    			attr_dev(div3, "class", "menu-item svelte-8momyt");
    			add_location(div3, file$1, 22, 10, 733);
    			attr_dev(div4, "class", "menu-item svelte-8momyt");
    			add_location(div4, file$1, 23, 10, 782);
    			attr_dev(div5, "class", "menu svelte-8momyt");
    			add_location(div5, file$1, 20, 8, 646);
    			attr_dev(div6, "class", "header svelte-8momyt");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-8momyt");
    			add_location(img1, file$1, 27, 8, 887);
    			attr_dev(div7, "class", "header-mobile svelte-8momyt");
    			add_location(div7, file$1, 26, 6, 851);
    			attr_dev(br, "class", "svelte-8momyt");
    			add_location(br, file$1, 33, 23, 1104);
    			attr_dev(h1, "class", "title svelte-8momyt");
    			add_location(h1, file$1, 32, 10, 1062);
    			attr_dev(p0, "class", "description svelte-8momyt");
    			add_location(p0, file$1, 36, 10, 1162);
    			attr_dev(p1, "class", "description svelte-8momyt");
    			add_location(p1, file$1, 41, 10, 1474);
    			attr_dev(button0, "class", "promo-button svelte-8momyt");
    			add_location(button0, file$1, 45, 12, 1683);
    			if (!src_url_equal(img2.src, img2_src_value = "/images/santa.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "Санта");
    			attr_dev(img2, "class", "santa-image svelte-8momyt");
    			add_location(img2, file$1, 48, 12, 1807);
    			attr_dev(div8, "class", "promo-container svelte-8momyt");
    			add_location(div8, file$1, 44, 10, 1641);
    			attr_dev(div9, "class", "left-side svelte-8momyt");
    			...
    			attr_dev(img3, "class", "tree-image svelte-8momyt");
    			add_location(img3, file$1, 53, 12, 1987);
    			if (!src_url_equal(img4.src, img4_src_value = "/images/Подарки.png")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "Подарки");
    			attr_dev(img4, "class", "gifts-image svelte-8momyt");
    			add_location(img4, file$1, 54, 12, 2070);
    			attr_dev(div10, "class", "tree-container svelte-8momyt");
    			add_location(div10, file$1, 52, 10, 1946);
    			attr_dev(div11, "class", "right-side svelte-8momyt");
    			add_location(div11, file$1, 51, 8, 1911);
    			attr_dev(div12, "class", "content svelte-8momyt");
    			add_location(div12, file$1, 30, 6, 998);
    			attr_dev(section0, "class", "first-screen svelte-8momyt");
    			add_location(section0, file$1, 14, 4, 415);
    			attr_dev(div13, "class", "screen-container svelte-8momyt");
    			add_location(div13, file$1, 13, 2, 380);
    			attr_dev(span0, "class", "prize-label svelte-8momyt");
    			add_location(span0, file$1, 66, 10, 2379);
    			attr_dev(div14, "class", "prize-header svelte-8momyt");
    			add_location(div14, file$1, 65, 8, 2342);
    			attr_dev(h20, "class", "prize-title svelte-8momyt");
    			add_location(h20, file$1, 69, 8, 2457);
    			attr_dev(span1, "class", "spec-label svelte-8momyt");
    			add_location(span1, file$1, 74, 14, 2634);
    			attr_dev(span2, "class", "spec-value svelte-8momyt");
    			add_location(span2, file$1, 75, 14, 2693);
    			attr_dev(div15, "class", "spec-item svelte-8momyt");
    			add_location(div15, file$1, 73, 12, 2596);
    			attr_dev(span3, "class", "spec-label svelte-8momyt");
    			add_location(span3, file$1, 78, 14, 2801);
    			attr_dev(span4, "class", "spec-value svelte-8momyt");
    			add_location(span4, file$1, 79, 14, 2857);
    			attr_dev(div16, "class", "spec-item svelte-8momyt");
    			add_location(div16, file$1, 77, 12, 2763);
    			attr_dev(div17, "class", "specs-column svelte-8momyt");
    			add_location(div17, file$1, 72, 10, 2557);
    			attr_dev(span5, "class", "spec-label svelte-8momyt");
    			add_location(span5, file$1, 84, 14, 3023);
    			attr_dev(span6, "class", "spec-value svelte-8momyt");
    			add_location(span6, file$1, 85, 14, 3074);
    			attr_dev(div18, "class", "spec-item svelte-8momyt");
    			add_location(div18, file$1, 83, 12, 2985);
    			attr_dev(span7, "class", "spec-label svelte-8momyt");
    			add_location(span7, file$1, 88, 14, 3194);
    			attr_dev(span8, "class", "spec-value svelte-8momyt");
    			add_location(span8, file$1, 89, 14, 3247);
    			attr_dev(div19, "class", "spec-item svelte-8momyt");
    			add_location(div19, file$1, 87, 12, 3156);
    			attr_dev(div20, "class", "specs-column svelte-8momyt");
    			add_location(div20, file$1, 82, 10, 2946);
    			attr_dev(div21, "class", "specs-container svelte-8momyt");
    			add_location(div21, file$1, 71, 8, 2517);
    			...
    			attr_dev(img5, "class", "prize-image svelte-8momyt");
    			add_location(img5, file$1, 94, 8, 3353);
    			attr_dev(div22, "class", "main-prize svelte-8momyt");
    			add_location(div22, file$1, 64, 6, 2309);
    			attr_dev(h30, "class", "prize-card-category svelte-8momyt");
    			add_location(h30, file$1, 99, 10, 3524);
    			attr_dev(h40, "class", "prize-card-model svelte-8momyt");
    			add_location(h40, file$1, 100, 10, 3580);
    			...
    			attr_dev(img6, "class", "prize-card-image svelte-8momyt");
    			add_location(img6, file$1, 101, 10, 3640);
    			attr_dev(div23, "class", "prize-card svelte-8momyt");
    			add_location(div23, file$1, 98, 8, 3489);
    			attr_dev(h31, "class", "prize-card-category svelte-8momyt");
    			add_location(h31, file$1, 105, 10, 3780);
    			attr_dev(h41, "class", "prize-card-model svelte-8momyt");
    			add_location(h41, file$1, 106, 10, 3839);
    			...
    			attr_dev(img7, "class", "prize-card-image svelte-8momyt");
    			add_location(img7, file$1, 107, 10, 3899);
    			attr_dev(div24, "class", "prize-card svelte-8momyt");
    			add_location(div24, file$1, 104, 8, 3745);
    			attr_dev(h32, "class", "prize-card-category svelte-8momyt");
    			add_location(h32, file$1, 111, 10, 4041);
    			attr_dev(h42, "class", "prize-card-model svelte-8momyt");
    			add_location(h42, file$1, 112, 10, 4102);
    			...
    			attr_dev(img8, "class", "prize-card-image svelte-8momyt");
    			add_location(img8, file$1, 113, 10, 4163);
    			attr_dev(div25, "class", "prize-card svelte-8momyt");
    			add_location(div25, file$1, 110, 8, 4006);
    			attr_dev(div26, "class", "additional-prizes svelte-8momyt");
    			add_location(div26, file$1, 97, 6, 3449);
    			attr_dev(div27, "class", "header-place svelte-8momyt");
    			add_location(div27, file$1, 120, 12, 4402);
    			attr_dev(div28, "class", "header-prize svelte-8momyt");
    			add_location(div28, file$1, 121, 12, 4452);
    			attr_dev(div29, "class", "header-freebet svelte-8momyt");
    			add_location(div29, file$1, 122, 12, 4501);
    			attr_dev(div30, "class", "leaderboard-headers svelte-8momyt");
    			add_location(div30, file$1, 119, 10, 4356);
    			attr_dev(div31, "class", "place svelte-8momyt");
    			add_location(div31, file$1, 127, 14, 4657);
    			attr_dev(div32, "class", "prize svelte-8momyt");
    			add_location(div32, file$1, 128, 14, 4698);
    			attr_dev(div33, "class", "freebet svelte-8momyt");
    			add_location(div33, file$1, 129, 14, 4751);
    			attr_dev(div34, "class", "leaderboard-row svelte-8momyt");
    			add_location(div34, file$1, 126, 12, 4613);
    			attr_dev(div35, "class", "place svelte-8momyt");
    			add_location(div35, file$1, 133, 14, 4863);
    			attr_dev(div36, "class", "prize svelte-8momyt");
    			add_location(div36, file$1, 134, 14, 4904);
    			attr_dev(div37, "class", "freebet svelte-8momyt");
    			add_location(div37, file$1, 135, 14, 4957);
    			attr_dev(div38, "class", "leaderboard-row svelte-8momyt");
    			add_location(div38, file$1, 132, 12, 4819);
    			attr_dev(div39, "class", "place svelte-8momyt");
    			add_location(div39, file$1, 139, 14, 5069);
    			attr_dev(div40, "class", "prize svelte-8momyt");
    			add_location(div40, file$1, 140, 14, 5110);
    			attr_dev(div41, "class", "freebet svelte-8momyt");
    			add_location(div41, file$1, 141, 14, 5163);
    			attr_dev(div42, "class", "leaderboard-row svelte-8momyt");
    			add_location(div42, file$1, 138, 12, 5025);
    			attr_dev(div43, "class", "place svelte-8momyt");
    			add_location(div43, file$1, 145, 14, 5275);
    			attr_dev(div44, "class", "prize svelte-8momyt");
    			add_location(div44, file$1, 146, 14, 5316);
    			attr_dev(div45, "class", "freebet svelte-8momyt");
    			add_location(div45, file$1, 147, 14, 5375);
    			attr_dev(div46, "class", "leaderboard-row svelte-8momyt");
    			add_location(div46, file$1, 144, 12, 5231);
    			attr_dev(div47, "class", "place svelte-8momyt");
    			add_location(div47, file$1, 151, 14, 5487);
    			attr_dev(div48, "class", "prize svelte-8momyt");
    			add_location(div48, file$1, 152, 14, 5528);
    			attr_dev(div49, "class", "freebet svelte-8momyt");
    			add_location(div49, file$1, 153, 14, 5587);
    			attr_dev(div50, "class", "leaderboard-row svelte-8momyt");
    			add_location(div50, file$1, 150, 12, 5443);
    			attr_dev(div51, "class", "place svelte-8momyt");
    			add_location(div51, file$1, 157, 14, 5699);
    			attr_dev(div52, "class", "prize svelte-8momyt");
    			add_location(div52, file$1, 158, 14, 5743);
    			attr_dev(div53, "class", "freebet svelte-8momyt");
    			add_location(div53, file$1, 159, 14, 5803);
    			attr_dev(div54, "class", "leaderboard-row svelte-8momyt");
    			add_location(div54, file$1, 156, 12, 5655);
    			attr_dev(div55, "class", "leaderboard-rows svelte-8momyt");
    			add_location(div55, file$1, 125, 10, 4570);
    			attr_dev(div56, "class", "leaderboard-content svelte-8momyt");
    			add_location(div56, file$1, 118, 8, 4312);
    			attr_dev(div57, "class", "merch-images svelte-8momyt");
    			add_location(div57, file$1, 166, 12, 5975);
    			attr_dev(span9, "class", "svelte-8momyt");
    			add_location(span9, file$1, 170, 14, 6127);
    			attr_dev(div58, "class", "merch-status svelte-8momyt");
    			add_location(div58, file$1, 169, 12, 6086);
    			attr_dev(div59, "class", "merch-content svelte-8momyt");
    			add_location(div59, file$1, 165, 10, 5935);
    			attr_dev(div60, "class", "merch-column svelte-8momyt");
    			add_location(div60, file$1, 164, 8, 5898);
    			attr_dev(div61, "class", "leaderboard svelte-8momyt");
    			add_location(div61, file$1, 117, 6, 4278);
    			attr_dev(section1, "class", "second-screen svelte-8momyt");
    			add_location(section1, file$1, 63, 4, 2271);
    			attr_dev(div62, "class", "screen-container svelte-8momyt");
    			add_location(div62, file$1, 62, 2, 2236);
    			attr_dev(h21, "class", "leaderboard-title svelte-8momyt");
    			add_location(h21, file$1, 182, 8, 6389);
    			attr_dev(p2, "class", "leaderboard-description svelte-8momyt");
    			add_location(p2, file$1, 183, 8, 6449);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-8momyt");
    			add_location(a, file$1, 186, 8, 6595);
    			attr_dev(div63, "class", "table-frame svelte-8momyt");
    			add_location(div63, file$1, 190, 10, 6771);
    			attr_dev(div64, "class", "leaderboard-table svelte-8momyt");
    			add_location(div64, file$1, 188, 8, 6690);
    			attr_dev(div65, "class", "leaderboard-left svelte-8momyt");
    			add_location(div65, file$1, 181, 6, 6350);
    			attr_dev(button1, "class", "action-button svelte-8momyt");
    			add_location(button1, file$1, 198, 8, 6976);
    			attr_dev(button2, "class", "action-button svelte-8momyt");
    			add_location(button2, file$1, 199, 8, 7040);
    			attr_dev(p3, "class", "promo-description svelte-8momyt");
    			add_location(p3, file$1, 201, 8, 7109);
    			attr_dev(p4, "class", "svelte-8momyt");
    			add_location(p4, file$1, 207, 12, 7365);
    			attr_dev(p5, "class", "svelte-8momyt");
    			add_location(p5, file$1, 208, 12, 7477);
    			attr_dev(p6, "class", "svelte-8momyt");
    			add_location(p6, file$1, 209, 12, 7531);
    			attr_dev(div66, "class", "additional-info svelte-8momyt");
    			add_location(div66, file$1, 206, 10, 7323);
    			attr_dev(div67, "class", "actions-container svelte-8momyt");
    			add_location(div67, file$1, 197, 6, 6936);
    			attr_dev(div68, "class", "leaderboard-right svelte-8momyt");
    			add_location(div68, file$1, 196, 4, 6898);
    			attr_dev(div69, "class", "leaderboard-container svelte-8momyt");
    			add_location(div69, file$1, 180, 4, 6308);
    			attr_dev(section2, "class", "third-screen svelte-8momyt");
    			add_location(section2, file$1, 179, 2, 6273);
    			attr_dev(div70, "class", "page-wrapper svelte-8momyt");

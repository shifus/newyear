    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-kvgqh7");
    			add_location(img0, file$1, 17, 10, 520);
    			attr_dev(div0, "class", "candy-cane svelte-kvgqh7");
    			add_location(div0, file$1, 18, 10, 592);
    			attr_dev(div1, "class", "logo-container svelte-kvgqh7");
    			add_location(div1, file$1, 16, 8, 481);
    			attr_dev(div2, "class", "menu-item svelte-kvgqh7");
    			add_location(div2, file$1, 21, 10, 675);
    			attr_dev(div3, "class", "menu-item svelte-kvgqh7");
    			add_location(div3, file$1, 22, 10, 733);
    			attr_dev(div4, "class", "menu-item svelte-kvgqh7");
    			add_location(div4, file$1, 23, 10, 782);
    			attr_dev(div5, "class", "menu svelte-kvgqh7");
    			add_location(div5, file$1, 20, 8, 646);
    			attr_dev(div6, "class", "header svelte-kvgqh7");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-kvgqh7");
    			add_location(img1, file$1, 27, 8, 887);
    			attr_dev(div7, "class", "header-mobile svelte-kvgqh7");
    			add_location(div7, file$1, 26, 6, 851);
    			attr_dev(br, "class", "svelte-kvgqh7");
    			add_location(br, file$1, 33, 23, 1104);
    			attr_dev(h1, "class", "title svelte-kvgqh7");
    			add_location(h1, file$1, 32, 10, 1062);
    			attr_dev(p0, "class", "description svelte-kvgqh7");
    			add_location(p0, file$1, 36, 10, 1162);
    			attr_dev(p1, "class", "description svelte-kvgqh7");
    			add_location(p1, file$1, 41, 10, 1474);
    			attr_dev(button0, "class", "promo-button svelte-kvgqh7");
    			...
    			attr_dev(img2, "class", "santa-image svelte-kvgqh7");
    			add_location(img2, file$1, 48, 12, 1804);
    			attr_dev(div8, "class", "promo-container svelte-kvgqh7");
    			add_location(div8, file$1, 44, 10, 1638);
    			attr_dev(div9, "class", "left-side svelte-kvgqh7");
    			add_location(div9, file$1, 31, 8, 1028);
    			if (!src_url_equal(img3.src, img3_src_value = "/images/your-tree-image.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Ёлка");
    			attr_dev(img3, "class", "tree-image svelte-kvgqh7");
    			...
    			attr_dev(img4, "class", "gifts-image svelte-kvgqh7");
    			add_location(img4, file$1, 54, 12, 2068);
    			attr_dev(div10, "class", "tree-container svelte-kvgqh7");
    			add_location(div10, file$1, 52, 10, 1943);
    			attr_dev(div11, "class", "right-side svelte-kvgqh7");
    			add_location(div11, file$1, 51, 8, 1908);
    			attr_dev(div12, "class", "content svelte-kvgqh7");
    			add_location(div12, file$1, 30, 6, 998);
    			attr_dev(section0, "class", "first-screen svelte-kvgqh7");
    			add_location(section0, file$1, 14, 4, 415);
    			attr_dev(div13, "class", "screen-container svelte-kvgqh7");
    			add_location(div13, file$1, 13, 2, 380);
    			attr_dev(span0, "class", "prize-label svelte-kvgqh7");
    			add_location(span0, file$1, 66, 10, 2377);
    			attr_dev(div14, "class", "prize-header svelte-kvgqh7");
    			add_location(div14, file$1, 65, 8, 2340);
    			attr_dev(h20, "class", "prize-title svelte-kvgqh7");
    			add_location(h20, file$1, 69, 8, 2455);
    			attr_dev(span1, "class", "spec-label svelte-kvgqh7");
    			add_location(span1, file$1, 74, 14, 2632);
    			attr_dev(span2, "class", "spec-value svelte-kvgqh7");
    			add_location(span2, file$1, 75, 14, 2691);
    			attr_dev(div15, "class", "spec-item svelte-kvgqh7");
    			add_location(div15, file$1, 73, 12, 2594);
    			attr_dev(span3, "class", "spec-label svelte-kvgqh7");
    			add_location(span3, file$1, 78, 14, 2799);
    			attr_dev(span4, "class", "spec-value svelte-kvgqh7");
    			add_location(span4, file$1, 79, 14, 2855);
    			attr_dev(div16, "class", "spec-item svelte-kvgqh7");
    			add_location(div16, file$1, 77, 12, 2761);
    			attr_dev(div17, "class", "specs-column svelte-kvgqh7");
    			add_location(div17, file$1, 72, 10, 2555);
    			attr_dev(span5, "class", "spec-label svelte-kvgqh7");
    			add_location(span5, file$1, 84, 14, 3021);
    			attr_dev(span6, "class", "spec-value svelte-kvgqh7");
    			add_location(span6, file$1, 85, 14, 3072);
    			attr_dev(div18, "class", "spec-item svelte-kvgqh7");
    			add_location(div18, file$1, 83, 12, 2983);
    			attr_dev(span7, "class", "spec-label svelte-kvgqh7");
    			add_location(span7, file$1, 88, 14, 3192);
    			attr_dev(span8, "class", "spec-value svelte-kvgqh7");
    			add_location(span8, file$1, 89, 14, 3245);
    			attr_dev(div19, "class", "spec-item svelte-kvgqh7");
    			add_location(div19, file$1, 87, 12, 3154);
    			attr_dev(div20, "class", "specs-column svelte-kvgqh7");
    			add_location(div20, file$1, 82, 10, 2944);
    			attr_dev(div21, "class", "specs-container svelte-kvgqh7");
    			add_location(div21, file$1, 71, 8, 2515);
    			...
    			attr_dev(img5, "class", "prize-image svelte-kvgqh7");
    			add_location(img5, file$1, 94, 8, 3351);
    			attr_dev(div22, "class", "main-prize svelte-kvgqh7");
    			add_location(div22, file$1, 64, 6, 2307);
    			attr_dev(h30, "class", "prize-card-category svelte-kvgqh7");
    			add_location(h30, file$1, 99, 10, 3522);
    			attr_dev(h40, "class", "prize-card-model svelte-kvgqh7");
    			add_location(h40, file$1, 100, 10, 3578);
    			...
    			attr_dev(img6, "class", "prize-card-image svelte-kvgqh7");
    			add_location(img6, file$1, 101, 10, 3638);
    			attr_dev(div23, "class", "prize-card svelte-kvgqh7");
    			add_location(div23, file$1, 98, 8, 3487);
    			attr_dev(h31, "class", "prize-card-category svelte-kvgqh7");
    			add_location(h31, file$1, 105, 10, 3778);
    			attr_dev(h41, "class", "prize-card-model svelte-kvgqh7");
    			add_location(h41, file$1, 106, 10, 3837);
    			...
    			attr_dev(img7, "class", "prize-card-image svelte-kvgqh7");
    			add_location(img7, file$1, 107, 10, 3897);
    			attr_dev(div24, "class", "prize-card svelte-kvgqh7");
    			add_location(div24, file$1, 104, 8, 3743);
    			attr_dev(h32, "class", "prize-card-category svelte-kvgqh7");
    			add_location(h32, file$1, 111, 10, 4039);
    			attr_dev(h42, "class", "prize-card-model svelte-kvgqh7");
    			add_location(h42, file$1, 112, 10, 4100);
    			...
    			attr_dev(img8, "class", "prize-card-image svelte-kvgqh7");
    			add_location(img8, file$1, 113, 10, 4161);
    			attr_dev(div25, "class", "prize-card svelte-kvgqh7");
    			add_location(div25, file$1, 110, 8, 4004);
    			attr_dev(div26, "class", "additional-prizes svelte-kvgqh7");
    			add_location(div26, file$1, 97, 6, 3447);
    			attr_dev(div27, "class", "header-place svelte-kvgqh7");
    			add_location(div27, file$1, 120, 12, 4400);
    			attr_dev(div28, "class", "header-prize svelte-kvgqh7");
    			add_location(div28, file$1, 121, 12, 4450);
    			attr_dev(div29, "class", "header-freebet svelte-kvgqh7");
    			add_location(div29, file$1, 122, 12, 4499);
    			attr_dev(div30, "class", "leaderboard-headers svelte-kvgqh7");
    			add_location(div30, file$1, 119, 10, 4354);
    			attr_dev(div31, "class", "place svelte-kvgqh7");
    			add_location(div31, file$1, 127, 14, 4658);
    			attr_dev(div32, "class", "prize svelte-kvgqh7");
    			add_location(div32, file$1, 128, 14, 4699);
    			attr_dev(div33, "class", "freebet svelte-kvgqh7");
    			add_location(div33, file$1, 129, 14, 4752);
    			attr_dev(div34, "class", "leaderboard-row svelte-kvgqh7");
    			add_location(div34, file$1, 126, 12, 4614);
    			attr_dev(div35, "class", "place svelte-kvgqh7");
    			add_location(div35, file$1, 133, 14, 4864);
    			attr_dev(div36, "class", "prize svelte-kvgqh7");
    			add_location(div36, file$1, 134, 14, 4905);
    			attr_dev(div37, "class", "freebet svelte-kvgqh7");
    			add_location(div37, file$1, 135, 14, 4958);
    			attr_dev(div38, "class", "leaderboard-row svelte-kvgqh7");
    			add_location(div38, file$1, 132, 12, 4820);
    			attr_dev(div39, "class", "place svelte-kvgqh7");
    			add_location(div39, file$1, 139, 14, 5070);
    			attr_dev(div40, "class", "prize svelte-kvgqh7");
    			add_location(div40, file$1, 140, 14, 5111);
    			attr_dev(div41, "class", "freebet svelte-kvgqh7");
    			add_location(div41, file$1, 141, 14, 5164);
    			attr_dev(div42, "class", "leaderboard-row svelte-kvgqh7");
    			add_location(div42, file$1, 138, 12, 5026);
    			attr_dev(div43, "class", "place svelte-kvgqh7");
    			add_location(div43, file$1, 145, 14, 5276);
    			attr_dev(div44, "class", "prize svelte-kvgqh7");
    			add_location(div44, file$1, 146, 14, 5317);
    			attr_dev(div45, "class", "freebet svelte-kvgqh7");
    			add_location(div45, file$1, 147, 14, 5376);
    			attr_dev(div46, "class", "leaderboard-row svelte-kvgqh7");
    			add_location(div46, file$1, 144, 12, 5232);
    			attr_dev(div47, "class", "place svelte-kvgqh7");
    			add_location(div47, file$1, 151, 14, 5488);
    			attr_dev(div48, "class", "prize svelte-kvgqh7");
    			add_location(div48, file$1, 152, 14, 5529);
    			attr_dev(div49, "class", "freebet svelte-kvgqh7");
    			add_location(div49, file$1, 153, 14, 5588);
    			attr_dev(div50, "class", "leaderboard-row svelte-kvgqh7");
    			add_location(div50, file$1, 150, 12, 5444);
    			attr_dev(div51, "class", "place svelte-kvgqh7");
    			add_location(div51, file$1, 157, 14, 5700);
    			attr_dev(div52, "class", "prize svelte-kvgqh7");
    			add_location(div52, file$1, 158, 14, 5744);
    			attr_dev(div53, "class", "freebet svelte-kvgqh7");
    			add_location(div53, file$1, 159, 14, 5804);
    			attr_dev(div54, "class", "leaderboard-row svelte-kvgqh7");
    			add_location(div54, file$1, 156, 12, 5656);
    			attr_dev(div55, "class", "leaderboard-rows svelte-kvgqh7");
    			add_location(div55, file$1, 125, 10, 4571);
    			attr_dev(div56, "class", "leaderboard-content svelte-kvgqh7");
    			add_location(div56, file$1, 118, 8, 4310);
    			attr_dev(div57, "class", "merch-images svelte-kvgqh7");
    			add_location(div57, file$1, 166, 12, 5976);
    			attr_dev(span9, "class", "svelte-kvgqh7");
    			add_location(span9, file$1, 170, 14, 6128);
    			attr_dev(div58, "class", "merch-status svelte-kvgqh7");
    			add_location(div58, file$1, 169, 12, 6087);
    			attr_dev(div59, "class", "merch-content svelte-kvgqh7");
    			add_location(div59, file$1, 165, 10, 5936);
    			attr_dev(div60, "class", "merch-column svelte-kvgqh7");
    			add_location(div60, file$1, 164, 8, 5899);
    			attr_dev(div61, "class", "leaderboard svelte-kvgqh7");
    			add_location(div61, file$1, 117, 6, 4276);
    			attr_dev(section1, "class", "second-screen svelte-kvgqh7");
    			add_location(section1, file$1, 63, 4, 2269);
    			attr_dev(div62, "class", "screen-container svelte-kvgqh7");
    			add_location(div62, file$1, 62, 2, 2234);
    			attr_dev(h21, "class", "leaderboard-title svelte-kvgqh7");
    			add_location(h21, file$1, 182, 8, 6390);
    			attr_dev(p2, "class", "leaderboard-description svelte-kvgqh7");
    			add_location(p2, file$1, 183, 8, 6450);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "previous-winners-link svelte-kvgqh7");
    			add_location(a, file$1, 186, 8, 6596);
    			attr_dev(div63, "class", "table-frame svelte-kvgqh7");
    			add_location(div63, file$1, 190, 10, 6772);
    			attr_dev(div64, "class", "leaderboard-table svelte-kvgqh7");
    			add_location(div64, file$1, 188, 8, 6691);
    			attr_dev(div65, "class", "leaderboard-left svelte-kvgqh7");
    			add_location(div65, file$1, 181, 6, 6351);
    			attr_dev(button1, "class", "action-button svelte-kvgqh7");
    			add_location(button1, file$1, 198, 8, 6977);
    			attr_dev(button2, "class", "action-button svelte-kvgqh7");
    			add_location(button2, file$1, 199, 8, 7041);
    			attr_dev(p3, "class", "promo-description svelte-kvgqh7");
    			add_location(p3, file$1, 201, 8, 7110);
    			attr_dev(p4, "class", "svelte-kvgqh7");
    			add_location(p4, file$1, 207, 12, 7366);
    			attr_dev(p5, "class", "svelte-kvgqh7");
    			add_location(p5, file$1, 208, 12, 7478);
    			attr_dev(p6, "class", "svelte-kvgqh7");
    			add_location(p6, file$1, 209, 12, 7532);
    			attr_dev(div66, "class", "additional-info svelte-kvgqh7");
    			add_location(div66, file$1, 206, 10, 7324);
    			attr_dev(div67, "class", "actions-container svelte-kvgqh7");
    			add_location(div67, file$1, 197, 6, 6937);
    			attr_dev(div68, "class", "leaderboard-right svelte-kvgqh7");
    			add_location(div68, file$1, 196, 4, 6899);
    			attr_dev(div69, "class", "leaderboard-container svelte-kvgqh7");
    			add_location(div69, file$1, 180, 4, 6309);
    			attr_dev(section2, "class", "third-screen svelte-kvgqh7");
    			add_location(section2, file$1, 179, 2, 6274);
    			attr_dev(div70, "class", "page-wrapper svelte-kvgqh7");

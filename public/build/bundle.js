...
var app = (function () {
    ...
    const file$2 = "src/components/Screen4.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t21 = space();
    			div12 = element("div");
    			attr_dev(h2, "class", "project-title svelte-33sl5u");
    			add_location(h2, file$2, 5, 4, 100);
    			attr_dev(p0, "class", "highlight-text svelte-33sl5u");
    			add_location(p0, file$2, 8, 8, 221);
    			attr_dev(p1, "class", "rules-text svelte-33sl5u");
    			add_location(p1, file$2, 9, 8, 341);
    			attr_dev(p2, "class", "details-text svelte-33sl5u");
    			add_location(p2, file$2, 10, 8, 389);
    			attr_dev(button, "class", "promo-button svelte-33sl5u");
    			add_location(button, file$2, 11, 8, 601);
    			attr_dev(div0, "class", "project-description svelte-33sl5u");
    			add_location(div0, file$2, 7, 6, 179);
    			...
    			add_location(div1, file$2, 15, 10, 741);
    			attr_dev(p3, "class", "step-text svelte-33sl5u");
    			add_location(p3, file$2, 16, 10, 854);
    			attr_dev(div2, "class", "step svelte-33sl5u");
    			add_location(div2, file$2, 14, 8, 712);
    			...
    			add_location(div3, file$2, 19, 10, 949);
    			...
    			add_location(div4, file$2, 20, 10, 1062);
    			attr_dev(p4, "class", "step-text svelte-33sl5u");
    			add_location(p4, file$2, 21, 10, 1175);
    			attr_dev(div5, "class", "step svelte-33sl5u");
    			add_location(div5, file$2, 18, 8, 920);
    			...
    			add_location(div6, file$2, 24, 10, 1284);
    			...
    			add_location(div7, file$2, 25, 10, 1397);
    			...
    			add_location(div8, file$2, 26, 10, 1510);
    			attr_dev(p5, "class", "step-text svelte-33sl5u");
    			add_location(p5, file$2, 27, 10, 1623);
    			attr_dev(div9, "class", "step svelte-33sl5u");
    			add_location(div9, file$2, 23, 8, 1255);
    			attr_dev(div10, "class", "project-steps svelte-33sl5u");
    			add_location(div10, file$2, 13, 6, 676);
    			attr_dev(div11, "class", "project-frame svelte-33sl5u");
    			add_location(div11, file$2, 6, 4, 145);
    			attr_dev(div12, "class", "santa svelte-33sl5u");
    			add_location(div12, file$2, 31, 4, 1721);
    			attr_dev(div13, "class", "about-project svelte-33sl5u");
    			add_location(div13, file$2, 4, 2, 68);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(source, file$1, 9, 8, 215);

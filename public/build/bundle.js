    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-1dmlkwa");
    			add_location(img0, file$1, 39, 10, 1098);
    			attr_dev(div0, "class", "candy-cane svelte-1dmlkwa");
    			add_location(div0, file$1, 40, 10, 1170);
    			attr_dev(div1, "class", "logo-container svelte-1dmlkwa");
    			add_location(div1, file$1, 38, 8, 1059);
    			attr_dev(a0, "href", "#leaderboard-table");
    			attr_dev(a0, "class", "menu-item svelte-1dmlkwa");
    			add_location(a0, file$1, 43, 10, 1253);
    			attr_dev(a1, "href", "#prizes");
    			attr_dev(a1, "class", "menu-item svelte-1dmlkwa");
    			add_location(a1, file$1, 44, 10, 1333);
    			attr_dev(a2, "href", "#about-project");
    			attr_dev(a2, "class", "menu-item svelte-1dmlkwa");
    			add_location(a2, file$1, 45, 10, 1389);
    			attr_dev(div2, "class", "menu svelte-1dmlkwa");
    			add_location(div2, file$1, 42, 8, 1224);
    			attr_dev(div3, "class", "header svelte-1dmlkwa");
    			...
    			attr_dev(img1, "class", "header-mobile-image svelte-1dmlkwa");
    			add_location(img1, file$1, 49, 8, 1516);
    			attr_dev(div4, "class", "header-mobile svelte-1dmlkwa");
    			add_location(div4, file$1, 48, 6, 1480);
    			attr_dev(span0, "class", "first-line svelte-1dmlkwa");
    			add_location(span0, file$1, 56, 12, 1763);
    			attr_dev(span1, "class", "second-line svelte-1dmlkwa");
    			add_location(span1, file$1, 57, 12, 1819);
    			attr_dev(h10, "class", "title svelte-1dmlkwa");
    			add_location(h10, file$1, 55, 10, 1732);
    			attr_dev(p0, "class", "description svelte-1dmlkwa");
    			add_location(p0, file$1, 60, 12, 1941);
    			attr_dev(p1, "class", "description description-secondary svelte-1dmlkwa");
    			add_location(p1, file$1, 66, 12, 2276);
    			attr_dev(div5, "class", "description-container svelte-1dmlkwa");
    			add_location(div5, file$1, 59, 10, 1893);
    			attr_dev(button0, "class", "promo-button svelte-1dmlkwa");
    			...
    			attr_dev(img2, "class", "santa-image svelte-1dmlkwa");
    			add_location(img2, file$1, 74, 12, 2652);
    			attr_dev(div6, "class", "promo-container svelte-1dmlkwa");
    			add_location(div6, file$1, 70, 10, 2486);
    			attr_dev(div7, "class", "left-side svelte-1dmlkwa");
    			...
    			attr_dev(img3, "class", "tree-image svelte-1dmlkwa");
    			...
    			attr_dev(img4, "class", "gifts-image svelte-1dmlkwa");
    			...
    			attr_dev(img5, "class", "star star-1 svelte-1dmlkwa");
    			...
    			attr_dev(img6, "class", "star star-2 svelte-1dmlkwa");
    			...
    			attr_dev(img7, "class", "star star-3 svelte-1dmlkwa");
    			add_location(img7, file$1, 84, 12, 3168);
    			attr_dev(div8, "class", "tree-container svelte-1dmlkwa");
    			add_location(div8, file$1, 79, 10, 2800);
    			attr_dev(div9, "class", "right-side svelte-1dmlkwa");
    			add_location(div9, file$1, 78, 8, 2765);
    			attr_dev(div10, "class", "content desktop-version svelte-1dmlkwa");
    			add_location(div10, file$1, 53, 6, 1652);
    			attr_dev(span2, "class", "first-line svelte-1dmlkwa");
    			add_location(span2, file$1, 93, 12, 3434);
    			attr_dev(span3, "class", "second-line svelte-1dmlkwa");
    			add_location(span3, file$1, 94, 12, 3490);
    			attr_dev(h11, "class", "title svelte-1dmlkwa");
    			add_location(h11, file$1, 92, 10, 3403);
    			attr_dev(p2, "class", "description svelte-1dmlkwa");
    			add_location(p2, file$1, 97, 12, 3612);
    			attr_dev(p3, "class", "description description-secondary svelte-1dmlkwa");
    			add_location(p3, file$1, 103, 12, 3947);
    			attr_dev(div11, "class", "description-container svelte-1dmlkwa");
    			add_location(div11, file$1, 96, 10, 3564);
    			attr_dev(button1, "class", "promo-button svelte-1dmlkwa");
    			...
    			attr_dev(img8, "class", "santa-image svelte-1dmlkwa");
    			add_location(img8, file$1, 111, 12, 4323);
    			attr_dev(div12, "class", "promo-container svelte-1dmlkwa");
    			add_location(div12, file$1, 107, 10, 4157);
    			attr_dev(div13, "class", "left-side svelte-1dmlkwa");
    			...
    			attr_dev(img9, "class", "tree-image svelte-1dmlkwa");
    			...
    			attr_dev(img10, "class", "gifts-image svelte-1dmlkwa");
    			...
    			attr_dev(img11, "class", "star star-1 svelte-1dmlkwa");
    			...
    			attr_dev(img12, "class", "star star-2 svelte-1dmlkwa");
    			...
    			attr_dev(img13, "class", "star star-3 svelte-1dmlkwa");
    			add_location(img13, file$1, 121, 12, 4839);
    			attr_dev(div14, "class", "tree-container svelte-1dmlkwa");
    			add_location(div14, file$1, 116, 10, 4471);
    			attr_dev(div15, "class", "right-side svelte-1dmlkwa");
    			add_location(div15, file$1, 115, 8, 4436);
    			attr_dev(div16, "class", "content mobile-container svelte-1dmlkwa");
    			add_location(div16, file$1, 90, 6, 3322);
    			attr_dev(section0, "class", "first-screen svelte-1dmlkwa");
    			add_location(section0, file$1, 36, 4, 993);
    			attr_dev(div17, "class", "screen-container svelte-1dmlkwa");
    			add_location(div17, file$1, 35, 2, 958);
    			attr_dev(span4, "class", "prize-label svelte-1dmlkwa");
    			add_location(span4, file$1, 133, 10, 5190);
    			attr_dev(div18, "class", "prize-header svelte-1dmlkwa");
    			add_location(div18, file$1, 132, 8, 5153);
    			attr_dev(h2, "class", "prize-title svelte-1dmlkwa");
    			add_location(h2, file$1, 136, 8, 5268);
    			attr_dev(span5, "class", "spec-label svelte-1dmlkwa");
    			add_location(span5, file$1, 141, 14, 5445);
    			attr_dev(span6, "class", "spec-value svelte-1dmlkwa");
    			add_location(span6, file$1, 142, 14, 5504);
    			attr_dev(div19, "class", "spec-item svelte-1dmlkwa");
    			add_location(div19, file$1, 140, 12, 5407);
    			attr_dev(span7, "class", "spec-label svelte-1dmlkwa");
    			add_location(span7, file$1, 145, 14, 5612);
    			attr_dev(span8, "class", "spec-value svelte-1dmlkwa");
    			add_location(span8, file$1, 146, 14, 5668);
    			attr_dev(div20, "class", "spec-item svelte-1dmlkwa");
    			add_location(div20, file$1, 144, 12, 5574);
    			attr_dev(div21, "class", "specs-column svelte-1dmlkwa");
    			add_location(div21, file$1, 139, 10, 5368);
    			attr_dev(span9, "class", "spec-label svelte-1dmlkwa");
    			add_location(span9, file$1, 151, 14, 5834);
    			attr_dev(span10, "class", "spec-value svelte-1dmlkwa");
    			add_location(span10, file$1, 152, 14, 5885);
    			attr_dev(div22, "class", "spec-item svelte-1dmlkwa");
    			add_location(div22, file$1, 150, 12, 5796);
    			attr_dev(span11, "class", "spec-label svelte-1dmlkwa");
    			add_location(span11, file$1, 155, 14, 6005);
    			attr_dev(span12, "class", "spec-value svelte-1dmlkwa");
    			add_location(span12, file$1, 156, 14, 6058);
    			attr_dev(div23, "class", "spec-item svelte-1dmlkwa");
    			add_location(div23, file$1, 154, 12, 5967);
    			attr_dev(div24, "class", "specs-column svelte-1dmlkwa");
    			add_location(div24, file$1, 149, 10, 5757);
    			attr_dev(div25, "class", "specs-container svelte-1dmlkwa");
    			...
    			attr_dev(img14, "class", "prize-image svelte-1dmlkwa");
    			...
    			attr_dev(img15, "class", "gift-decoration svelte-1dmlkwa");
    			...
    			attr_dev(div26, "class", "main-prize svelte-1dmlkwa");
    			set_style(div26, "position", "relative");
    			add_location(div26, file$1, 131, 6, 5092);
    			attr_dev(h30, "class", "prize-card-category svelte-1dmlkwa");
    			add_location(h30, file$1, 167, 10, 6528);
    			attr_dev(h40, "class", "prize-card-model svelte-1dmlkwa");
    			...
    			attr_dev(img16, "class", "prize-card-image svelte-1dmlkwa");
    			add_location(img16, file$1, 169, 10, 6644);
    			attr_dev(div27, "class", "prize-card svelte-1dmlkwa");
    			add_location(div27, file$1, 166, 8, 6493);
    			attr_dev(h31, "class", "prize-card-category svelte-1dmlkwa");
    			add_location(h31, file$1, 173, 10, 6784);
    			attr_dev(h41, "class", "prize-card-model svelte-1dmlkwa");
    			...
    			attr_dev(img17, "class", "prize-card-image svelte-1dmlkwa");
    			add_location(img17, file$1, 175, 10, 6903);
    			attr_dev(div28, "class", "prize-card svelte-1dmlkwa");
    			add_location(div28, file$1, 172, 8, 6749);
    			attr_dev(h32, "class", "prize-card-category svelte-1dmlkwa");
    			add_location(h32, file$1, 179, 10, 7045);
    			attr_dev(h42, "class", "prize-card-model svelte-1dmlkwa");
    			...
    			attr_dev(img18, "class", "prize-card-image svelte-1dmlkwa");
    			add_location(img18, file$1, 181, 10, 7167);
    			attr_dev(div29, "class", "prize-card svelte-1dmlkwa");
    			add_location(div29, file$1, 178, 8, 7010);
    			attr_dev(div30, "class", "additional-prizes svelte-1dmlkwa");
    			add_location(div30, file$1, 165, 6, 6453);
    			attr_dev(div31, "class", "header-place svelte-1dmlkwa");
    			add_location(div31, file$1, 188, 12, 7406);
    			attr_dev(div32, "class", "header-prize svelte-1dmlkwa");
    			add_location(div32, file$1, 189, 12, 7456);
    			attr_dev(div33, "class", "header-freebet svelte-1dmlkwa");
    			add_location(div33, file$1, 190, 12, 7505);
    			attr_dev(div34, "class", "leaderboard-headers svelte-1dmlkwa");
    			add_location(div34, file$1, 187, 10, 7360);
    			attr_dev(div35, "class", "place svelte-1dmlkwa");
    			add_location(div35, file$1, 195, 14, 7661);
    			attr_dev(div36, "class", "prize svelte-1dmlkwa");
    			add_location(div36, file$1, 196, 14, 7702);
    			attr_dev(div37, "class", "freebet svelte-1dmlkwa");
    			add_location(div37, file$1, 197, 14, 7755);
    			attr_dev(div38, "class", "leaderboard-row svelte-1dmlkwa");
    			add_location(div38, file$1, 194, 12, 7617);
    			attr_dev(div39, "class", "place svelte-1dmlkwa");
    			add_location(div39, file$1, 201, 14, 7867);
    			attr_dev(div40, "class", "prize svelte-1dmlkwa");
    			add_location(div40, file$1, 202, 14, 7908);
    			attr_dev(div41, "class", "freebet svelte-1dmlkwa");
    			add_location(div41, file$1, 203, 14, 7961);
    			attr_dev(div42, "class", "leaderboard-row svelte-1dmlkwa");
    			add_location(div42, file$1, 200, 12, 7823);
    			attr_dev(div43, "class", "place svelte-1dmlkwa");
    			add_location(div43, file$1, 207, 14, 8073);
    			attr_dev(div44, "class", "prize svelte-1dmlkwa");
    			add_location(div44, file$1, 208, 14, 8114);
    			attr_dev(div45, "class", "freebet svelte-1dmlkwa");
    			add_location(div45, file$1, 209, 14, 8167);
    			attr_dev(div46, "class", "leaderboard-row svelte-1dmlkwa");
    			add_location(div46, file$1, 206, 12, 8029);
    			attr_dev(div47, "class", "place svelte-1dmlkwa");
    			add_location(div47, file$1, 213, 14, 8279);
    			attr_dev(div48, "class", "prize svelte-1dmlkwa");
    			add_location(div48, file$1, 214, 14, 8320);
    			attr_dev(div49, "class", "freebet svelte-1dmlkwa");
    			add_location(div49, file$1, 215, 14, 8379);
    			attr_dev(div50, "class", "leaderboard-row svelte-1dmlkwa");
    			add_location(div50, file$1, 212, 12, 8235);
    			attr_dev(div51, "class", "place svelte-1dmlkwa");
    			add_location(div51, file$1, 219, 14, 8491);
    			attr_dev(div52, "class", "prize svelte-1dmlkwa");
    			add_location(div52, file$1, 220, 14, 8532);
    			attr_dev(div53, "class", "freebet svelte-1dmlkwa");
    			add_location(div53, file$1, 221, 14, 8591);
    			attr_dev(div54, "class", "leaderboard-row svelte-1dmlkwa");
    			add_location(div54, file$1, 218, 12, 8447);
    			attr_dev(div55, "class", "place svelte-1dmlkwa");
    			add_location(div55, file$1, 225, 14, 8703);
    			attr_dev(div56, "class", "prize svelte-1dmlkwa");
    			add_location(div56, file$1, 226, 14, 8747);
    			attr_dev(div57, "class", "freebet svelte-1dmlkwa");
    			add_location(div57, file$1, 227, 14, 8807);
    			attr_dev(div58, "class", "leaderboard-row svelte-1dmlkwa");
    			add_location(div58, file$1, 224, 12, 8659);
    			attr_dev(div59, "class", "leaderboard-rows svelte-1dmlkwa");
    			add_location(div59, file$1, 193, 10, 7574);
    			attr_dev(div60, "class", "leaderboard-content svelte-1dmlkwa");
    			...
    			attr_dev(img19, "class", "svelte-1dmlkwa");
    			add_location(img19, file$1, 235, 14, 9020);
    			attr_dev(div61, "class", "merch-images svelte-1dmlkwa");
    			add_location(div61, file$1, 234, 12, 8979);
    			attr_dev(div62, "class", "merch-content svelte-1dmlkwa");
    			add_location(div62, file$1, 233, 10, 8939);
    			attr_dev(div63, "class", "merch-column svelte-1dmlkwa");
    			add_location(div63, file$1, 232, 8, 8902);
    			attr_dev(div64, "class", "leaderboard svelte-1dmlkwa");
    			add_location(div64, file$1, 185, 6, 7282);
    			attr_dev(section1, "class", "second-screen svelte-1dmlkwa");
    			attr_dev(section1, "id", "prizes");
    			add_location(section1, file$1, 130, 4, 5042);
    			attr_dev(div65, "class", "screen-container svelte-1dmlkwa");
    			add_location(div65, file$1, 129, 2, 5007);
    			attr_dev(div66, "class", "contest-title svelte-1dmlkwa");
    			add_location(div66, file$1, 249, 10, 9447);
    			attr_dev(div67, "class", "contest-description svelte-1dmlkwa");
    			add_location(div67, file$1, 250, 10, 9507);
    			attr_dev(a3, "href", "#");
    			attr_dev(a3, "class", "previous-winners-link svelte-1dmlkwa");
    			add_location(a3, file$1, 251, 10, 9635);
    			attr_dev(div68, "class", "header-left svelte-1dmlkwa");
    			add_location(div68, file$1, 255, 12, 9793);
    			attr_dev(div69, "class", "header-right svelte-1dmlkwa");
    			add_location(div69, file$1, 256, 12, 9840);
    			attr_dev(div70, "class", "table-headers svelte-1dmlkwa");
    			add_location(div70, file$1, 254, 10, 9753);
    			attr_dev(div71, "class", "name svelte-1dmlkwa");
    			add_location(div71, file$1, 263, 16, 10063);
    			attr_dev(div72, "class", "phone svelte-1dmlkwa");
    			add_location(div72, file$1, 264, 16, 10113);
    			attr_dev(div73, "class", "left-column svelte-1dmlkwa");
    			add_location(div73, file$1, 262, 14, 10021);
    			attr_dev(div74, "class", "coefficient svelte-1dmlkwa");
    			add_location(div74, file$1, 267, 16, 10235);
    			attr_dev(div75, "class", "right-column svelte-1dmlkwa");
    			add_location(div75, file$1, 266, 14, 10192);
    			attr_dev(div76, "class", "table-row svelte-1dmlkwa");
    			add_location(div76, file$1, 261, 12, 9983);
    			attr_dev(div77, "class", "name svelte-1dmlkwa");
    			add_location(div77, file$1, 272, 16, 10404);
    			attr_dev(div78, "class", "phone svelte-1dmlkwa");
    			add_location(div78, file$1, 273, 16, 10457);
    			attr_dev(div79, "class", "left-column svelte-1dmlkwa");
    			add_location(div79, file$1, 271, 14, 10362);
    			attr_dev(div80, "class", "coefficient svelte-1dmlkwa");
    			add_location(div80, file$1, 276, 16, 10579);
    			attr_dev(div81, "class", "right-column svelte-1dmlkwa");
    			add_location(div81, file$1, 275, 14, 10536);
    			attr_dev(div82, "class", "table-row svelte-1dmlkwa");
    			add_location(div82, file$1, 270, 12, 10324);
    			attr_dev(div83, "class", "name svelte-1dmlkwa");
    			add_location(div83, file$1, 281, 16, 10747);
    			attr_dev(div84, "class", "phone svelte-1dmlkwa");
    			add_location(div84, file$1, 282, 16, 10798);
    			attr_dev(div85, "class", "left-column svelte-1dmlkwa");
    			add_location(div85, file$1, 280, 14, 10705);
    			attr_dev(div86, "class", "coefficient svelte-1dmlkwa");
    			add_location(div86, file$1, 285, 16, 10920);
    			attr_dev(div87, "class", "right-column svelte-1dmlkwa");
    			add_location(div87, file$1, 284, 14, 10877);
    			attr_dev(div88, "class", "table-row svelte-1dmlkwa");
    			add_location(div88, file$1, 279, 12, 10667);
    			attr_dev(div89, "class", "name svelte-1dmlkwa");
    			add_location(div89, file$1, 290, 16, 11088);
    			attr_dev(div90, "class", "phone svelte-1dmlkwa");
    			add_location(div90, file$1, 291, 16, 11136);
    			attr_dev(div91, "class", "left-column svelte-1dmlkwa");
    			add_location(div91, file$1, 289, 14, 11046);
    			attr_dev(div92, "class", "coefficient svelte-1dmlkwa");
    			add_location(div92, file$1, 294, 16, 11258);
    			attr_dev(div93, "class", "right-column svelte-1dmlkwa");
    			add_location(div93, file$1, 293, 14, 11215);
    			attr_dev(div94, "class", "table-row svelte-1dmlkwa");
    			add_location(div94, file$1, 288, 12, 11008);
    			attr_dev(div95, "class", "name svelte-1dmlkwa");
    			add_location(div95, file$1, 299, 16, 11426);
    			attr_dev(div96, "class", "phone svelte-1dmlkwa");
    			add_location(div96, file$1, 300, 16, 11476);
    			attr_dev(div97, "class", "left-column svelte-1dmlkwa");
    			add_location(div97, file$1, 298, 14, 11384);
    			attr_dev(div98, "class", "coefficient svelte-1dmlkwa");
    			add_location(div98, file$1, 303, 16, 11598);
    			attr_dev(div99, "class", "right-column svelte-1dmlkwa");
    			add_location(div99, file$1, 302, 14, 11555);
    			attr_dev(div100, "class", "table-row svelte-1dmlkwa");
    			add_location(div100, file$1, 297, 12, 11346);
    			attr_dev(div101, "class", "name svelte-1dmlkwa");
    			add_location(div101, file$1, 308, 16, 11766);
    			attr_dev(div102, "class", "phone svelte-1dmlkwa");
    			add_location(div102, file$1, 309, 16, 11816);
    			attr_dev(div103, "class", "left-column svelte-1dmlkwa");
    			add_location(div103, file$1, 307, 14, 11724);
    			attr_dev(div104, "class", "coefficient svelte-1dmlkwa");
    			add_location(div104, file$1, 312, 16, 11938);
    			attr_dev(div105, "class", "right-column svelte-1dmlkwa");
    			add_location(div105, file$1, 311, 14, 11895);
    			attr_dev(div106, "class", "table-row svelte-1dmlkwa");
    			add_location(div106, file$1, 306, 12, 11686);
    			attr_dev(div107, "class", "table-rows svelte-1dmlkwa");
    			add_location(div107, file$1, 260, 10, 9946);
    			attr_dev(div108, "class", "table-frame svelte-1dmlkwa");
    			add_location(div108, file$1, 247, 8, 9373);
    			attr_dev(div109, "class", "leaderboard-left svelte-1dmlkwa");
    			add_location(div109, file$1, 246, 6, 9334);
    			attr_dev(button2, "class", "action-button svelte-1dmlkwa");
    			add_location(button2, file$1, 321, 10, 12200);
    			attr_dev(button3, "class", "action-button svelte-1dmlkwa");
    			add_location(button3, file$1, 322, 10, 12298);
    			attr_dev(p4, "class", "promo-description svelte-1dmlkwa");
    			add_location(p4, file$1, 324, 10, 12399);
    			attr_dev(p5, "class", "svelte-1dmlkwa");
    			add_location(p5, file$1, 330, 12, 12660);
    			attr_dev(p6, "class", "svelte-1dmlkwa");
    			add_location(p6, file$1, 331, 12, 12773);
    			attr_dev(p7, "class", "svelte-1dmlkwa");
    			add_location(p7, file$1, 332, 12, 12828);
    			attr_dev(div110, "class", "additional-info svelte-1dmlkwa");
    			add_location(div110, file$1, 329, 10, 12618);
    			attr_dev(div111, "class", "actions-container actions-container-mobile svelte-1dmlkwa");
    			set_style(div111, "margin-top", "190px");
    			add_location(div111, file$1, 320, 8, 12106);
    			attr_dev(div112, "class", "leaderboard-right svelte-1dmlkwa");
    			add_location(div112, file$1, 319, 6, 12066);
    			attr_dev(div113, "class", "leaderboard-container svelte-1dmlkwa");
    			add_location(div113, file$1, 245, 4, 9292);
    			attr_dev(section2, "class", "third-screen svelte-1dmlkwa");
    			attr_dev(section2, "id", "leaderboard-table");
    			add_location(section2, file$1, 244, 2, 9234);
    			attr_dev(section3, "id", "about-project");
    			attr_dev(section3, "class", "svelte-1dmlkwa");
    			add_location(section3, file$1, 340, 2, 13028);
    			attr_dev(div114, "class", "page-wrapper svelte-1dmlkwa");

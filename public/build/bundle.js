    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "header-image svelte-1rs3yst");
    			add_location(img0, file$1, 9, 2, 237);
    			add_location(picture, file$1, 5, 0, 98);
    			attr_dev(br, "class", "svelte-1rs3yst");
    			add_location(br, file$1, 15, 17, 404);
    			attr_dev(h1, "class", "title svelte-1rs3yst");
    			add_location(h1, file$1, 14, 4, 368);
    			attr_dev(p0, "class", "description svelte-1rs3yst");
    			add_location(p0, file$1, 18, 4, 444);
    			attr_dev(p1, "class", "description svelte-1rs3yst");
    			add_location(p1, file$1, 23, 4, 727);
    			attr_dev(button, "class", "promo-button svelte-1rs3yst");
    			add_location(button, file$1, 26, 4, 872);
    			attr_dev(div0, "class", "left-side svelte-1rs3yst");
    			...
    			attr_dev(img1, "class", "tree-image svelte-1rs3yst");
    			add_location(img1, file$1, 31, 4, 980);
    			attr_dev(div1, "class", "right-side svelte-1rs3yst");
    			add_location(div1, file$1, 30, 2, 951);
    			attr_dev(div2, "class", "content svelte-1rs3yst");
    			add_location(div2, file$1, 12, 0, 316);
    			attr_dev(section0, "class", "screen first-screen svelte-1rs3yst");
    			...
    			attr_dev(img2, "class", "second-screen-image svelte-1rs3yst");
    			add_location(img2, file$1, 37, 2, 1122);
    			attr_dev(section1, "class", "second-screen svelte-1rs3yst");
